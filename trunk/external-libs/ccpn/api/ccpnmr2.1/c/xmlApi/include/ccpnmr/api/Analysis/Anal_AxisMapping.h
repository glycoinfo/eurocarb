...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
extern Acco_AccessObject Anal_AxisMapping_GetActiveAccess(Anal_AxisMapping self);
...
/**
  ...
  @returns   the result
**/
extern Anal_AxisPanel Anal_AxisMapping_GetAxisPanel(Anal_AxisMapping self);
