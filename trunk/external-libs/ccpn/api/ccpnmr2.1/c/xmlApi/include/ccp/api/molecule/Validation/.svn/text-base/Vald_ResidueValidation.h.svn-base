...
#ifndef __incl__ccp_api_molecule_Validation_ResidueValidation_h__
#define __incl__ccp_api_molecule_Validation_ResidueValidation_h__
...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
extern Acco_AccessObject Vald_ResidueValidation_GetActiveAccess(Vald_ResidueValidation self);
...
#endif /* __incl__ccp_api_molecule_Validation_ResidueValidation_h__ */
