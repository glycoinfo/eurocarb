...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
extern Acco_AccessObject Anal_SpectrumWindowView_GetActiveAccess(Anal_SpectrumWindowView self);
...
- synonym for spectrumWindowPane
  ...
  @returns   the result
**/
extern Anal_SpectrumWindowPane Anal_SpectrumWindowView_GetParent(Anal_SpectrumWindowView self);
...
link
  ...
  @returns   the result
**/
extern Anal_SpectrumWindowPane Anal_SpectrumWindowView_GetSpectrumWindowPane(Anal_SpectrumWindowView self);
...
**/
extern Anal_SpectrumWindowView Anal_SpectrumWindowView_Init(Anal_SpectrumWindowPane parent, ApiMap attrlinks);
...
/**
  ...
  @returns  the new object
**/
extern Anal_SpectrumWindowView Anal_SpectrumWindowView_Init_reqd(Anal_SpectrumWindowPane parent, Anal_AnalysisSpectrum analysisSpectrum);
