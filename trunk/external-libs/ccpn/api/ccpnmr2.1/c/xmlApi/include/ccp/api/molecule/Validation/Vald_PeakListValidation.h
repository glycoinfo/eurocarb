...
#ifndef __incl__ccp_api_molecule_Validation_PeakListValidation_h__
#define __incl__ccp_api_molecule_Validation_PeakListValidation_h__
...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
extern Acco_AccessObject Vald_PeakListValidation_GetActiveAccess(Vald_PeakListValidation self);
...
#endif /* __incl__ccp_api_molecule_Validation_PeakListValidation_h__ */
