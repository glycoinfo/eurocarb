...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Cita_ThesisCitation_GetActiveAccess(Cita_ThesisCitation self)
{
  ...
  if (!method)
    return raiseApiException("ccp.general.Citation.ThesisCitation: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccp.general.Citation.ThesisCitation: method 'getActiveAccess' is not callable");
