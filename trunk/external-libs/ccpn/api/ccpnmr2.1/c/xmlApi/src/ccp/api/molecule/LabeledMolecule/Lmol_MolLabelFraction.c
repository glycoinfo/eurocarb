...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Lmol_MolLabelFraction_GetActiveAccess(Lmol_MolLabelFraction self)
{
  ...
  if (!method)
    return raiseApiException("ccp.molecule.LabeledMolecule.MolLabelFraction: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccp.molecule.LabeledMolecule.MolLabelFraction: method 'getActiveAccess' is not callable");
