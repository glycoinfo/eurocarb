...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Nmr_InternalShiftReference_GetActiveAccess(Nmr_InternalShiftReference self)
{
  ...
  if (!method)
    return raiseApiException("ccp.nmr.Nmr.InternalShiftReference: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccp.nmr.Nmr.InternalShiftReference: method 'getActiveAccess' is not callable");
