...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Nmap_NameMappingStore_GetActiveAccess(Nmap_NameMappingStore self)
{
  ...
  if (!method)
    return raiseApiException("ccpnmr.NameMapping.NameMappingStore: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccpnmr.NameMapping.NameMappingStore: method 'getActiveAccess' is not callable");
