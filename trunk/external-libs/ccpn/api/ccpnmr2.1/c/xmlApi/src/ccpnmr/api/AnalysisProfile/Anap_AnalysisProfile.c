...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Anap_AnalysisProfile_GetActiveAccess(Anap_AnalysisProfile self)
{
  ...
  if (!method)
    return raiseApiException("ccpnmr.AnalysisProfile.AnalysisProfile: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccpnmr.AnalysisProfile.AnalysisProfile: method 'getActiveAccess' is not callable");
