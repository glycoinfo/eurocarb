...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Nmrc_PairwiseConstraintItem_GetActiveAccess(Nmrc_PairwiseConstraintItem self)
{
  ...
  if (!method)
    return raiseApiException("ccp.nmr.NmrConstraint.PairwiseConstraintItem: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccp.nmr.NmrConstraint.PairwiseConstraintItem: method 'getActiveAccess' is not callable");
