...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Mols_ChainFragment_GetActiveAccess(Mols_ChainFragment self)
{
  ...
  if (!method)
    return raiseApiException("ccp.molecule.MolSystem.ChainFragment: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccp.molecule.MolSystem.ChainFragment: method 'getActiveAccess' is not callable");
