...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Nsim_NmrSimEnergyTerm_GetActiveAccess(Nsim_NmrSimEnergyTerm self)
{
  ...
  if (!method)
    return raiseApiException("molsim.NmrSim.NmrSimEnergyTerm: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("molsim.NmrSim.NmrSimEnergyTerm: method 'getActiveAccess' is not callable");
