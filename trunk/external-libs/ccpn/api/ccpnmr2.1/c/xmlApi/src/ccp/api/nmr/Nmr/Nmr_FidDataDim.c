...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Nmr_FidDataDim_GetActiveAccess(Nmr_FidDataDim self)
{
  ...
  if (!method)
    return raiseApiException("ccp.nmr.Nmr.FidDataDim: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccp.nmr.Nmr.FidDataDim: method 'getActiveAccess' is not callable");
