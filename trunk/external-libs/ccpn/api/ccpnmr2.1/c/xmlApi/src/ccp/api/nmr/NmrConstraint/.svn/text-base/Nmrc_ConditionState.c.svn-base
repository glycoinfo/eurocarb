...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Nmrc_ConditionState_GetActiveAccess(Nmrc_ConditionState self)
{
  ...
  if (!method)
    return raiseApiException("ccp.nmr.NmrConstraint.ConditionState: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccp.nmr.NmrConstraint.ConditionState: method 'getActiveAccess' is not callable");
