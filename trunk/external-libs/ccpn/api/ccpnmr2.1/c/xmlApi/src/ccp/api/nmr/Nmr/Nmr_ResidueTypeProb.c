...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Nmr_ResidueTypeProb_GetActiveAccess(Nmr_ResidueTypeProb self)
{
  ...
  if (!method)
    return raiseApiException("ccp.nmr.Nmr.ResidueTypeProb: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccp.nmr.Nmr.ResidueTypeProb: method 'getActiveAccess' is not callable");
