...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Nmrx_RefExpDim_GetActiveAccess(Nmrx_RefExpDim self)
{
  ...
  if (!method)
    return raiseApiException("ccp.nmr.NmrExpPrototype.RefExpDim: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccp.nmr.NmrExpPrototype.RefExpDim: method 'getActiveAccess' is not callable");
