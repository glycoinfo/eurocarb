...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Prot_PressStep_GetActiveAccess(Prot_PressStep self)
{
  ...
  if (!method)
    return raiseApiException("ccp.lims.Protocol.PressStep: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccp.lims.Protocol.PressStep: method 'getActiveAccess' is not callable");
