...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Ccca_ChemCompCharge_GetActiveAccess(Ccca_ChemCompCharge self)
{
  ...
  if (!method)
    return raiseApiException("ccp.molecule.ChemCompCharge.ChemCompCharge: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccp.molecule.ChemCompCharge.ChemCompCharge: method 'getActiveAccess' is not callable");
