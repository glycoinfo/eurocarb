...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Kwdf_KeywordDefinitionStore_GetActiveAccess(Kwdf_KeywordDefinitionStore self)
{
  ...
  if (!method)
    return raiseApiException("ccp.general.KeywordDefinition.KeywordDefinitionStore: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccp.general.KeywordDefinition.KeywordDefinitionStore: method 'getActiveAccess' is not callable");
