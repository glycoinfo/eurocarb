...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Mole_MolResLink_GetActiveAccess(Mole_MolResLink self)
{
  ...
  if (!method)
    return raiseApiException("ccp.molecule.Molecule.MolResLink: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccp.molecule.Molecule.MolResLink: method 'getActiveAccess' is not callable");
