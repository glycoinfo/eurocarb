...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Cclb_LabelingScheme_GetActiveAccess(Cclb_LabelingScheme self)
{
  ...
  if (!method)
    return raiseApiException("ccp.molecule.ChemCompLabel.LabelingScheme: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccp.molecule.ChemCompLabel.LabelingScheme: method 'getActiveAccess' is not callable");
