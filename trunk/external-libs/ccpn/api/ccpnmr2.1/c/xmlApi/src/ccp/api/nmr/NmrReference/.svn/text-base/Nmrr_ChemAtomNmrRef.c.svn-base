...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Nmrr_ChemAtomNmrRef_GetActiveAccess(Nmrr_ChemAtomNmrRef self)
{
  ...
  if (!method)
    return raiseApiException("ccp.nmr.NmrReference.ChemAtomNmrRef: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccp.nmr.NmrReference.ChemAtomNmrRef: method 'getActiveAccess' is not callable");
