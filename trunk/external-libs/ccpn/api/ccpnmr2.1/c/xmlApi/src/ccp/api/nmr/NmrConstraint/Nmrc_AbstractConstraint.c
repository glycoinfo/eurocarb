...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Nmrc_AbstractConstraint_GetActiveAccess(Nmrc_AbstractConstraint self)
{
  ...
  if (!method)
    return raiseApiException("ccp.nmr.NmrConstraint.AbstractConstraint: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccp.nmr.NmrConstraint.AbstractConstraint: method 'getActiveAccess' is not callable");
