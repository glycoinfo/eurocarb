...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Nmr_SampleCondition_GetActiveAccess(Nmr_SampleCondition self)
{
  ...
  if (!method)
    return raiseApiException("ccp.nmr.Nmr.SampleCondition: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccp.nmr.Nmr.SampleCondition: method 'getActiveAccess' is not callable");
