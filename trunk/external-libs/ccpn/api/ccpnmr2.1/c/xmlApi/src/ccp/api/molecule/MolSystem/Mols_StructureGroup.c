...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Mols_StructureGroup_GetActiveAccess(Mols_StructureGroup self)
{
  ...
  if (!method)
    return raiseApiException("ccp.molecule.MolSystem.StructureGroup: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccp.molecule.MolSystem.StructureGroup: method 'getActiveAccess' is not callable");
