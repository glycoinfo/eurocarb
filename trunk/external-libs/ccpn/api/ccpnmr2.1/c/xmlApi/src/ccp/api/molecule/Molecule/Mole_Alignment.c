...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Mole_Alignment_GetActiveAccess(Mole_Alignment self)
{
  ...
  if (!method)
    return raiseApiException("ccp.molecule.Molecule.Alignment: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccp.molecule.Molecule.Alignment: method 'getActiveAccess' is not callable");
