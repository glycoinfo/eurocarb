...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Expb_BlueprintStatus_GetActiveAccess(Expb_BlueprintStatus self)
{
  ...
  if (!method)
    return raiseApiException("ccp.lims.ExpBlueprint.BlueprintStatus: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccp.lims.ExpBlueprint.BlueprintStatus: method 'getActiveAccess' is not callable");
