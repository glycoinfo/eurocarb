...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Hold_RefSamplePosition_GetActiveAccess(Hold_RefSamplePosition self)
{
  ...
  if (!method)
    return raiseApiException("ccp.lims.Holder.RefSamplePosition: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccp.lims.Holder.RefSamplePosition: method 'getActiveAccess' is not callable");
