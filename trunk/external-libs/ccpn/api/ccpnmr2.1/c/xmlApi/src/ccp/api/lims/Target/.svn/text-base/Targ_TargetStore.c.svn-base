...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Targ_TargetStore_GetActiveAccess(Targ_TargetStore self)
{
  ...
  if (!method)
    return raiseApiException("ccp.lims.Target.TargetStore: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccp.lims.Target.TargetStore: method 'getActiveAccess' is not callable");
