...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Prot_RefOutputSample_GetActiveAccess(Prot_RefOutputSample self)
{
  ...
  if (!method)
    return raiseApiException("ccp.lims.Protocol.RefOutputSample: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccp.lims.Protocol.RefOutputSample: method 'getActiveAccess' is not callable");
