...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Sam_Sample_GetActiveAccess(Sam_Sample self)
{
  ...
  if (!method)
    return raiseApiException("ccp.lims.Sample.Sample: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccp.lims.Sample.Sample: method 'getActiveAccess' is not callable");
