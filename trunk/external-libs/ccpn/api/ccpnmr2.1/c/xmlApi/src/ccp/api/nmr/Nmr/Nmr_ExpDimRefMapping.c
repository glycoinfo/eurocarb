...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Nmr_ExpDimRefMapping_GetActiveAccess(Nmr_ExpDimRefMapping self)
{
  ...
  if (!method)
    return raiseApiException("ccp.nmr.Nmr.ExpDimRefMapping: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccp.nmr.Nmr.ExpDimRefMapping: method 'getActiveAccess' is not callable");
