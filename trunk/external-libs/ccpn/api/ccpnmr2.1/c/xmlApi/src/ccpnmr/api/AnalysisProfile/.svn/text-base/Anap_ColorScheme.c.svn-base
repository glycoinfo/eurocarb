...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Anap_ColorScheme_GetActiveAccess(Anap_ColorScheme self)
{
  ...
  if (!method)
    return raiseApiException("ccpnmr.AnalysisProfile.ColorScheme: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccpnmr.AnalysisProfile.ColorScheme: method 'getActiveAccess' is not callable");
