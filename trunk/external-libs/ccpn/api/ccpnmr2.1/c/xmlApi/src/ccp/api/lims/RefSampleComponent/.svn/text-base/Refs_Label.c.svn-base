...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Refs_Label_GetActiveAccess(Refs_Label self)
{
  ...
  if (!method)
    return raiseApiException("ccp.lims.RefSampleComponent.Label: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccp.lims.RefSampleComponent.Label: method 'getActiveAccess' is not callable");
