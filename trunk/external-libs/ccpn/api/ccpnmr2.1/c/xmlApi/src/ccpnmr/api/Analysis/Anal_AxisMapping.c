...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Anal_AxisMapping_GetActiveAccess(Anal_AxisMapping self)
{
  ...
  if (!method)
    return raiseApiException("ccpnmr.Analysis.AxisMapping: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccpnmr.Analysis.AxisMapping: method 'getActiveAccess' is not callable");
...
/**
  ...
  @returns   the result
**/
Anal_AxisPanel Anal_AxisMapping_GetAxisPanel(Anal_AxisMapping self)
{
  ...
  if (!method)
    return raiseApiException("ccpnmr.Analysis.AxisMapping: cannot find method 'getAxisPanel'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccpnmr.Analysis.AxisMapping: method 'getAxisPanel' is not callable");
