...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Kwdf_KeywordDefinition_GetActiveAccess(Kwdf_KeywordDefinition self)
{
  ...
  if (!method)
    return raiseApiException("ccp.general.KeywordDefinition.KeywordDefinition: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccp.general.KeywordDefinition.KeywordDefinition: method 'getActiveAccess' is not callable");
