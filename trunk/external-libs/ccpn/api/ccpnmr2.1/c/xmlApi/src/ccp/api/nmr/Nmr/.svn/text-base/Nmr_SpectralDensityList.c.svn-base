...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Nmr_SpectralDensityList_GetActiveAccess(Nmr_SpectralDensityList self)
{
  ...
  if (!method)
    return raiseApiException("ccp.nmr.Nmr.SpectralDensityList: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccp.nmr.Nmr.SpectralDensityList: method 'getActiveAccess' is not callable");
