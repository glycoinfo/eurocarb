...
**/
Impl_AppDataBoolean Impl_AppDataBoolean_Clone(Impl_AppDataBoolean self, ApiMap attrDict)
{
  ...
  if (!method)
    return raiseApiException("memops.Implementation.AppDataBoolean: cannot find method 'clone'");
  if (!PyCallable_Check(method))
    return raiseApiException("memops.Implementation.AppDataBoolean: method 'clone' is not callable");
