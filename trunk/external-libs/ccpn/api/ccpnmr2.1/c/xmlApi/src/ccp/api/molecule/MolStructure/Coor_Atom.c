...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Coor_Atom_GetActiveAccess(Coor_Atom self)
{
  ...
  if (!method)
    return raiseApiException("ccp.molecule.MolStructure.Atom: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccp.molecule.MolStructure.Atom: method 'getActiveAccess' is not callable");
