...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Chem_ChemAtomSet_GetActiveAccess(Chem_ChemAtomSet self)
{
  ...
  if (!method)
    return raiseApiException("ccp.molecule.ChemComp.ChemAtomSet: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccp.molecule.ChemComp.ChemAtomSet: method 'getActiveAccess' is not callable");
