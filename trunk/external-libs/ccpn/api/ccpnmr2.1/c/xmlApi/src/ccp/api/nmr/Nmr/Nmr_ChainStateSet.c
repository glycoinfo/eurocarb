...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Nmr_ChainStateSet_GetActiveAccess(Nmr_ChainStateSet self)
{
  ...
  if (!method)
    return raiseApiException("ccp.nmr.Nmr.ChainStateSet: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccp.nmr.Nmr.ChainStateSet: method 'getActiveAccess' is not callable");
