...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Symm_Symmetry_GetActiveAccess(Symm_Symmetry self)
{
  ...
  if (!method)
    return raiseApiException("molsim.Symmetry.Symmetry: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("molsim.Symmetry.Symmetry: method 'getActiveAccess' is not callable");
