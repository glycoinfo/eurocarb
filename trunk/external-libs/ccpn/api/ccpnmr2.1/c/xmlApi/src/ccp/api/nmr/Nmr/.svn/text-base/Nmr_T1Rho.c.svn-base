...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Nmr_T1Rho_GetActiveAccess(Nmr_T1Rho self)
{
  ...
  if (!method)
    return raiseApiException("ccp.nmr.Nmr.T1Rho: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccp.nmr.Nmr.T1Rho: method 'getActiveAccess' is not callable");
