...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Inst_NmrProbe_GetActiveAccess(Inst_NmrProbe self)
{
  ...
  if (!method)
    return raiseApiException("ccp.general.Instrument.NmrProbe: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccp.general.Instrument.NmrProbe: method 'getActiveAccess' is not callable");
