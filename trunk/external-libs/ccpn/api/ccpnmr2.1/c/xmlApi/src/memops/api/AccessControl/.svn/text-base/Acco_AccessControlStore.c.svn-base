...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Acco_AccessControlStore_GetActiveAccess(Acco_AccessControlStore self)
{
  ...
  if (!method)
    return raiseApiException("memops.AccessControl.AccessControlStore: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("memops.AccessControl.AccessControlStore: method 'getActiveAccess' is not callable");
