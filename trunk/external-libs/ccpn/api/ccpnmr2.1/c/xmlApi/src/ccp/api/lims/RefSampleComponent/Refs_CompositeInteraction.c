...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Refs_CompositeInteraction_GetActiveAccess(Refs_CompositeInteraction self)
{
  ...
  if (!method)
    return raiseApiException("ccp.lims.RefSampleComponent.CompositeInteraction: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccp.lims.RefSampleComponent.CompositeInteraction: method 'getActiveAccess' is not callable");
