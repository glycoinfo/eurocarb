...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Nmr_PKaDerivation_GetActiveAccess(Nmr_PKaDerivation self)
{
  ...
  if (!method)
    return raiseApiException("ccp.nmr.Nmr.PKaDerivation: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccp.nmr.Nmr.PKaDerivation: method 'getActiveAccess' is not callable");
