...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Coor_Model_GetActiveAccess(Coor_Model self)
{
  ...
  if (!method)
    return raiseApiException("ccp.molecule.MolStructure.Model: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccp.molecule.MolStructure.Model: method 'getActiveAccess' is not callable");
