...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Clas_SampleComponentCategory_GetActiveAccess(Clas_SampleComponentCategory self)
{
  ...
  if (!method)
    return raiseApiException("ccp.lims.Classification.SampleComponentCategory: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccp.lims.Classification.SampleComponentCategory: method 'getActiveAccess' is not callable");
