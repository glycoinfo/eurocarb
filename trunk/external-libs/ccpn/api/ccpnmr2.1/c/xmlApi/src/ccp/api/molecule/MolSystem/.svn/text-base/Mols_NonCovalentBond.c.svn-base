...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Mols_NonCovalentBond_GetActiveAccess(Mols_NonCovalentBond self)
{
  ...
  if (!method)
    return raiseApiException("ccp.molecule.MolSystem.NonCovalentBond: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccp.molecule.MolSystem.NonCovalentBond: method 'getActiveAccess' is not callable");
