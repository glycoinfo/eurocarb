...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Prot_ProtocolStore_GetActiveAccess(Prot_ProtocolStore self)
{
  ...
  if (!method)
    return raiseApiException("ccp.lims.Protocol.ProtocolStore: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccp.lims.Protocol.ProtocolStore: method 'getActiveAccess' is not callable");
