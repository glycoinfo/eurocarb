...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Nmrc_ResStructure_GetActiveAccess(Nmrc_ResStructure self)
{
  ...
  if (!method)
    return raiseApiException("ccp.nmr.NmrConstraint.ResStructure: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccp.nmr.NmrConstraint.ResStructure: method 'getActiveAccess' is not callable");
