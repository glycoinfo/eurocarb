...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Loca_Location_GetActiveAccess(Loca_Location self)
{
  ...
  if (!method)
    return raiseApiException("ccp.lims.Location.Location: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccp.lims.Location.Location: method 'getActiveAccess' is not callable");
