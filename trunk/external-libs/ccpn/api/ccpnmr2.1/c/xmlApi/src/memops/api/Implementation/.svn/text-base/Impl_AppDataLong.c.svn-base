...
**/
Impl_AppDataLong Impl_AppDataLong_Clone(Impl_AppDataLong self, ApiMap attrDict)
{
  ...
  if (!method)
    return raiseApiException("memops.Implementation.AppDataLong: cannot find method 'clone'");
  if (!PyCallable_Check(method))
    return raiseApiException("memops.Implementation.AppDataLong: method 'clone' is not callable");
