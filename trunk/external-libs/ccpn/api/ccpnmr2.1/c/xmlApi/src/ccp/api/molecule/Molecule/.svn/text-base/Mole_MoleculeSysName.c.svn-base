...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Mole_MoleculeSysName_GetActiveAccess(Mole_MoleculeSysName self)
{
  ...
  if (!method)
    return raiseApiException("ccp.molecule.Molecule.MoleculeSysName: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccp.molecule.Molecule.MoleculeSysName: method 'getActiveAccess' is not callable");
