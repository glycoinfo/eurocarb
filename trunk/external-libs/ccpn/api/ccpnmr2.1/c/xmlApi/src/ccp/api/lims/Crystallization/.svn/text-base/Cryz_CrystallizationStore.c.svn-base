...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Cryz_CrystallizationStore_GetActiveAccess(Cryz_CrystallizationStore self)
{
  ...
  if (!method)
    return raiseApiException("ccp.lims.Crystallization.CrystallizationStore: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccp.lims.Crystallization.CrystallizationStore: method 'getActiveAccess' is not callable");
