...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Prot_AddStep_GetActiveAccess(Prot_AddStep self)
{
  ...
  if (!method)
    return raiseApiException("ccp.lims.Protocol.AddStep: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccp.lims.Protocol.AddStep: method 'getActiveAccess' is not callable");
