...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Dang_DangleResidue_GetActiveAccess(Dang_DangleResidue self)
{
  ...
  if (!method)
    return raiseApiException("cambridge.Dangle.DangleResidue: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("cambridge.Dangle.DangleResidue: method 'getActiveAccess' is not callable");
