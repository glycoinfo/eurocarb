...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Refs_RefSampleComponentStore_GetActiveAccess(Refs_RefSampleComponentStore self)
{
  ...
  if (!method)
    return raiseApiException("ccp.lims.RefSampleComponent.RefSampleComponentStore: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccp.lims.RefSampleComponent.RefSampleComponentStore: method 'getActiveAccess' is not callable");
