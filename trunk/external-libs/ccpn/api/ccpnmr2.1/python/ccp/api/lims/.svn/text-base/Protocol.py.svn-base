...
Autogenerated by PyFileApiGen revision 1.51.2.5 on Fri Sep 18 15:10:04 2009
...
values are associated with an Experiment.
  """
  #   from data model element ccp.lims.Protocol.ParameterDefinition revision 1.36.2.10
...
class Procedure(memops.api.Implementation.DataObject):
  ...
  """
  #   from data model element ccp.lims.Protocol.Procedure revision 1.38.2.10
...
that contain steps.
  """
  #   from data model element ccp.lims.Protocol.Protocol revision 1.38.2.10
...
class ProtocolStore(memops.api.Implementation.TopObject):
  ...
  """
  #   from data model element ccp.lims.Protocol.ProtocolStore revision 1.37.2.10
...
InputSampleDef.sampleCategory is null).
  """
  #   from data model element ccp.lims.Protocol.RefInputSample revision 1.36.2.10
...
OutputSampleDef.sampleCategory is null).
  """
  #   from data model element ccp.lims.Protocol.RefOutputSample revision 1.36.2.10
...
certain time (duration).
  """
  #   from data model element ccp.lims.Protocol.Step revision 1.36.2.10
...
class CentrifugationStep(Step):
  ...
  """
  #   from data model element ccp.lims.Protocol.CentrifugationStep revision 1.35.2.10
...
class FiltrationStep(Step):
  ...
  """
  #   from data model element ccp.lims.Protocol.FiltrationStep revision 1.35.2.10
...
class PressStep(Step):
  r"""Press step.
  """
  #   from data model element ccp.lims.Protocol.PressStep revision 1.35.2.10
...
class WaitStep(Step):
  r"""Step for waiting.
  """
  #   from data model element ccp.lims.Protocol.WaitStep revision 1.35.2.10
...
class AddStep(Step):
  ...
  """
  #   from data model element ccp.lims.Protocol.AddStep revision 1.36.2.10
...
class FlowStep(Step):
  r"""Flow step.
  """
  #   from data model element ccp.lims.Protocol.FlowStep revision 1.36.2.10
...
class SonicationStep(Step):
  ...
  """
  #   from data model element ccp.lims.Protocol.SonicationStep revision 1.35.2.10
...
class TemperatureStep(Step):
  r"""Temperature step.
  """
  #   from data model element ccp.lims.Protocol.TemperatureStep revision 1.35.2.10
