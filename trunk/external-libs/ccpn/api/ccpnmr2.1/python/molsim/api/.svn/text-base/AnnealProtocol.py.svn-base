...
Autogenerated by PyFileApiGen revision 1.51.2.5 on Fri Sep 18 15:08:48 2009
  from data model element molsim.AnnealProtocol revision 1.24.2.10
...
general terms.
  """
  #   from data model element molsim.AnnealProtocol.AnnealProtocol revision 1.24.2.10
  _metaclass = metaPackage.getElement('AnnealProtocol')
  _packageName = 'molsim.AnnealProtocol'
  _packageShortName = 'ANPR'
  _fieldNames = ('application', 'applicationData', 'className', 'code', 'details', 'fieldNames', 'inConstructor', 'isDeleted', 'metaclass', 'name', 'packageName', 'packageShortName', 'qualifiedName', 'access', 'activeAccess', 'annealProtocolStore', 'annealStages', 'energyTerms', 'parent', 'root', 'runs', 'topObject',)
...
class AnnealProtocolStore(memops.api.Implementation.TopObject):
  ...
  """
  #   from data model element molsim.AnnealProtocol.AnnealProtocolStore revision 1.25.2.10
...
class AnnealStage(memops.api.Implementation.DataObject):
  ...
  """
  #   from data model element molsim.AnnealProtocol.AnnealStage revision 1.24.2.10
...
refPotentialTerms
  """
  #   from data model element molsim.AnnealProtocol.EnergyTerm revision 1.3.2.10
  _metaclass = metaPackage.getElement('EnergyTerm')
  _packageName = 'molsim.AnnealProtocol'
  _packageShortName = 'ANPR'
  _fieldNames = ('applicationData', 'className', 'code', 'details', 'fieldNames', 'inConstructor', 'isDeleted', 'metaclass', 'name', 'packageName', 'packageShortName', 'qualifiedName', 'serial', 'access', 'activeAccess', 'annealProtocol', 'nmrSimEnergyTerms', 'parent', 'potentialScales', 'root', 'topObject',)
...
class PotentialScale(memops.api.Implementation.DataObject):
  ...
  """
  #   from data model element molsim.AnnealProtocol.PotentialScale revision 1.24.2.10
...
interpretation generally requires reference to the application.
  """
  #   from data model element molsim.AnnealProtocol.RefPotentialTerm revision 1.3.2.10
...
class RefTermParameter(memops.api.Implementation.DataObject):
  ...
  """
  #   from data model element molsim.AnnealProtocol.RefTermParameter revision 1.3.2.10
