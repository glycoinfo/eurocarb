...
synonym for spectrumWindow
  ...
  @returns   the result
**/
Anal_SpectrumWindow Anal_AxisPanel_GetParent(Anal_AxisPanel self)
{
...
parent link
  ...
  @returns   the result
**/
Anal_SpectrumWindow Anal_AxisPanel_GetSpectrumWindow(Anal_AxisPanel self)
{
  ...
  if (!method)
    return raiseApiException("ccpnmr.Analysis.AxisPanel: cannot find method 'getSpectrumWindow'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccpnmr.Analysis.AxisPanel: method 'getSpectrumWindow' is not callable");
...
**/
Anal_AxisPanel Anal_AxisPanel_Init(Anal_SpectrumWindow parent, ApiMap attrlinks)
{
  
  return Anal_SpectrumWindow_NewAxisPanel(parent, attrlinks);
}
...
/**
  ...
  @returns  the new object
**/
Anal_AxisPanel Anal_AxisPanel_Init_reqd(Anal_SpectrumWindow parent, char * label)
{
