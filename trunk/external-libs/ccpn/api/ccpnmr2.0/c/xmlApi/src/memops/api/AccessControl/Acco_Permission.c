...
parent link
  ...
  @returns   the result
**/
Acco_AccessControlStore Acco_Permission_GetAccessControlStore(Acco_Permission self)
{
  ...
  if (!method)
    return raiseApiException("memops.AccessControl.Permission: cannot find method 'getAccessControlStore'");
  if (!PyCallable_Check(method))
    return raiseApiException("memops.AccessControl.Permission: method 'getAccessControlStore' is not callable");
...
synonym for accessControlStore
  ...
  @returns   the result
**/
Acco_AccessControlStore Acco_Permission_GetParent(Acco_Permission self)
{
...
**/
Acco_Permission Acco_Permission_Init(Acco_AccessControlStore parent, ApiMap attrlinks)
{
  
  return Acco_AccessControlStore_NewPermission(parent, attrlinks);
}
...
/**
  ...
  @returns  the new object
**/
Acco_Permission Acco_Permission_Init_reqd(Acco_AccessControlStore parent, Acco_AccessObject accessObject, Acco_UserGroup userGroup)
{
...
/**
  ...
  @param  Acco_AccessObject value
**/
void *Acco_Permission_SetAccessObject(Acco_Permission self, Acco_AccessObject value)
{
  
  void *obj;
  PyObject *args, *method = PyObject_GetAttrString(self, "setAccessObject");
  
  if (!method)
    return raiseApiException("memops.AccessControl.Permission: cannot find method 'setAccessObject'");
  if (!PyCallable_Check(method))
    return raiseApiException("memops.AccessControl.Permission: method 'setAccessObject' is not callable");
