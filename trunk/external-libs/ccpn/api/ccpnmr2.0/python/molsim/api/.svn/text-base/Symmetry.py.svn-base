...
Autogenerated by PyFileApiGen revision 1.51.2.3 on Mon Apr  6 17:03:50 2009
...
class MolSystemSymmetrySet(memops.api.Implementation.TopObject):
  ...
  """
  #   from data model element molsim.Symmetry.MolSystemSymmetrySet revision 1.3.2.9
  _metaclass = metaPackage.getElement('MolSystemSymmetrySet')
  _packageName = 'molsim.Symmetry'
  _packageShortName = 'SYMM'
  _fieldNames = ('applicationData', 'className', 'createdBy', 'fieldNames', 'guid', 'inConstructor', 'isDeleted', 'isLoaded', 'isModifiable', 'isModified', 'isReading', 'lastUnlockedBy', 'metaclass', 'packageName', 'packageShortName', 'qualifiedName', 'symmetrySetId', 'access', 'activeRepositories', 'memopsRoot', 'molSystem', 'packageLocator', 'parent', 'root', 'symmetries', 'topObject',)
...
class Segment(memops.api.Implementation.DataObject):
  ...
  """
  #   from data model element molsim.Symmetry.Segment revision 1.3.2.9
  _metaclass = metaPackage.getElement('Segment')
  _packageName = 'molsim.Symmetry'
  _packageShortName = 'SYMM'
  _fieldNames = ('applicationData', 'chainCode', 'className', 'fieldNames', 'firstSeqId', 'inConstructor', 'isDeleted', 'metaclass', 'packageName', 'packageShortName', 'qualifiedName', 'access', 'parent', 'residues', 'root', 'symmetry', 'topObject',)
...
of chani segents that are symmetric under some symmetry operation, such 
...
a multichain MolSystem.
  """
  #   from data model element molsim.Symmetry.Symmetry revision 1.5.2.9
  _metaclass = metaPackage.getElement('Symmetry')
  _packageName = 'molsim.Symmetry'
  _packageShortName = 'SYMM'
  _fieldNames = ('applicationData', 'className', 'fieldNames', 'inConstructor', 'isDeleted', 'metaclass', 'packageName', 'packageShortName', 'qualifiedName', 'segmentLength', 'serial', 'symmetryCode', 'access', 'molSystemSymmetrySet', 'parent', 'root', 'segments', 'topObject',)
