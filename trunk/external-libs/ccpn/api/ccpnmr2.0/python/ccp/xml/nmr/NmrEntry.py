...
def makeMapping(globalMap):
  ...
  # Attribute Entry.spectrometerListDetails
  currentMap = {}
  contentMap['spectrometerListDetails'] = currentMap
  mapsByGuid['www.ccpn.ac.uk_Fogh_2008-09-26-14:12:30_00007'] = currentMap
  loadMaps['ENTR.Entry.spectrometerListDetails'] = currentMap
  currentMap['tag'] = 'ENTR.Entry.spectrometerListDetails'
  currentMap['type'] = 'attr'
  currentMap['guid'] = 'www.ccpn.ac.uk_Fogh_2008-09-26-14:12:30_00007'
  currentMap['name'] = 'spectrometerListDetails'
  currentMap['hicard'] = 1
  currentMap['locard'] = 0
  currentMap['eType'] = 'cplx'
  currentMap['data'] = mapsByGuid.get('www.ccpn.ac.uk_Fogh_2006-08-16-14:22:53_00036')
  ...
  aList = ['bmrbProcessing', 'details', 'entryType', 'keywords', 'name', 'spectrometerListDetails', 'title']
  ...
  aList = ['dbCode', 'dbName', 'relationship']
  currentMap['simpleAttrs'] = aList
