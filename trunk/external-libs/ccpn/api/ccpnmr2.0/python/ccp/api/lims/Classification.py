...
Autogenerated by PyFileApiGen revision 1.51.2.3 on Mon Apr  6 17:02:59 2009
...
class AbstractCategory(memops.api.Implementation.DataObject):
  ...
  """
  #   from data model element ccp.lims.Classification.AbstractCategory revision 1.35.2.9
  _metaclass = metaPackage.getElement('AbstractCategory')
  _packageName = 'ccp.lims.Classification'
  _packageShortName = 'CLAS'
  _fieldNames = ('applicationData', 'className', 'details', 'fieldNames', 'inConstructor', 'isDeleted', 'metaclass', 'name', 'packageName', 'packageShortName', 'qualifiedName', 'access', 'root', 'topObject',)
...
class Classification(memops.api.Implementation.TopObject):
  ...
  """
  #   from data model element ccp.lims.Classification.Classification revision 1.37.2.9
  _metaclass = metaPackage.getElement('Classification')
  _packageName = 'ccp.lims.Classification'
  _packageShortName = 'CLAS'
  _fieldNames = ('applicationData', 'className', 'createdBy', 'fieldNames', 'guid', 'inConstructor', 'isDeleted', 'isLoaded', 'isModifiable', 'isModified', 'isReading', 'lastUnlockedBy', 'metaclass', 'namingSystem', 'packageName', 'packageShortName', 'qualifiedName', 'access', 'activeRepositories', 'experimentTypes', 'hazardPhrases', 'holderCategorys', 'instrumentTypes', 'memopsRoot', 'packageLocator', 'parent', 'root', 'sampleCategories', 'sampleComponentCategory', 'targetScoreboards', 'targetStatus', 'topObject',)
...
caregories include buffering agent, salt, inhibitor,...
  """
  #   from data model element ccp.lims.Classification.SampleComponentCategory revision 1.36.2.9
  _metaclass = metaPackage.getElement('SampleComponentCategory')
  _packageName = 'ccp.lims.Classification'
  _packageShortName = 'CLAS'
  _fieldNames = ('applicationData', 'className', 'details', 'fieldNames', 'inConstructor', 'isDeleted', 'metaclass', 'name', 'packageName', 'packageShortName', 'qualifiedName', 'access', 'classification', 'components', 'parent', 'root', 'topObject',)
...
organisations can have their own types.
  """
  #   from data model element ccp.lims.Classification.ExperimentType revision 1.36.2.9
  _metaclass = metaPackage.getElement('ExperimentType')
  _packageName = 'ccp.lims.Classification'
  _packageShortName = 'CLAS'
  _fieldNames = ('applicationData', 'className', 'details', 'fieldNames', 'inConstructor', 'isDeleted', 'metaclass', 'name', 'packageName', 'packageShortName', 'qualifiedName', 'access', 'classification', 'experiments', 'instrumentTypes', 'parent', 'protocols', 'root', 'sampleCategories', 'topObject',)
...
class TargetScoreboard(AbstractCategory):
  ...
  """
  #   from data model element ccp.lims.Classification.TargetScoreboard revision 1.36.2.9
  _metaclass = metaPackage.getElement('TargetScoreboard')
  _packageName = 'ccp.lims.Classification'
  _packageShortName = 'CLAS'
  _fieldNames = ('applicationData', 'className', 'details', 'fieldNames', 'inConstructor', 'isDeleted', 'metaclass', 'name', 'packageName', 'packageShortName', 'qualifiedName', 'access', 'classification', 'parent', 'root', 'targetStatus', 'topObject',)
...
organisations can have their own categories.
  """
  #   from data model element ccp.lims.Classification.HolderCategory revision 1.36.2.9
  _metaclass = metaPackage.getElement('HolderCategory')
  _packageName = 'ccp.lims.Classification'
  _packageShortName = 'CLAS'
  _fieldNames = ('applicationData', 'className', 'details', 'fieldNames', 'inConstructor', 'isDeleted', 'metaclass', 'name', 'packageName', 'packageShortName', 'qualifiedName', 'abstractHolderTypes', 'access', 'classification', 'holders', 'parent', 'root', 'topObject',)
...
class HazardPhrase(AbstractCategory):
  ...
  """
  #   from data model element ccp.lims.Classification.HazardPhrase revision 1.36.2.9
  _metaclass = metaPackage.getElement('HazardPhrase')
  _packageName = 'ccp.lims.Classification'
  _packageShortName = 'CLAS'
  _fieldNames = ('applicationData', 'className', 'details', 'fieldNames', 'inConstructor', 'isDeleted', 'metaclass', 'name', 'packageName', 'packageShortName', 'phrase', 'qualifiedName', 'access', 'classification', 'parent', 'root', 'topObject',)
...
specific to a particular organisation.
  """
  #   from data model element ccp.lims.Classification.InstrumentType revision 1.36.2.9
  _metaclass = metaPackage.getElement('InstrumentType')
  _packageName = 'ccp.lims.Classification'
  _packageShortName = 'CLAS'
  _fieldNames = ('applicationData', 'className', 'details', 'fieldNames', 'inConstructor', 'isDeleted', 'metaclass', 'name', 'packageName', 'packageShortName', 'qualifiedName', 'access', 'classification', 'experimentTypes', 'instruments', 'parent', 'procedures', 'root', 'topObject',)
...
organisations can have their own categories.
  """
  #   from data model element ccp.lims.Classification.SampleCategory revision 1.36.2.9
  _metaclass = metaPackage.getElement('SampleCategory')
  _packageName = 'ccp.lims.Classification'
  _packageShortName = 'CLAS'
  _fieldNames = ('applicationData', 'className', 'details', 'fieldNames', 'inConstructor', 'isDeleted', 'metaclass', 'name', 'packageName', 'packageShortName', 'qualifiedName', 'abstractSamples', 'access', 'classification', 'experimentTypes', 'parent', 'root', 'topObject',)
...
class TargetStatus(AbstractCategory):
  ...
  """
  #   from data model element ccp.lims.Classification.TargetStatus revision 1.36.2.9
  _metaclass = metaPackage.getElement('TargetStatus')
  _packageName = 'ccp.lims.Classification'
  _packageShortName = 'CLAS'
  _fieldNames = ('applicationData', 'className', 'details', 'fieldNames', 'inConstructor', 'isDeleted', 'metaclass', 'name', 'packageName', 'packageShortName', 'qualifiedName', 'access', 'blueprintStatuss', 'classification', 'parent', 'root', 'targetScoreboards', 'targetStatus', 'topObject',)
