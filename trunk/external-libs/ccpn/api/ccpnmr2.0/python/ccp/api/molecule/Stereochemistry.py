...
SMILES conventions. 
  """
  #   from data model element ccp.molecule.Stereochemistry.RefStereochemistry revision 1.37.2.9
  _metaclass = metaPackage.getElement('RefStereochemistry')
  _packageName = 'ccp.molecule.Stereochemistry'
  _packageShortName = 'STER'
  _fieldNames = ('applicationData', 'className', 'details', 'fieldNames', 'inConstructor', 'isDeleted', 'metaclass', 'numAtoms', 'packageName', 'packageShortName', 'qualifiedName', 'serial', 'stereoClass', 'values', 'access', 'parent', 'root', 'stereochemistryStore', 'topObject',)
...
class StereochemistryStore(memops.api.Implementation.TopObject):
  ...
  """
  #   from data model element ccp.molecule.Stereochemistry.StereochemistryStore revision 1.37.2.9
  _metaclass = metaPackage.getElement('StereochemistryStore')
  _packageName = 'ccp.molecule.Stereochemistry'
  _packageShortName = 'STER'
  _fieldNames = ('applicationData', 'className', 'createdBy', 'fieldNames', 'guid', 'inConstructor', 'isDeleted', 'isLoaded', 'isModifiable', 'isModified', 'isReading', 'lastUnlockedBy', 'metaclass', 'name', 'packageName', 'packageShortName', 'qualifiedName', 'access', 'activeRepositories', 'memopsRoot', 'packageLocator', 'parent', 'refStereochemistries', 'root', 'topObject',)
