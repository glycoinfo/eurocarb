    ...
    if self.version in ('3.0','3.1'): 
      ...
      #
        ...
        if citationType == 'journal':
          citationTagNames += ['Journal_abbrev','Journal_volume','Journal_issue','Page_first','Year',None,None,'isPrimary','Page_last','Journal_name_full','PubMed_ID']
        elif citationType == 'book':
          citationTagNames += [None,'Book_volume',None,'Page_first','Year','Book_publisher_city','Book_publisher','isPrimary','Page_last',None,None]
        elif citationType == 'conference' or citationType == 'abstract':
          citationTagNames += [None,None,None,'Page_first','Year','Conference_site',None,'isPrimary','Page_last',None,None]
        elif citationType == 'thesis':
          citationTagNames += [None,None,None,'Page_first','Year','Thesis_institution_city',None,'isPrimary','Page_last',None,None]
        elif citationType == 'BMRB only':
          citationTagNames += [None,None,None,None,None,None,None,'isPrimary',None,None,None]

        # NOT HANDLED CURRENLTY! TODO!!
