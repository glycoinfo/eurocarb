...
*   for more details.
*
*   Last commit: $Rev: 1258 $ by $Author: glycoslave $ on $Date:: 2009-06-25 #$  
*/
...
*   @author mjh
*/
public class SubstructureQueryGenerator extends DepthFirstGraphVisitor<Linkage,Residue>
{
    /** logging handle */
    ...
    *   & meta-data that may add additional predicates to query */
    ...
    public SubstructureQueryGenerator( SubstructureQuery q )
    {
        this.query = q;
    ...
    */
    ...
    {       
        ...
        String hql = 
            "select gs " 
            //+ SubstructureQueryResult.class.getName()
            //+ "( gs "
            // + ", "
            // + join(", ", ids )
            //+ " ) "
    ...
    */        
    protected String getTableAliasFor( Residue r )
    {
    ...
    /** Start method for visitor traversal of substructure graph. */
    public void visit() 
    {  
        visit( graph );  
        processOptions();
    ...
    protected void addPredicate( String predicate )
    {
    ...
    */
    ...
    public void addResiduePredicate( Residue gr )
    {
        // assert r instanceof GlycanResidue;
        
        // GlycanResidue gr = (GlycanResidue) r;
        
        String predicate 
            = getTableAliasFor( gr )
            + ".residueName = '"
            // + gr.getResidue().getName();
            + gr.getName()
            + "'";
        ...
        addSiblingDisambiguationPredicateIfNeeded( gr );  
    }
