...
*   for more details.
*
*   Last commit: $Rev: 1314 $ by $Author: glycoslave $ on $Date:: 2009-06-28 #$  
*/
...
import org.eurocarbdb.dataaccess.hplc.RefLink; //  mjh to mc: this doesn't belong here!
    ...
    implements Serializable, Contributed
{
    ...
    static 
    {
        // EcdbMonosaccharideLibrary.init();
    ...
    *   parent/child residues. */
    ...
    // private Set<Composition> glycanComposition = new HashSet<Composition>(0);

    /** TODO - this will be replaced soon */
    // private String composition;

    private Set<Glycan> glycanHplc = new HashSet<Glycan>(0);
    private Set<RefLink> glycanGu = new HashSet<RefLink>(0);
    ...
    public GlycanSequence( String raw_sequence ) 
    {
        ...
        sequenceIupac = raw_sequence; // <-- TODO!!!
        sequenceCtCondensed = raw_sequence; // <-- TODO!!!
    ...
    */
    ...
    /*  getAllSequences  *//*****************************************
    *
    *   Returns an {@link Iterator} of all glycan sequences in 
    *   the data store. 
    */
    public static Iterator<GlycanSequence> getAllSequences()
    {
        //  can also use Query.iterate() method instead of list().iterator()
        //  see http://www.hibernate.org/hib_docs/v3/reference/en/html_single/#objectstate-querying-executing-iterate
        return (Iterator<GlycanSequence>) getEntityManager()
              .getQuery( Q + "ALL" )
              .list()
              .iterator();
    }
    ...
    /*  getAllGlycanSequences  *//***********************************
    *
    *   Returns all (!!!) glycan_sequence objects in the data store.
    *   @deprecated has major performance/memory issues - use {@link getAllSequences}
    *   instead.
    */
    @Deprecated
    @SuppressWarnings("unchecked")
    public static List<GlycanSequence> getAllGlycanSequences()
    {
        return (List<GlycanSequence>)(getEntityManager().getQuery(Q + "ALL").list());
    }

    
    @Deprecated
    public static List<GlycanSequence> getAllGlycanSequences(int first, int limit)
    {
        return (List<GlycanSequence>)(getEntityManager().getQuery(Q + "ALL")
    ...
    /*  getSequencesByRowNum  *//***********************************
    *
    *   Returns all glycan_sequence objects in the rows between START and END.
    */
    @Deprecated
    @SuppressWarnings("unchecked")    
    public static List<GlycanSequence> getSequencesByRowNum( long start, long end )
    {
        log.debug("from " + start + " to " + end);
    
        List<GlycanSequence> ret = (List<GlycanSequence>) getEntityManager()
            .getQuery( Q + "BY_ROW_NUM" )
            .setParameter("start", start )
            .setParameter("end", end )
            .list();
        
        log.debug("result "  + ret.size());
        return ret;
    ...
    */
    public Set<Contributor> getContributors()
    {
        ...
        for ( Contributed c : this.getBiologicalContexts() )
    ...
    *   glycan sequence in the {@link IupacSequenceFormat 
    *   Iupac sequence format}. 
    */
    ...
    {
        sequenceCt = sequenceCt;    
        this.sequenceCt = sequenceCt;
        this.sequenceIupac = sequenceCt ;
        this.sequenceCtCondensed = sequenceCt;
    }

    
    public String getSequenceCtCondensed()
    {
        return sequenceCtCondensed;
    }
    
    
    public void setSequenceCtCondensed(String sequenceCt)
    {
        this.sequenceCt = sequenceCt;
        this.sequenceIupac = sequenceCt ;
        this.sequenceCtCondensed = sequenceCt;
    ...
    /**
    *   Returns the {@link SugarSequence} of this GlycanSequence.
    *   @see #getSequenceCt
    *   @see SequenceFormat#GlycoctXml
    */
    ...
    /** Returns this sequence in Staliano (TM) sugar sequence format. */
    public String getSequenceGWS() 
    {
        return sequenceGWS; // to be changed
    }

    
    public void setSequenceGWS(String s) 
    {
        sequenceGWS = s;
    }
    ...
    *   represented by this GlycanSequence.
    */
    ...
    /** mjh: this should be calculated from the underlying sugar */
    ...
    *   which this {@link GlycanSequence} has been found.
    *
    *   @see #addBiologicalContext
    ...
    */
    ...
    /** Return a {@link Set} of unique {@link Taxonomy}s associated with this GlycanSequence
     *  @see #getTaxonomies
     */
    ...
    */    
    ...
    /** Return a {@link Set} of unique {@link Disease}s associated with this GlycanSequence
     *  @see #getDiseases
     */
    ...
    */    
    ...
    /** Return a {@link Set} of unique {@link Tissue}s associated with this GlycanSequence
     *  @see #getTissues
     */
    ...
    *   @see org.eurocarbdb.dataaccess.nmr.DigestProfile
    */    
    ...
    */
    ...
    public int hashCode() 
    {
        return this.sequence.toString().hashCode(); 
    }
    */

    Set<Glycan> getGlycan()
    {
        return this.glycanHplc;
    }

    void setGlycan( Set<Glycan> glycanHplc )
    {
        this.glycanHplc = glycanHplc;
    }
    
    Set<RefLink> getRefLink()
    {
        return this.glycanGu;
    }
    
    void setRefLink( Set<RefLink> glycanGu )
    {
        this.glycanGu = glycanGu;
    }
