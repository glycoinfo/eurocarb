...
//  static imports
import static org.eurocarbdb.util.graph.GraphUtils.unmodifiableGraph;
...
implements Cloneable, SugarElement, Iterable<Residue>
{
    /** Logging instance. */
    ...
    *
    *   @see GraphUtils#unmodifiableGraph
    */
    ...
    */
    ...
    public boolean isDefinite()
    {
        ...
        {
            r = v.getValue();
            if ( r instanceof SugarElement )
                if ( ! ((SugarElement) r).isDefinite() )
                    return false;
        }
        ...
        {
            l = e.getValue();
            if ( l instanceof SugarElement )
                if ( ! ((SugarElement) l).isDefinite() )
                    return false;
        }
