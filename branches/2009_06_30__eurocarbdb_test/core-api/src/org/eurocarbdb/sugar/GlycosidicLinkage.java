...
*   for more details.
*
*   Last commit: $Rev: 1208 $ by $Author: glycoslave $ on $Date:: 2009-06-11 #$  
*/
...
*
*/
public class GlycosidicLinkage implements Linkage, SugarElement
{
    /** Logging instance. */
    ...
    */
    ...
    /*  SugarElement interface  */
    
    public boolean isDefinite()
    {
        return ! ( 
            anomer == Anomer.UnknownAnomer
            && parentTerminus == UnknownTerminus
            && childTerminus == UnknownTerminus );
    }
    
    
    //~~~  Implemented methods from Linkage interface  ~~~//
