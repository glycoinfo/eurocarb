...
*   for more details.
*
*   Last commit: $Rev: 1248 $ by $Author: glycoslave $ on $Date:: 2009-06-24 #$  
*/
...
public class BitSet implements Set<Integer>, Iterable<Integer>, RandomAccess, Cloneable, Serializable
{
    ...
    public static BitSet forString( String bitstring )
    {
        ...
        for ( int j = chars.length - 1; j >= 0; j-- )
        {
            switch ( chars[j] )
            {
                ...
                default:
                    throw new IllegalArgumentException(
                        "invalid bit string format, only 1's and 0's allowed: "
                        + bitstring 
                    );
            }
        }       
    ...
    *   @throws ArrayIndexOutOfBoundsException if given index is negative.
    */
    ...
    *   integers whose position in the bitset is true. 
    */
    public int size()
    {
        int size = 0;
    ...
    */
    ...
    /** Returns this BitSet as an array of booleans. */
    ...
    /** Returns this bitset as a bitstring of length {@link #capacity()}. */
