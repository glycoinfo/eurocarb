...
{
  s=document.forms['determine'].elements[field].value;
  ...
  document.forms['determine'].elements[field+'_act'].value=c;
}
...
<div>Determine Structure</div>
<@ww.form method="post" name="determine" action="casper_determine_start"
...
<table>
  <tr><td>
	...
	<tr>
	  ...
	  <td colspan=7 align="center"><label for="linkage1" class="label">Linkage positions</label></td>
	</tr>
	<tr>
	  <td></td>
    ...
    <td>
      Chemical shifts
      <input name="dimensions" type="radio" value="1D" onchange="count_required();switchSpectra();" checked title="Switch between input of 1D and 2D spectra.">1D
	...
	<tr>
	  <td>
	    ...
	    anticipated: <input type="text" name="cShifts_ant" readonly="true"
	    		 	size="3" />
	    actual: <input type="text" name="cShifts_act" readonly="true"
	    	    	   size="2" />
	  </td>
	  <td>
	    Number of chemical shifts<br />
	    anticipated: <input type="text" name="hShifts_ant" readonly="true"
	    		       	size="3" />
	    actual: <input type="text" name="hShifts_act" readonly="true"
	    	    	   size="2" />
	  </td>
	</tr>
      </table>
	...
	<tr>
	  <td>
	    ...
	    anticipated: <input type="text" name="cHShifts_ant" readonly="true"
	    		 	size="3" />
	    actual: <input type="text" name="cHShifts_act" readonly="true"
	    	    	   size="2" />
	  </td>
	</tr>
      </table>
