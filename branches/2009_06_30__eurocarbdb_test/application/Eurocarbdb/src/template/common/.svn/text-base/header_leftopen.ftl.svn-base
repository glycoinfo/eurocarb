...
<@ww.url value="/js/lib/MochiKit/MochiKit.js" includeParams="none" id="url_mochikit_js"/>
...
<body 
  class="yui-skin-sam"
      <#if onload_function?exists>onload="${onload_function}"</#if>
...
<div class="menu_item" onmouseover="show('2','block')">
  ...
  <div class="sub_menu" onmouseover="show('2','block')" id="smenu2">
      ...
      <a href="${base}/search_substructure.action">Search by substructure</a>
      <hr/>
      <a href="${base}/search_biological_context.action">Search biological context</a>
      <hr/>
