...
*   for more details.
*
*   Last commit: $Rev: 1214 $ by $Author: glycoslave $ on $Date:: 2009-06-12 #$  
*/
...
public class UserManager extends AbstractUserAwareAction implements ServletRequestAware
{
    ...
    */    
    ...
    private String processLocalLogin()
    {
        ...
        if( !userpass.equals(c.getPassword()) ) {
    ...
    private String processOpenIdLogin()
    {
        ...
        try {
            this.openIdUrl = (new OpenIdAuthenticator()).createAuthenticationRequest(openIdIdentifier,request);
