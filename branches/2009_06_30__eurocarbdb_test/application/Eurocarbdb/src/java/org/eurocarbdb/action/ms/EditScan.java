...
*   for more details.
*
*   Last commit: $Rev: 1313 $ by $Author: glycoslave $ on $Date:: 2009-06-28 #$  
*/
...
public class EditScan extends EurocarbAction implements RequiresLogin,EditingAction 
{
    ...
    {   
        ...
        scan = getObjectFromParams(Scan.class, params, "scan.scanId");
        
        if (scan == null)
        {
            this.addActionError("Must supply a valid Scan ID if you wish to edit");
            if (params.get("scan.scanId") == null) {
                this.addFieldError("scan.scanId", "No scan identifier provided");
            } else {
                this.addFieldError("scan.scanId", "Bad scan identifier provided");                
            }
        }
