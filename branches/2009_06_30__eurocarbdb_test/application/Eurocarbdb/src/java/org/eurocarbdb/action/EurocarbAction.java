...
import org.codehaus.xfire.jibx.JibxServiceFactory;
...
import org.eurocarbdb.soap.service.SoapActions;
...
implements EurocarbObject, ParameterAware, CookiesAware
{
    ...
    *   parameters hash
    */
    protected <T> T getObjectFromParams( Class<T> clazz, Map params, String paramName )
    {
        Object identifier;
        if ((identifier = params.get(paramName)) != null) {
            return Eurocarb.getEntityManager().lookup( clazz , paramToInt(identifier) );
        }
        return null;
    }
