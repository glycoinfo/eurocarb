...
*/
/*-------------------------------------------------------------------
*   $Id: SearchTaxonomy.java 1147 2009-06-04 12:02:50Z glycoslave $
...
public class SearchTaxonomy extends AbstractSearchAction<Taxonomy>
{
    ...
    */
    ...
    /* (non-Javadoc)
     * @see org.eurocarbdb.action.EurocarbAction#getResult()
     */
    public Result<Taxonomy> getResult() {
        final SearchTaxonomy self = this;
        Result<Taxonomy> result = new Result<Taxonomy>() 
        {
            public EurocarbAction getAction() {
                return self;
            }

            public List<Taxonomy> getAllResults() {
                return self.getMatchingTaxonomies();
            }

            public Taxonomy getUniqueResult() {
                return self.getMatchingTaxonomies().get(0);
            }
