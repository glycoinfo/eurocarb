...
*   for more details.
*
*   Last commit: $Rev: 1259 $ by $Author: glycoslave $ on $Date:: 2009-06-25 #$  
*/
/**
* $Id: TestCreateReferences.java 1259 2009-06-25 16:02:01Z glycoslave $
...
public class TestCreateReferences extends BaseActionTestSuite {
    ...
    public void createReferencesTestAddJournalReference() throws Exception {
        ...
        params.put("journalReference.journal.journalTitle", "Hiren's journal of articles");
