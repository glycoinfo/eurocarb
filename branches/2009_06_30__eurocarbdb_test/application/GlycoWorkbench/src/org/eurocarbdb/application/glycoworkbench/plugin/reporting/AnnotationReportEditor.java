...
public class AnnotationReportEditor extends JFrame implements ActionListener, MouseListener, AnnotationReportCanvas.SelectionChangeListener, BaseDocument.DocumentChangeListener {
    ...
    theActionManager.add("open",FileUtils.getIcon("open"),"Open...",KeyEvent.VK_O, "ctrl O",this);
    theActionManager.add("save",FileUtils.getIcon("save"),"Save",KeyEvent.VK_S, "ctrl S",this);
    theActionManager.add("saveas",FileUtils.getIcon("saveas"),"Save as...",KeyEvent.VK_A, "shift ctrl S",this);
    theActionManager.add("update",FileUtils.getIcon("update"),"Update annotations",KeyEvent.VK_U, "",this);
    theActionManager.add("print",FileUtils.getIcon("print"),"Print...",KeyEvent.VK_P, "ctrl P",this);
    theActionManager.add("close",FileUtils.getIcon("close"),"Close",KeyEvent.VK_C, "ctrl Q",this);
    ...
    theActionManager.add("delete",FileUtils.getIcon("delete"),"Delete",KeyEvent.VK_DELETE, "",this);
    ...
    theActionManager.add("selectnone",FileUtils.getIcon("selectnone"),"Select none",KeyEvent.VK_E, "ESCAPE",this);

    theActionManager.add("enlarge",FileUtils.getIcon(this.getClass(),"enlarge"),"Enlarge selected structures",-1, "",this);
    theActionManager.add("resetsize",FileUtils.getIcon(this.getClass(),"resetsize"),"Reset size of selected structures to default value",-1, "",this);
    theActionManager.add("shrink",FileUtils.getIcon(this.getClass(),"shrink"),"Shrink selected structures",-1, "",this);
    theActionManager.add("highlight",FileUtils.getIcon(this.getClass(),"highlight"),"Set highlight for selected structures",-1, "",this);

    theActionManager.add("ungroup",FileUtils.getIcon(this.getClass(),"ungroup"),"Ungroup selected structures",-1, "",this);
    theActionManager.add("group",FileUtils.getIcon(this.getClass(),"group"),"Group selected structures",-1, "",this);
    
    theActionManager.add("placestructures",FileUtils.getIcon(this.getClass(),"placestructures"),"Automatic place all structures",-1, "",this);
    ...
    theActionManager.add("display=" + GraphicOptions.DISPLAY_CUSTOM, null, "custom view with user settings", KeyEvent.VK_K, "", this);

    theActionManager.add("orientation",getOrientationIcon(),"Change orientation",-1,"",this);

    theActionManager.add("displaysettings",FileUtils.getIcon(""),"Change structure display settings",KeyEvent.VK_S,"",this);
    theActionManager.add("reportsettings",FileUtils.getIcon(""),"Change report display settings",KeyEvent.VK_R,"",this);
    }
