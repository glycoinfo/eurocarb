...
public class FragmentCanvas extends JComponent implements Printable, MouseListener, MouseMotionListener, ActionListener {
    ...
    minus_button = FileUtils.getIcon("fcb_minus","png");
    cross_button = FileUtils.getIcon("fcb_cross","png");
    minus_button_pressed = FileUtils.getIcon("fcb_minusp2","png");
    cross_button_pressed = FileUtils.getIcon("fcb_crossp","png");
