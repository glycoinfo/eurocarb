...
public class SpectraPlugin implements Plugin, ActionListener {
    ...
    actions.add(new GlycanAction("addPeaks",FileUtils.getIcon("addpeaks"),"Add selected peaks to the peak list",KeyEvent.VK_A, "",this));
    actions.add(new GlycanAction("annotatePeaks",FileUtils.getIcon("annotatepeaks"),"Find possible annotations for selected peaks",KeyEvent.VK_N, "",this));
    actions.add(new GlycanAction("centroid",FileUtils.getIcon(""),"Compute peak centroids",KeyEvent.VK_C, "",this));
