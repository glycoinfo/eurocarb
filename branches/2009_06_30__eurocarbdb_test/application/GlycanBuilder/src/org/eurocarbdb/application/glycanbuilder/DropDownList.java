...
/**
   Component implementing a drop down list with multiple selections to
   be added in a toolbar.
...
public class DropDownList extends JToggleButton implements ActionListener, ListSelectionListener, PopupMenuListener {
    ...
    super("---", FileUtils.getIcon("smalldownarrow"));    
    ...
    if( this.isSelected() ) {
        ...
        thePopup.setPopupSize(Math.max(bounds.width,psize.width),psize.height);
    }
    else
