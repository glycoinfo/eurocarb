...
public class GraphicOptionsDialog extends EscapeDialog implements java.awt.event.ActionListener, java.awt.event.ItemListener, javax.swing.event.ChangeListener  {
    ...
    // set models
    field_display.setModel(new javax.swing.DefaultComboBoxModel(new String[] {GraphicOptions.DISPLAY_NORMALINFO, GraphicOptions.DISPLAY_NORMAL, GraphicOptions.DISPLAY_COMPACT, GraphicOptions.DISPLAY_CUSTOM}));

    field_node_size.setModel(new javax.swing.SpinnerNumberModel(1,1,100,1));
    field_node_font_size.setModel(new javax.swing.SpinnerNumberModel(1,1,40,1));
        field_node_font_face.setModel(new javax.swing.DefaultComboBoxModel(GraphicOptions.getAllFontFaces()));

    field_composition_font_size.setModel(new javax.swing.SpinnerNumberModel(1,1,40,1));
        field_composition_font_face.setModel(new javax.swing.DefaultComboBoxModel(GraphicOptions.getAllFontFaces()));

    field_linkage_info_size.setModel(new javax.swing.SpinnerNumberModel(1,1,40,1));
        field_linkage_info_font_face.setModel(new javax.swing.DefaultComboBoxModel(GraphicOptions.getAllFontFaces()));

    field_node_space.setModel(new javax.swing.SpinnerNumberModel(1,1,100,1));
    field_node_sub_space.setModel(new javax.swing.SpinnerNumberModel(1,1,40,1));
    field_structures_space.setModel(new javax.swing.SpinnerNumberModel(1,1,100,1));

    field_mass_text_space.setModel(new javax.swing.SpinnerNumberModel(1,1,100,1));
    field_mass_text_size.setModel(new javax.swing.SpinnerNumberModel(1,1,40,1));
        field_mass_text_font_face.setModel(new javax.swing.DefaultComboBoxModel(GraphicOptions.getAllFontFaces()));
    ...
    field_composition_font_face.setSelectedItem(options.COMPOSITION_FONT_FACE);

    field_linkage_info_size.setValue(options.LINKAGE_INFO_SIZE);
    field_linkage_info_font_face.setSelectedItem(options.LINKAGE_INFO_FONT_FACE);
    ...
    if( field_display.getSelectedItem().equals(GraphicOptions.DISPLAY_CUSTOM) ) {
        theGraphicOptions.SHOW_INFO_CUSTOM = field_show_info.isSelected();
    
        theGraphicOptions.NODE_SIZE_CUSTOM = (Integer)field_node_size.getValue();
        theGraphicOptions.NODE_FONT_SIZE_CUSTOM = (Integer)field_node_font_size.getValue();
        theGraphicOptions.NODE_FONT_FACE_CUSTOM = (String)field_node_font_face.getSelectedItem();
        
        theGraphicOptions.COMPOSITION_FONT_SIZE_CUSTOM = (Integer)field_composition_font_size.getValue();
        theGraphicOptions.COMPOSITION_FONT_FACE_CUSTOM = (String)field_composition_font_face.getSelectedItem();

        theGraphicOptions.LINKAGE_INFO_SIZE_CUSTOM = (Integer)field_linkage_info_size.getValue();
        theGraphicOptions.LINKAGE_INFO_FONT_FACE_CUSTOM = (String)field_linkage_info_font_face.getSelectedItem();
        
        theGraphicOptions.NODE_SPACE_CUSTOM = (Integer)field_node_space.getValue();
        theGraphicOptions.NODE_SUB_SPACE_CUSTOM = (Integer)field_node_sub_space.getValue();
        theGraphicOptions.STRUCTURES_SPACE_CUSTOM = (Integer)field_structures_space.getValue();
        
        theGraphicOptions.MASS_TEXT_SPACE_CUSTOM = (Integer)field_mass_text_space.getValue();
        theGraphicOptions.MASS_TEXT_SIZE_CUSTOM = (Integer)field_mass_text_size.getValue();
        theGraphicOptions.MASS_TEXT_FONT_FACE_CUSTOM = (String)field_mass_text_font_face.getSelectedItem();    
    }
    }
    ...
    if( !ignore_change ) {
        ...
        initData(new GraphicOptions((String)field_display.getSelectedItem()));
        }
        else {
        ignore_change = true;
