...
def packageProject(project, filePrefix, includeData = True, overwriteExistingFile = True):
  """
  Package up project backup directory into one gzipped tar file.
  """

  fileName = '%s.tar' % filePrefix
