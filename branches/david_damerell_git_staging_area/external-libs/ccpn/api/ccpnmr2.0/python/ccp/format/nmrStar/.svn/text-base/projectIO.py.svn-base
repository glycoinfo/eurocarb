...
class NmrStarProjectFile(NmrStarFile):
  ...
  def read(self,verbose = 0,**keywds):
    ...
    saveFrameName = 'distance_constraints' 
    ...
    saveFrameName = None
    if self.version == '2.1.1':
      saveFrameName = 'monomeric_polymer' 
    ...
    if self.version == '3.1':
      ...
      if self.sfs.has_key(saveFrameName):
        saveFrame = self.sfs[saveFrameName][0]
...
class NmrStarSampleConditionsFile(NmrStarProjectDataComponent):
  ...
  def parseSaveFrame(self):
    ...
    if self.saveFrame.tables.has_key(self.tableName):
      ...
      for i in range(0,len(tableTags['Val'])):    # Just pick any obligatory tag from the table to loop over the rows
...
class NmrStarChemShiftRefFile(NmrStarProjectDataComponent):
  ...
  def parseSaveFrame(self):
    ...
    tagNames = ('Atom_type','Atom_isotope_number','Mol_common_name','Atom_group','Chem_shift_units','Chem_shift_val','Ref_method','Ref_type','Indirect_shift_ratio','External_ref_loc')
...
class ChemShiftRef:
  ...
  def __init__(self,parent,atomType,isotopeNum,molName,atomGroup,chemShiftUnits,chemShiftVal,refMeth,refType,indirectShiftRatio,location = None):
...
class Sample:
  ...
  def __init__(self,parent,name,samType,details,solventSys,aggrSamNo):
...
class NmrStarExperimentFile(NmrStarProjectDataComponent):
  ...
  def parseSaveFrame(self):
    ...
    tagNames = ('ID','Name','Raw_data_flag','Sample_ID','Sample_label','Sample_state','Sample_condition_list_ID','Sample_condition_list_label','NMR_spectrometer_ID','NMR_spectrometer_label')
    if self.saveFrame.tables.has_key(self.tableName):
      tableTags = self.saveFrame.tables[self.tableName].tags
...
class Experiment:
  ...
  def __init__(self,parent,Id,name,raw_data_flag,sampleId,sampleLabel,sampleState,sampleCondListId,sampleCondListLabel,specId,specLabel):
...
class NmrStarInstrumentFile(NmrStarProjectDataComponent):
  ...
  def parseSaveFrame(self):
    ...
    tagNames = ('ID','Name','Manufacturer','Model','Field_strength','Details')
    if self.saveFrame.tables.has_key(self.tableName):
      tableTags = self.saveFrame.tables[self.tableName].tags
...
class NmrSpectrometer:
  ...
  def __init__(self,parent,Id,name,manufacturer,model,field_strength,details):
...
class NmrStarSourceFile(NmrStarProjectDataComponent):
  ...
  def parseSaveFrame(self):
    ...
    if self.source == 'natural':
      ...
      tagNames = ('ID','Entity_ID','Entity_chimera_segment_ID','Type',None,'NCBI_taxonomy_ID','Organism_name_scientific','Organism_name_common','Strain','Variant','Organ','Tissue','Cell_line','Cell_type','ATCC_number',None,'Plasmid','Details','Species','Genus','Superkingdom','Kingdom',None,'Gene_mnemonic')

    elif self.source == 'experimental':
      self.tableName = '_Entity_experimental_src'
      tagNames = ('ID','Entity_ID','Entity_chimera_segment_ID',None,'Production_method','Host_org_NCBI_taxonomy_ID','Host_org_scientific_name','Host_org_name_common','Host_org_strain','Host_org_variant','Host_org_organ','Host_org_tissue','Host_org_cell_line','Host_org_cell_type','Host_org_ATCC_number','Vector_type','Vector_name','Details','Host_org_species','Host_org_genus',None,None,'PDBview_host_org_vector_name',None)
...
class Source:
  ...
  def __init__(self,parent,sourceType,Id,entId,entChimId,orgType,prodMethod,ncbiTaxId,orgSci,orgName,strain,variant,organ,tissue,cell_line,cell_type,atccNo,vecType,plasmid,details,species,genus,superKingdom,kingdom,pdbVectorName,geneMnemonic):
