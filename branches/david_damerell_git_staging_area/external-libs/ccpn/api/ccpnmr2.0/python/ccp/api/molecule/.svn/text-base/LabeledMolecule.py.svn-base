...
Autogenerated by PyFileApiGen revision 1.51.2.3 on Mon Apr  6 17:03:31 2009
...
class AtomLabel(memops.api.Implementation.DataObject):
  ...
  """
  #   from data model element ccp.molecule.LabeledMolecule.AtomLabel revision 1.30.2.9
  _metaclass = metaPackage.getElement('AtomLabel')
  _packageName = 'ccp.molecule.LabeledMolecule'
  _packageShortName = 'LMOL'
  _fieldNames = ('applicationData', 'className', 'fieldNames', 'inConstructor', 'isDeleted', 'massNumber', 'metaclass', 'packageName', 'packageShortName', 'qualifiedName', 'serial', 'weight', 'access', 'parent', 'resLabel', 'root', 'topObject',)
...
class LabeledMixture(memops.api.Implementation.DataObject):
  ...
  """
  #   from data model element ccp.molecule.LabeledMolecule.LabeledMixture revision 1.30.2.9
  _metaclass = metaPackage.getElement('LabeledMixture')
  _packageName = 'ccp.molecule.LabeledMolecule'
  _packageShortName = 'LMOL'
  _fieldNames = ('applicationData', 'className', 'fieldNames', 'inConstructor', 'isDeleted', 'metaclass', 'packageName', 'packageShortName', 'qualifiedName', 'serial', 'access', 'averageComposition', 'experiments', 'labeledMolecule', 'molComponents', 'molLabelFractions', 'parent', 'root', 'topObject',)
...
class LabeledMolecule(memops.api.Implementation.TopObject):
  ...
  """
  #   from data model element ccp.molecule.LabeledMolecule.LabeledMolecule revision 1.34.2.9
  _metaclass = metaPackage.getElement('LabeledMolecule')
  _packageName = 'ccp.molecule.LabeledMolecule'
  _packageShortName = 'LMOL'
  _fieldNames = ('applicationData', 'className', 'createdBy', 'fieldNames', 'guid', 'inConstructor', 'isDeleted', 'isLoaded', 'isModifiable', 'isModified', 'isReading', 'lastUnlockedBy', 'metaclass', 'name', 'packageName', 'packageShortName', 'qualifiedName', 'access', 'activeRepositories', 'labeledMixtures', 'memopsRoot', 'molLabels', 'molecule', 'packageLocator', 'parent', 'root', 'topObject',)
...
class MolLabel(memops.api.Implementation.DataObject):
  ...
  """
  #   from data model element ccp.molecule.LabeledMolecule.MolLabel revision 1.29.2.9
  _metaclass = metaPackage.getElement('MolLabel')
  _packageName = 'ccp.molecule.LabeledMolecule'
  _packageShortName = 'LMOL'
  _fieldNames = ('applicationData', 'className', 'fieldNames', 'inConstructor', 'isDeleted', 'metaclass', 'packageName', 'packageShortName', 'qualifiedName', 'serial', 'access', 'averageLabeledMixtures', 'labeledMolecule', 'molLabelFractions', 'parent', 'resLabels', 'root', 'topObject',)
...
LabeledMixture (association class).
  """
  #   from data model element ccp.molecule.LabeledMolecule.MolLabelFraction revision 1.29.2.9
  _metaclass = metaPackage.getElement('MolLabelFraction')
  _packageName = 'ccp.molecule.LabeledMolecule'
  _packageShortName = 'LMOL'
  _fieldNames = ('applicationData', 'className', 'fieldNames', 'inConstructor', 'isDeleted', 'metaclass', 'packageName', 'packageShortName', 'qualifiedName', 'weight', 'access', 'labeledMixture', 'molLabel', 'parent', 'root', 'topObject',)
...
ResLabelFractions.
  """
  #   from data model element ccp.molecule.LabeledMolecule.ResLabel revision 1.35.2.9
  _metaclass = metaPackage.getElement('ResLabel')
  _packageName = 'ccp.molecule.LabeledMolecule'
  _packageShortName = 'LMOL'
  _fieldNames = ('applicationData', 'className', 'fieldNames', 'inConstructor', 'isDeleted', 'metaclass', 'packageName', 'packageShortName', 'qualifiedName', 'resId', 'access', 'atomLabels', 'molLabel', 'molResidue', 'parent', 'resLabelFractions', 'root', 'topObject',)
...
class ResLabelFraction(memops.api.Implementation.DataObject):
  ...
  """
  #   from data model element ccp.molecule.LabeledMolecule.ResLabelFraction revision 1.31.2.9
  _metaclass = metaPackage.getElement('ResLabelFraction')
  _packageName = 'ccp.molecule.LabeledMolecule'
  _packageShortName = 'LMOL'
  _fieldNames = ('applicationData', 'className', 'fieldNames', 'inConstructor', 'isDeleted', 'isotopomerSerial', 'metaclass', 'packageName', 'packageShortName', 'qualifiedName', 'schemeName', 'weight', 'access', 'isotopomers', 'labelingScheme', 'parent', 'resLabel', 'root', 'topObject',)
...
residue, except those attached to any SingleAtomLabel object.
  """
  #   from data model element ccp.molecule.LabeledMolecule.UniformAtomLabel revision 1.28.2.9
  _metaclass = metaPackage.getElement('UniformAtomLabel')
  _packageName = 'ccp.molecule.LabeledMolecule'
  _packageShortName = 'LMOL'
  _fieldNames = ('applicationData', 'className', 'elementName', 'fieldNames', 'inConstructor', 'isDeleted', 'massNumber', 'metaclass', 'packageName', 'packageShortName', 'qualifiedName', 'serial', 'weight', 'access', 'parent', 'resLabel', 'root', 'topObject',)
...
and ResLabelFraction records present for the same residue ID(s)
  """
  #   from data model element ccp.molecule.LabeledMolecule.SingleAtomLabel revision 1.29.2.9
  _metaclass = metaPackage.getElement('SingleAtomLabel')
  _packageName = 'ccp.molecule.LabeledMolecule'
  _packageShortName = 'LMOL'
  _fieldNames = ('applicationData', 'atomName', 'className', 'fieldNames', 'inConstructor', 'isDeleted', 'massNumber', 'metaclass', 'packageName', 'packageShortName', 'qualifiedName', 'serial', 'weight', 'access', 'parent', 'resLabel', 'root', 'topObject',)
