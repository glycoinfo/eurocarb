...
class Citation:
  ...
  def __init__(self,parent,type,title,status,pubShortName,volume,issue,firstPage,year,publisherPlace,publisher,isPrimary = False,lastPage = None, pubLongName = None, pubMedId = None):
