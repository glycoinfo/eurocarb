...
Autogenerated by PyFileApiGen revision 1.51.2.3 on Mon Apr  6 17:03:02 2009
  from data model element ccp.lims.Location revision 1.34.2.9
...
class Location(memops.api.Implementation.DataObject):
  ...
  """
  #   from data model element ccp.lims.Location.Location revision 1.36.2.9
  _metaclass = metaPackage.getElement('Location')
  _packageName = 'ccp.lims.Location'
  _packageShortName = 'LOCA'
  _fieldNames = ('applicationData', 'className', 'fieldNames', 'inConstructor', 'isDeleted', 'locationType', 'metaclass', 'name', 'packageName', 'packageShortName', 'pressure', 'pressureDisplayUnit', 'qualifiedName', 'serial', 'tempDisplayUnit', 'temperature', 'access', 'contents', 'holderLocations', 'location', 'locationStore', 'organisation', 'parent', 'root', 'topObject',)
...
class LocationStore(memops.api.Implementation.TopObject):
  ...
  """
  #   from data model element ccp.lims.Location.LocationStore revision 1.37.2.9
  _metaclass = metaPackage.getElement('LocationStore')
  _packageName = 'ccp.lims.Location'
  _packageShortName = 'LOCA'
  _fieldNames = ('applicationData', 'className', 'createdBy', 'fieldNames', 'guid', 'inConstructor', 'isDeleted', 'isLoaded', 'isModifiable', 'isModified', 'isReading', 'lastUnlockedBy', 'metaclass', 'name', 'packageName', 'packageShortName', 'qualifiedName', 'access', 'activeRepositories', 'locations', 'memopsRoot', 'packageLocator', 'parent', 'root', 'topObject',)
