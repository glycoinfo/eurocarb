...
Autogenerated by PyFileApiGen revision 1.51.2.3 on Mon Apr  6 17:02:48 2009
  from data model element ccp.general.Affiliation revision 1.33.2.9
...
class AffiliationStore(memops.api.Implementation.TopObject):
  ...
  """
  #   from data model element ccp.general.Affiliation.AffiliationStore revision 1.37.2.9
  _metaclass = metaPackage.getElement('AffiliationStore')
  _packageName = 'ccp.general.Affiliation'
  _packageShortName = 'AFFI'
  _fieldNames = ('applicationData', 'className', 'createdBy', 'fieldNames', 'guid', 'inConstructor', 'isDeleted', 'isLoaded', 'isModifiable', 'isModified', 'isReading', 'lastUnlockedBy', 'metaclass', 'name', 'packageName', 'packageShortName', 'qualifiedName', 'access', 'activeRepositories', 'memopsRoot', 'organisations', 'packageLocator', 'parent', 'persons', 'root', 'topObject',)
  ...
  def findAllOrganisations(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        ...
        directAttrs = frozenset(('city', 'country', 'emailAddress', 'faxNumber', 'name', 'organisationType', 'phoneNumber', 'postalCode', 'serial', 'url', 'access', 'affiliationStore',))
...
class Group(memops.api.Implementation.DataObject):
  ...
  """
  #   from data model element ccp.general.Affiliation.Group revision 1.36.2.9
  _metaclass = metaPackage.getElement('Group')
  _packageName = 'ccp.general.Affiliation'
  _packageShortName = 'AFFI'
  _fieldNames = ('applicationData', 'className', 'fieldNames', 'inConstructor', 'isDeleted', 'metaclass', 'name', 'packageName', 'packageShortName', 'qualifiedName', 'serial', 'url', 'access', 'experiments', 'nmrEntries', 'organisation', 'parent', 'personInGroups', 'root', 'topObject',)
...
class Organisation(memops.api.Implementation.DataObject):
  ...
  """
  #   from data model element ccp.general.Affiliation.Organisation revision 1.37.2.9
  _metaclass = metaPackage.getElement('Organisation')
  _packageName = 'ccp.general.Affiliation'
  _packageShortName = 'AFFI'
  _fieldNames = ('addresses', 'applicationData', 'city', 'className', 'country', 'emailAddress', 'faxNumber', 'fieldNames', 'inConstructor', 'isDeleted', 'metaclass', 'name', 'organisationType', 'packageName', 'packageShortName', 'phoneNumber', 'postalCode', 'qualifiedName', 'serial', 'url', 'access', 'affiliationStore', 'groups', 'parent', 'root', 'topObject',)
...
class Person(memops.api.Implementation.DataObject):
  ...
  """
  #   from data model element ccp.general.Affiliation.Person revision 1.41.2.9
  _metaclass = metaPackage.getElement('Person')
  _packageName = 'ccp.general.Affiliation'
  _packageShortName = 'AFFI'
  _fieldNames = ('applicationData', 'className', 'familyName', 'familyTitle', 'fieldNames', 'firstInitial', 'givenName', 'inConstructor', 'isDeleted', 'metaclass', 'middleInitials', 'packageName', 'packageShortName', 'qualifiedName', 'serial', 'title', 'access', 'affiliationStore', 'authorCitations', 'authoredEntries', 'contactEntries', 'createdExps', 'createdProtocols', 'currentPersonInGroup', 'dropAnnotations', 'editedExps', 'editedProtocols', 'editorCitations', 'expBlueprints', 'parent', 'personInGroups', 'root', 'targets', 'topObject', 'users',)
  ...
  def findAllUsers(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        (key, condition) = items[0]
        directAttrs = frozenset(('name', 'access', 'accessControlStore', 'person',))
        if (key in directAttrs):
          for v in currentValues:
            if (condition == v.__dict__.get(key)):
              result.add(v)
...
information.
  """
  #   from data model element ccp.general.Affiliation.PersonInGroup revision 1.37.2.9
  _metaclass = metaPackage.getElement('PersonInGroup')
  _packageName = 'ccp.general.Affiliation'
  _packageShortName = 'AFFI'
  _fieldNames = ('applicationData', 'className', 'deliveryAddress', 'emailAddress', 'endDate', 'faxNumber', 'fieldNames', 'inConstructor', 'isDeleted', 'mailingAddress', 'metaclass', 'packageName', 'packageShortName', 'phoneNumbers', 'position', 'qualifiedName', 'serial', 'access', 'group', 'parent', 'person', 'root', 'topObject',)
