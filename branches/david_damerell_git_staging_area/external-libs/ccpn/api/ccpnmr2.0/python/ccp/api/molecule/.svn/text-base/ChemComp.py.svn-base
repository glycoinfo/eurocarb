...
Autogenerated by PyFileApiGen revision 1.51.2.3 on Mon Apr  6 17:03:10 2009
  from data model element ccp.molecule.ChemComp revision 1.38.2.9
...
LinkAtom partaking in the bond and 'prev_2' for the other LinkAtom.
  """
  #   from data model element ccp.molecule.ChemComp.AbstractChemAtom revision 1.38.2.9
  _metaclass = metaPackage.getElement('AbstractChemAtom')
  _packageName = 'ccp.molecule.ChemComp'
  _packageShortName = 'CHEM'
  _fieldNames = ('applicationData', 'className', 'fieldNames', 'inConstructor', 'isDeleted', 'metaclass', 'name', 'packageName', 'packageShortName', 'qualifiedName', 'subType', 'access', 'chemAngles', 'chemBonds', 'chemComp', 'chemCompVars', 'chemTorsions', 'parent', 'root', 'stereochemistries', 'topObject',)
...
ChemAtom(Set) involved.
  """
  #   from data model element ccp.molecule.ChemComp.AtomSysName revision 1.38.2.9
  _metaclass = metaPackage.getElement('AtomSysName')
  _packageName = 'ccp.molecule.ChemComp'
  _packageShortName = 'CHEM'
  _fieldNames = ('altSysNames', 'applicationData', 'atomName', 'atomSubType', 'className', 'fieldNames', 'inConstructor', 'isDeleted', 'metaclass', 'packageName', 'packageShortName', 'qualifiedName', 'sysName', 'access', 'namingSystem', 'parent', 'root', 'topObject',)
...
class ChemAngle(memops.api.Implementation.DataObject):
  ...
  """
  #   from data model element ccp.molecule.ChemComp.ChemAngle revision 1.38.2.9
  _metaclass = metaPackage.getElement('ChemAngle')
  _packageName = 'ccp.molecule.ChemComp'
  _packageShortName = 'CHEM'
  _fieldNames = ('applicationData', 'className', 'fieldNames', 'inConstructor', 'isDeleted', 'metaclass', 'packageName', 'packageShortName', 'qualifiedName', 'access', 'chemAtoms', 'chemComp', 'parent', 'root', 'topObject',)
...
ChemCompVars.
  """
  #   from data model element ccp.molecule.ChemComp.ChemAtomSet revision 1.46.2.9
  _metaclass = metaPackage.getElement('ChemAtomSet')
  _packageName = 'ccp.molecule.ChemComp'
  _packageShortName = 'CHEM'
  _fieldNames = ('applicationData', 'className', 'distCorr', 'elementSymbol', 'fieldNames', 'inConstructor', 'isDeleted', 'isEquivalent', 'isProchiral', 'metaclass', 'name', 'packageName', 'packageShortName', 'qualifiedName', 'subType', 'access', 'chemAtomSet', 'chemAtomSets', 'chemAtoms', 'chemComp', 'parent', 'root', 'topObject',)
...
class ChemBond(memops.api.Implementation.DataObject):
  ...
  """
  #   from data model element ccp.molecule.ChemComp.ChemBond revision 1.36.2.9
  _metaclass = metaPackage.getElement('ChemBond')
  _packageName = 'ccp.molecule.ChemComp'
  _packageShortName = 'CHEM'
  _fieldNames = ('applicationData', 'bondType', 'className', 'fieldNames', 'inConstructor', 'isDeleted', 'metaclass', 'packageName', 'packageShortName', 'qualifiedName', 'stereochem', 'access', 'chemAtoms', 'chemComp', 'parent', 'root', 'topObject',)
...
for all ChemCompVars, others have different names for different sets. 
  """
  #   from data model element ccp.molecule.ChemComp.ChemCompSysName revision 1.43.2.9
  _metaclass = metaPackage.getElement('ChemCompSysName')
  _packageName = 'ccp.molecule.ChemComp'
  _packageShortName = 'CHEM'
  _fieldNames = ('applicationData', 'className', 'fieldNames', 'inConstructor', 'isDeleted', 'metaclass', 'packageName', 'packageShortName', 'qualifiedName', 'sysName', 'access', 'chemCompVars', 'namingSystem', 'parent', 'root', 'specificChemCompVars', 'topObject',)
...
reference.
  """
  #   from data model element ccp.molecule.ChemComp.ChemTorsion revision 1.39.2.9
  _metaclass = metaPackage.getElement('ChemTorsion')
  _packageName = 'ccp.molecule.ChemComp'
  _packageShortName = 'CHEM'
  _fieldNames = ('applicationData', 'className', 'fieldNames', 'inConstructor', 'isDeleted', 'metaclass', 'name', 'packageName', 'packageShortName', 'qualifiedName', 'access', 'chemAtoms', 'chemComp', 'parent', 'root', 'sysNames', 'topObject',)
...
class ChemTorsionSysName(memops.api.Implementation.DataObject):
  ...
  """
  #   from data model element ccp.molecule.ChemComp.ChemTorsionSysName revision 1.37.2.9
  _metaclass = metaPackage.getElement('ChemTorsionSysName')
  _packageName = 'ccp.molecule.ChemComp'
  _packageShortName = 'CHEM'
  _fieldNames = ('applicationData', 'className', 'fieldNames', 'inConstructor', 'isDeleted', 'metaclass', 'packageName', 'packageShortName', 'qualifiedName', 'sysName', 'access', 'chemTorsion', 'namingSystem', 'parent', 'root', 'topObject',)
...
created and linked to the correct AbstractChemAtoms.
  """
  #   from data model element ccp.molecule.ChemComp.LinkEnd revision 1.47.2.9
  _metaclass = metaPackage.getElement('LinkEnd')
  _packageName = 'ccp.molecule.ChemComp'
  _packageShortName = 'CHEM'
  _fieldNames = ('applicationData', 'className', 'fieldNames', 'inConstructor', 'isDeleted', 'linkCode', 'metaclass', 'packageName', 'packageShortName', 'qualifiedName', 'access', 'boundChemAtom', 'boundLinkAtom', 'chemComp', 'chemCompVars', 'parent', 'remoteChemAtom', 'remoteLinkAtom', 'root', 'topObject',)
...
given explicitly
  """
  #   from data model element ccp.molecule.ChemComp.NamingSystem revision 1.29.2.9
  _metaclass = metaPackage.getElement('NamingSystem')
  _packageName = 'ccp.molecule.ChemComp'
  _packageShortName = 'CHEM'
  _fieldNames = ('applicationData', 'className', 'fieldNames', 'inConstructor', 'isDeleted', 'metaclass', 'name', 'packageName', 'packageShortName', 'qualifiedName', 'access', 'atomReference', 'atomSetReference', 'atomSetVariantSystems', 'atomSysNames', 'atomVariantSystems', 'chemComp', 'chemCompSysNames', 'chemTorsionSysNames', 'mainChemCompSysName', 'parent', 'root', 'topObject',)
...
and their order in the link define the stereochemistry of the atoms.  
  """
  #   from data model element ccp.molecule.ChemComp.Stereochemistry revision 1.40.2.9
  _metaclass = metaPackage.getElement('Stereochemistry')
  _packageName = 'ccp.molecule.ChemComp'
  _packageShortName = 'CHEM'
  _fieldNames = ('applicationData', 'className', 'fieldNames', 'inConstructor', 'isDeleted', 'metaclass', 'packageName', 'packageShortName', 'qualifiedName', 'serial', 'stereoClass', 'value', 'access', 'chemAtoms', 'chemComp', 'parent', 'refStereochemistry', 'root', 'topObject',)
...
definition of LinkEnds. 
  """
  #   from data model element ccp.molecule.ChemComp.LinkAtom revision 1.39.2.9
  _metaclass = metaPackage.getElement('LinkAtom')
  _packageName = 'ccp.molecule.ChemComp'
  _packageShortName = 'CHEM'
  _fieldNames = ('applicationData', 'className', 'elementSymbol', 'fieldNames', 'inConstructor', 'isDeleted', 'metaclass', 'name', 'packageName', 'packageShortName', 'qualifiedName', 'subType', 'access', 'boundLinkEnd', 'chemAngles', 'chemBonds', 'chemComp', 'chemCompVars', 'chemTorsions', 'parent', 'remoteLinkEnd', 'root', 'stereochemistries', 'topObject',)
...
from one.
  """
  #   from data model element ccp.molecule.ChemComp.NonStdChemComp revision 1.39.2.9
...
four standrad DNA or RNA bases
  """
  #   from data model element ccp.molecule.ChemComp.StdChemComp revision 1.41.2.9
