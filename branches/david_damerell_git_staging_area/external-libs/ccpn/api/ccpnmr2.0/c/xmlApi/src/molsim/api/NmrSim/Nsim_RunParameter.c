...
the class key.
  ...
  @returns   the result
**/
ApiInteger Nsim_RunParameter_GetId(Nsim_RunParameter self)
{
  
  ApiInteger obj;
  PyObject *args, *method = PyObject_GetAttrString(self, "getId");
  
  if (!method)
    return raiseApiException("molsim.NmrSim.RunParameter: cannot find method 'getId'");
  if (!PyCallable_Check(method))
    return raiseApiException("molsim.NmrSim.RunParameter: method 'getId' is not callable");
...
/**
  ...
  @returns  the new object
**/
Nsim_RunParameter Nsim_RunParameter_Init_reqd(Nsim_Run parent, char * code, ApiInteger id)
{
...
**/
void *Nsim_RunParameter_SetId(Nsim_RunParameter self, ApiInteger value)
{
  
  void *obj;
  PyObject *args, *method = PyObject_GetAttrString(self, "setId");
  
  if (!method)
    return raiseApiException("molsim.NmrSim.RunParameter: cannot find method 'setId'");
  if (!PyCallable_Check(method))
    return raiseApiException("molsim.NmrSim.RunParameter: method 'setId' is not callable");
