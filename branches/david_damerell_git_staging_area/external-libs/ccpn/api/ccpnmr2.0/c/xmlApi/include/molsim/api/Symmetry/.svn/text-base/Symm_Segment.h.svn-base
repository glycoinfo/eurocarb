...
segment
  ...
  @returns  all value that satisfy the conditions 
**/
extern ApiSet Symm_Segment_FindAllResidues(Symm_Segment self, ApiMap conditions);
...
segment
  ...
  @returns  all value that satisfy the conditions 
**/
extern ApiSet Symm_Segment_FindAllResidues_keyval0(Symm_Segment self);
...
segment
  ...
  @returns  all value that satisfy the conditions 
**/
extern ApiSet Symm_Segment_FindAllResidues_keyval1(Symm_Segment self, char * key, ApiObject value);
...
segment
  ...
  @returns  all value that satisfy the conditions 
**/
extern ApiSet Symm_Segment_FindAllResidues_keyval2(Symm_Segment self, char * key1, ApiObject value1, char * key2, ApiObject value2);
...
segment
  ...
  @returns  all value that satisfy the conditions 
**/
extern ApiSet Symm_Segment_FindAllResidues_keyval3(Symm_Segment self, char * key1, ApiObject value1, char * key2, ApiObject value2, char * key3, ApiObject value3);
...
segment
  ...
  @returns  all value that satisfy the conditions 
**/
extern ApiSet Symm_Segment_FindAllResidues_keyval4(Symm_Segment self, char * key1, ApiObject value1, char * key2, ApiObject value2, char * key3, ApiObject value3, char * key4, ApiObject value4);
...
/**
  ...
  @returns   the result
**/
extern ApiSet Symm_Segment_GetResidues(Symm_Segment self);
...
segment
  ...
  @returns   the result
**/
extern ApiList Symm_Segment_SortedResidues(Symm_Segment self);
