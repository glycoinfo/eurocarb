...
segment
  ...
  @returns  all value that satisfy the conditions 
**/
ApiSet Symm_Segment_FindAllResidues(Symm_Segment self, ApiMap conditions)
{
...
segment
  ...
  @returns  all value that satisfy the conditions 
**/
ApiSet Symm_Segment_FindAllResidues_keyval0(Symm_Segment self)
{
...
segment
  ...
  @returns  all value that satisfy the conditions 
**/
ApiSet Symm_Segment_FindAllResidues_keyval1(Symm_Segment self, char * key, ApiObject value)
{
...
segment
  ...
  @returns  all value that satisfy the conditions 
**/
ApiSet Symm_Segment_FindAllResidues_keyval2(Symm_Segment self, char * key1, ApiObject value1, char * key2, ApiObject value2)
{
...
segment
  ...
  @returns  all value that satisfy the conditions 
**/
ApiSet Symm_Segment_FindAllResidues_keyval3(Symm_Segment self, char * key1, ApiObject value1, char * key2, ApiObject value2, char * key3, ApiObject value3)
{
...
segment
  ...
  @returns  all value that satisfy the conditions 
**/
ApiSet Symm_Segment_FindAllResidues_keyval4(Symm_Segment self, char * key1, ApiObject value1, char * key2, ApiObject value2, char * key3, ApiObject value3, char * key4, ApiObject value4)
{
...
/**
  ...
  @returns   the result
**/
ApiSet Symm_Segment_GetResidues(Symm_Segment self)
{
...
/**
  Sorted for molsim.Symmetry.Segment.residues
...
segment
  ...
  @returns   the result
**/
ApiList Symm_Segment_SortedResidues(Symm_Segment self)
{
  ...
  if (!method)
    return raiseApiException("molsim.Symmetry.Segment: cannot find method 'sortedResidues'");
  if (!PyCallable_Check(method))
    return raiseApiException("molsim.Symmetry.Segment: method 'sortedResidues' is not callable");
