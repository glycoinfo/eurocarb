...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Nmrc_CsaConstraintList_GetActiveAccess(Nmrc_CsaConstraintList self)
{
  ...
  if (!method)
    return raiseApiException("ccp.nmr.NmrConstraint.CsaConstraintList: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccp.nmr.NmrConstraint.CsaConstraintList: method 'getActiveAccess' is not callable");
