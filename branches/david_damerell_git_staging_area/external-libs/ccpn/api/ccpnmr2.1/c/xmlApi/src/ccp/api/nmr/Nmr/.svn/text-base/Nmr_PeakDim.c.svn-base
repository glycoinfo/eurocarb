...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Nmr_PeakDim_GetActiveAccess(Nmr_PeakDim self)
{
  ...
  if (!method)
    return raiseApiException("ccp.nmr.Nmr.PeakDim: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccp.nmr.Nmr.PeakDim: method 'getActiveAccess' is not callable");
