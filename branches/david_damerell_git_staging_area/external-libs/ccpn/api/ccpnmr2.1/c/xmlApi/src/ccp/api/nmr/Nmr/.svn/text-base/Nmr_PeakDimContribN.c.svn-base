...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Nmr_PeakDimContribN_GetActiveAccess(Nmr_PeakDimContribN self)
{
  ...
  if (!method)
    return raiseApiException("ccp.nmr.Nmr.PeakDimContribN: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccp.nmr.Nmr.PeakDimContribN: method 'getActiveAccess' is not callable");
