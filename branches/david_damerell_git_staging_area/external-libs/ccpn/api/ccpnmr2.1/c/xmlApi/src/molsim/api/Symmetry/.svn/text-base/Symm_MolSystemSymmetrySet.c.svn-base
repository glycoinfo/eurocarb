...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Symm_MolSystemSymmetrySet_GetActiveAccess(Symm_MolSystemSymmetrySet self)
{
  ...
  if (!method)
    return raiseApiException("molsim.Symmetry.MolSystemSymmetrySet: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("molsim.Symmetry.MolSystemSymmetrySet: method 'getActiveAccess' is not callable");
