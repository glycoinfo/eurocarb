...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Nmr_ResonanceGroupProb_GetActiveAccess(Nmr_ResonanceGroupProb self)
{
  ...
  if (!method)
    return raiseApiException("ccp.nmr.Nmr.ResonanceGroupProb: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccp.nmr.Nmr.ResonanceGroupProb: method 'getActiveAccess' is not callable");
