...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
extern Acco_AccessObject Entr_RelatedEntry_GetActiveAccess(Entr_RelatedEntry self);
...
related entry
  ...
  @returns   the result
**/
extern ApiString Entr_RelatedEntry_GetDbCode(Entr_RelatedEntry self);
...
explanatory comments, etc.
  ...
  @returns   the result
**/
extern ApiString Entr_RelatedEntry_GetDetails(Entr_RelatedEntry self);
...
/**
  ...
  @returns  the new object
**/
extern Entr_RelatedEntry Entr_RelatedEntry_Init_reqd(Entr_Entry parent, char * dbCode);
...
**/
extern void *Entr_RelatedEntry_SetDbCode(Entr_RelatedEntry self, ApiString value);
...
explanatory comments, etc.
  ...
  @param  ApiString value
**/
extern void *Entr_RelatedEntry_SetDetails(Entr_RelatedEntry self, ApiString value);
