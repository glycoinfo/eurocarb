...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Ccco_ChemCompCoord_GetActiveAccess(Ccco_ChemCompCoord self)
{
  ...
  if (!method)
    return raiseApiException("ccp.molecule.ChemCompCoord.ChemCompCoord: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccp.molecule.ChemCompCoord.ChemCompCoord: method 'getActiveAccess' is not callable");
