...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Nmrx_SystematicName_GetActiveAccess(Nmrx_SystematicName self)
{
  ...
  if (!method)
    return raiseApiException("ccp.nmr.NmrExpPrototype.SystematicName: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccp.nmr.NmrExpPrototype.SystematicName: method 'getActiveAccess' is not callable");
