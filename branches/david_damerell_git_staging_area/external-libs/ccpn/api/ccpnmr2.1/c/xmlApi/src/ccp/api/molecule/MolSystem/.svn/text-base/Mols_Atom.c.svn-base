...
results for Atom
  @param  Mols_Atom self
  @param  Vald_MolSysAtomValidation value
**/
void *Mols_Atom_AddMolSysAtomValidation(Mols_Atom self, Vald_MolSysAtomValidation value)
{
  
  void *obj;
  PyObject *args, *method = PyObject_GetAttrString(self, "addMolSysAtomValidation");
  
  if (!method)
    return raiseApiException("ccp.molecule.MolSystem.Atom: cannot find method 'addMolSysAtomValidation'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccp.molecule.MolSystem.Atom: method 'addMolSysAtomValidation' is not callable");
...
/**
  FindAll for 
ccp.molecule.MolSystem.Atom.molSysAtomValidations
...
for Atom
  ...
  @returns  all value that satisfy the conditions 
**/
ApiSet Mols_Atom_FindAllMolSysAtomValidations(Mols_Atom self, ApiMap conditions)
{
  
  ApiSet obj;
  PyObject *args, *method = PyObject_GetAttrString(self, "findAllMolSysAtomValidations");
  
  if (!method)
    return raiseApiException("ccp.molecule.MolSystem.Atom: cannot find method 'findAllMolSysAtomValidations'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccp.molecule.MolSystem.Atom: method 'findAllMolSysAtomValidations' is not callable");
...
for Atom
  ...
  @returns  all value that satisfy the conditions 
**/
ApiSet Mols_Atom_FindAllMolSysAtomValidations_keyval0(Mols_Atom self)
{
  
  ApiSet  obj;
  PyObject *conditions = PyDict_New();
  
  obj = Mols_Atom_FindAllMolSysAtomValidations(self, conditions);
...
for Atom
  ...
  @returns  all value that satisfy the conditions 
**/
ApiSet Mols_Atom_FindAllMolSysAtomValidations_keyval1(Mols_Atom self, char * key, ApiObject value)
{
...
for Atom
  ...
  @returns  all value that satisfy the conditions 
**/
ApiSet Mols_Atom_FindAllMolSysAtomValidations_keyval2(Mols_Atom self, char * key1, ApiObject value1, char * key2, ApiObject value2)
{
...
for Atom
  ...
  @returns  all value that satisfy the conditions 
**/
ApiSet Mols_Atom_FindAllMolSysAtomValidations_keyval3(Mols_Atom self, char * key1, ApiObject value1, char * key2, ApiObject value2, char * key3, ApiObject value3)
{
...
for Atom
  ...
  @returns  all value that satisfy the conditions 
**/
ApiSet Mols_Atom_FindAllMolSysAtomValidations_keyval4(Mols_Atom self, char * key1, ApiObject value1, char * key2, ApiObject value2, char * key3, ApiObject value3, char * key4, ApiObject value4)
{
...
for Atom
  ...
  @returns  the first value that satisfies the conditions 
**/
Vald_MolSysAtomValidation Mols_Atom_FindFirstMolSysAtomValidation(Mols_Atom self, ApiMap conditions)
{
  
  Vald_MolSysAtomValidation obj;
  PyObject *args, *method = PyObject_GetAttrString(self, "findFirstMolSysAtomValidation");
  
  if (!method)
    return raiseApiException("ccp.molecule.MolSystem.Atom: cannot find method 'findFirstMolSysAtomValidation'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccp.molecule.MolSystem.Atom: method 'findFirstMolSysAtomValidation' is not callable");
...
for Atom
  ...
  @returns  the first value that satisfies the conditions 
**/
Vald_MolSysAtomValidation Mols_Atom_FindFirstMolSysAtomValidation_keyval0(Mols_Atom self)
{
  
  Vald_MolSysAtomValidation  obj;
  PyObject *conditions = PyDict_New();
  
  obj = Mols_Atom_FindFirstMolSysAtomValidation(self, conditions);
...
for Atom
  ...
  @returns  the first value that satisfies the conditions 
**/
Vald_MolSysAtomValidation Mols_Atom_FindFirstMolSysAtomValidation_keyval1(Mols_Atom self, char * key, ApiObject value)
{
...
for Atom
  ...
  @returns  the first value that satisfies the conditions 
**/
Vald_MolSysAtomValidation Mols_Atom_FindFirstMolSysAtomValidation_keyval2(Mols_Atom self, char * key1, ApiObject value1, char * key2, ApiObject value2)
{
...
for Atom
  ...
  @returns  the first value that satisfies the conditions 
**/
Vald_MolSysAtomValidation Mols_Atom_FindFirstMolSysAtomValidation_keyval3(Mols_Atom self, char * key1, ApiObject value1, char * key2, ApiObject value2, char * key3, ApiObject value3)
{
...
for Atom
  ...
  @returns  the first value that satisfies the conditions 
**/
Vald_MolSysAtomValidation Mols_Atom_FindFirstMolSysAtomValidation_keyval4(Mols_Atom self, char * key1, ApiObject value1, char * key2, ApiObject value2, char * key3, ApiObject value3, char * key4, ApiObject value4)
{
...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Mols_Atom_GetActiveAccess(Mols_Atom self)
{
  ...
  if (!method)
    return raiseApiException("ccp.molecule.MolSystem.Atom: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccp.molecule.MolSystem.Atom: method 'getActiveAccess' is not callable");
...
results for Atom
  ...
  @returns   the result
**/
ApiSet Mols_Atom_GetMolSysAtomValidations(Mols_Atom self)
{
  
  ApiSet obj;
  PyObject *args, *method = PyObject_GetAttrString(self, "getMolSysAtomValidations");
  
  if (!method)
    return raiseApiException("ccp.molecule.MolSystem.Atom: cannot find method 'getMolSysAtomValidations'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccp.molecule.MolSystem.Atom: method 'getMolSysAtomValidations' is not callable");
...
results for Atom
  ...
  @param  Vald_MolSysAtomValidation value
**/
void *Mols_Atom_RemoveMolSysAtomValidation(Mols_Atom self, Vald_MolSysAtomValidation value)
{
  
  void *obj;
  PyObject *args, *method = PyObject_GetAttrString(self, "removeMolSysAtomValidation");
  
  if (!method)
    return raiseApiException("ccp.molecule.MolSystem.Atom: cannot find method 'removeMolSysAtomValidation'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccp.molecule.MolSystem.Atom: method 'removeMolSysAtomValidation' is not callable");
...
results for Atom
  ...
  @param  ApiSet values
**/
void *Mols_Atom_SetMolSysAtomValidations(Mols_Atom self, ApiSet values)
{
  
  void *obj;
  PyObject *args, *method = PyObject_GetAttrString(self, "setMolSysAtomValidations");
  
  if (!method)
    return raiseApiException("ccp.molecule.MolSystem.Atom: cannot find method 'setMolSysAtomValidations'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccp.molecule.MolSystem.Atom: method 'setMolSysAtomValidations' is not callable");
...
results for Atom
  ...
  @returns   the result
**/
ApiList Mols_Atom_SortedMolSysAtomValidations(Mols_Atom self)
{
  
  ApiList obj;
  PyObject *args, *method = PyObject_GetAttrString(self, "sortedMolSysAtomValidations");
  
  if (!method)
    return raiseApiException("ccp.molecule.MolSystem.Atom: cannot find method 'sortedMolSysAtomValidations'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccp.molecule.MolSystem.Atom: method 'sortedMolSysAtomValidations' is not callable");
