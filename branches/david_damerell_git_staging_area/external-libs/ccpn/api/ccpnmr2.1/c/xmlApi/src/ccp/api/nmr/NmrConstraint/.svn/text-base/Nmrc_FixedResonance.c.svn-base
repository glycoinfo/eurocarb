...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Nmrc_FixedResonance_GetActiveAccess(Nmrc_FixedResonance self)
{
  ...
  if (!method)
    return raiseApiException("ccp.nmr.NmrConstraint.FixedResonance: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccp.nmr.NmrConstraint.FixedResonance: method 'getActiveAccess' is not callable");
