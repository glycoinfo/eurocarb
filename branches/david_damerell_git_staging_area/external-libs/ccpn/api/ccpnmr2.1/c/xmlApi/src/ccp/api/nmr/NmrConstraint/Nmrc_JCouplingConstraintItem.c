...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Nmrc_JCouplingConstraintItem_GetActiveAccess(Nmrc_JCouplingConstraintItem self)
{
  ...
  if (!method)
    return raiseApiException("ccp.nmr.NmrConstraint.JCouplingConstraintItem: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccp.nmr.NmrConstraint.JCouplingConstraintItem: method 'getActiveAccess' is not callable");
