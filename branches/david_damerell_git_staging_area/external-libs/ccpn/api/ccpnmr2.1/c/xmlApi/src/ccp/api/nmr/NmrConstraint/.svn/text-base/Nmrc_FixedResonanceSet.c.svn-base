...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Nmrc_FixedResonanceSet_GetActiveAccess(Nmrc_FixedResonanceSet self)
{
  ...
  if (!method)
    return raiseApiException("ccp.nmr.NmrConstraint.FixedResonanceSet: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccp.nmr.NmrConstraint.FixedResonanceSet: method 'getActiveAccess' is not callable");
