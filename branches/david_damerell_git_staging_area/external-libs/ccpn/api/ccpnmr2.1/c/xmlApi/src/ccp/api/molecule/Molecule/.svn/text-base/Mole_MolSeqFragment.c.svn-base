...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Mole_MolSeqFragment_GetActiveAccess(Mole_MolSeqFragment self)
{
  ...
  if (!method)
    return raiseApiException("ccp.molecule.Molecule.MolSeqFragment: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccp.molecule.Molecule.MolSeqFragment: method 'getActiveAccess' is not callable");
