...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Anal_SidePanel_GetActiveAccess(Anal_SidePanel self)
{
  ...
  if (!method)
    return raiseApiException("ccpnmr.Analysis.SidePanel: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccpnmr.Analysis.SidePanel: method 'getActiveAccess' is not callable");
