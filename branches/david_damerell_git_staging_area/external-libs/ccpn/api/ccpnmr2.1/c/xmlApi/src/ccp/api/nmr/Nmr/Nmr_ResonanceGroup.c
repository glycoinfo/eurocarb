...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Nmr_ResonanceGroup_GetActiveAccess(Nmr_ResonanceGroup self)
{
  ...
  if (!method)
    return raiseApiException("ccp.nmr.Nmr.ResonanceGroup: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccp.nmr.Nmr.ResonanceGroup: method 'getActiveAccess' is not callable");
