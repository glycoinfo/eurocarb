...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Anal_SlicePanel_GetActiveAccess(Anal_SlicePanel self)
{
  ...
  if (!method)
    return raiseApiException("ccpnmr.Analysis.SlicePanel: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccpnmr.Analysis.SlicePanel: method 'getActiveAccess' is not callable");
...
synonym for spectrumWindowPane
  ...
  @returns   the result
**/
Anal_SpectrumWindowPane Anal_SlicePanel_GetParent(Anal_SlicePanel self)
{
...
parent link
  ...
  @returns   the result
**/
Anal_SpectrumWindowPane Anal_SlicePanel_GetSpectrumWindowPane(Anal_SlicePanel self)
{
  ...
  if (!method)
    return raiseApiException("ccpnmr.Analysis.SlicePanel: cannot find method 'getSpectrumWindowPane'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccpnmr.Analysis.SlicePanel: method 'getSpectrumWindowPane' is not callable");
...
**/
Anal_SlicePanel Anal_SlicePanel_Init(Anal_SpectrumWindowPane parent, ApiMap attrlinks)
{
  
  return Anal_SpectrumWindowPane_NewSlicePanel(parent, attrlinks);
}
...
/**
  ...
  @returns  the new object
**/
Anal_SlicePanel Anal_SlicePanel_Init_reqd(Anal_SpectrumWindowPane parent, char * label)
{
