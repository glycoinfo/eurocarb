...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Nmrc_AbstractConstraintList_GetActiveAccess(Nmrc_AbstractConstraintList self)
{
  ...
  if (!method)
    return raiseApiException("ccp.nmr.NmrConstraint.AbstractConstraintList: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccp.nmr.NmrConstraint.AbstractConstraintList: method 'getActiveAccess' is not callable");
