...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Cryz_Score_GetActiveAccess(Cryz_Score self)
{
  ...
  if (!method)
    return raiseApiException("ccp.lims.Crystallization.Score: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccp.lims.Crystallization.Score: method 'getActiveAccess' is not callable");
