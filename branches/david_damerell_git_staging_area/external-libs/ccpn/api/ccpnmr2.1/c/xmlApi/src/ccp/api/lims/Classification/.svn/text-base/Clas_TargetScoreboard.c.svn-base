...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Clas_TargetScoreboard_GetActiveAccess(Clas_TargetScoreboard self)
{
  ...
  if (!method)
    return raiseApiException("ccp.lims.Classification.TargetScoreboard: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccp.lims.Classification.TargetScoreboard: method 'getActiveAccess' is not callable");
