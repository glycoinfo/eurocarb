...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Anal_AtomSetMapping_GetActiveAccess(Anal_AtomSetMapping self)
{
  ...
  if (!method)
    return raiseApiException("ccpnmr.Analysis.AtomSetMapping: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccpnmr.Analysis.AtomSetMapping: method 'getActiveAccess' is not callable");
