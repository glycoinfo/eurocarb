...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Anal_AnalysisPeakList_GetActiveAccess(Anal_AnalysisPeakList self)
{
  ...
  if (!method)
    return raiseApiException("ccpnmr.Analysis.AnalysisPeakList: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccpnmr.Analysis.AnalysisPeakList: method 'getActiveAccess' is not callable");
