...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Affi_AffiliationStore_GetActiveAccess(Affi_AffiliationStore self)
{
  ...
  if (!method)
    return raiseApiException("ccp.general.Affiliation.AffiliationStore: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccp.general.Affiliation.AffiliationStore: method 'getActiveAccess' is not callable");
