...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Nmrc_ChainStateLink_GetActiveAccess(Nmrc_ChainStateLink self)
{
  ...
  if (!method)
    return raiseApiException("ccp.nmr.NmrConstraint.ChainStateLink: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccp.nmr.NmrConstraint.ChainStateLink: method 'getActiveAccess' is not callable");
