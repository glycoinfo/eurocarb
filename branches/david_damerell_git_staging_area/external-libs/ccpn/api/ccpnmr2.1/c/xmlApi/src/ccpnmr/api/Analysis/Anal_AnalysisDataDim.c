...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Anal_AnalysisDataDim_GetActiveAccess(Anal_AnalysisDataDim self)
{
  ...
  if (!method)
    return raiseApiException("ccpnmr.Analysis.AnalysisDataDim: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccpnmr.Analysis.AnalysisDataDim: method 'getActiveAccess' is not callable");
