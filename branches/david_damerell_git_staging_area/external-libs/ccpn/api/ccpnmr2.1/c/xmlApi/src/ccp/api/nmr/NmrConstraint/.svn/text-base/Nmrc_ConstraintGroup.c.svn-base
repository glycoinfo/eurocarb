...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Nmrc_ConstraintGroup_GetActiveAccess(Nmrc_ConstraintGroup self)
{
  ...
  if (!method)
    return raiseApiException("ccp.nmr.NmrConstraint.ConstraintGroup: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccp.nmr.NmrConstraint.ConstraintGroup: method 'getActiveAccess' is not callable");
