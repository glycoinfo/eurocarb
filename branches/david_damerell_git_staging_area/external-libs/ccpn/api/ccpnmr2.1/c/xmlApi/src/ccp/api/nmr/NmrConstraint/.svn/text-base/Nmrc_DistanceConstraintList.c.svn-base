...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Nmrc_DistanceConstraintList_GetActiveAccess(Nmrc_DistanceConstraintList self)
{
  ...
  if (!method)
    return raiseApiException("ccp.nmr.NmrConstraint.DistanceConstraintList: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccp.nmr.NmrConstraint.DistanceConstraintList: method 'getActiveAccess' is not callable");
