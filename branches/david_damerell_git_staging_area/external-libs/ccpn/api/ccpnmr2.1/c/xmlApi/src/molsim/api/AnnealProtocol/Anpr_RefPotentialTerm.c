...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Anpr_RefPotentialTerm_GetActiveAccess(Anpr_RefPotentialTerm self)
{
  ...
  if (!method)
    return raiseApiException("molsim.AnnealProtocol.RefPotentialTerm: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("molsim.AnnealProtocol.RefPotentialTerm: method 'getActiveAccess' is not callable");
