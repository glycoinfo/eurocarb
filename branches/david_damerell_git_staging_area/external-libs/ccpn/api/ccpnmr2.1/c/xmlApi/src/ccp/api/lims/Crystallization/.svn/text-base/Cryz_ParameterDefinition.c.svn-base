...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Cryz_ParameterDefinition_GetActiveAccess(Cryz_ParameterDefinition self)
{
  ...
  if (!method)
    return raiseApiException("ccp.lims.Crystallization.ParameterDefinition: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccp.lims.Crystallization.ParameterDefinition: method 'getActiveAccess' is not callable");
