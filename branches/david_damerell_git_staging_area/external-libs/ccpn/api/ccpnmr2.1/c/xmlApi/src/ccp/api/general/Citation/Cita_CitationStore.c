...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Cita_CitationStore_GetActiveAccess(Cita_CitationStore self)
{
  ...
  if (!method)
    return raiseApiException("ccp.general.Citation.CitationStore: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccp.general.Citation.CitationStore: method 'getActiveAccess' is not callable");
