...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Coor_Residue_GetActiveAccess(Coor_Residue self)
{
  ...
  if (!method)
    return raiseApiException("ccp.molecule.MolStructure.Residue: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccp.molecule.MolStructure.Residue: method 'getActiveAccess' is not callable");
