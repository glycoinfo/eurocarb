...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Cclb_AtomLabel_GetActiveAccess(Cclb_AtomLabel self)
{
  ...
  if (!method)
    return raiseApiException("ccp.molecule.ChemCompLabel.AtomLabel: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccp.molecule.ChemCompLabel.AtomLabel: method 'getActiveAccess' is not callable");
