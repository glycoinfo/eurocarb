...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Nmap_ResonanceLinkMapping_GetActiveAccess(Nmap_ResonanceLinkMapping self)
{
  ...
  if (!method)
    return raiseApiException("ccpnmr.NameMapping.ResonanceLinkMapping: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccpnmr.NameMapping.ResonanceLinkMapping: method 'getActiveAccess' is not callable");
