...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Nmr_HExchProtectionList_GetActiveAccess(Nmr_HExchProtectionList self)
{
  ...
  if (!method)
    return raiseApiException("ccp.nmr.Nmr.HExchProtectionList: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccp.nmr.Nmr.HExchProtectionList: method 'getActiveAccess' is not callable");
