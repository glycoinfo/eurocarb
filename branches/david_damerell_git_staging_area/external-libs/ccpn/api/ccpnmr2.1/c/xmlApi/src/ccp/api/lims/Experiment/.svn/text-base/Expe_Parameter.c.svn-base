...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Expe_Parameter_GetActiveAccess(Expe_Parameter self)
{
  ...
  if (!method)
    return raiseApiException("ccp.lims.Experiment.Parameter: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccp.lims.Experiment.Parameter: method 'getActiveAccess' is not callable");
