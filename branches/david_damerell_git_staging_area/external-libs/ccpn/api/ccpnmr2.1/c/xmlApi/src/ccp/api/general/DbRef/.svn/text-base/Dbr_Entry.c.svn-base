...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Dbr_Entry_GetActiveAccess(Dbr_Entry self)
{
  ...
  if (!method)
    return raiseApiException("ccp.general.DbRef.Entry: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccp.general.DbRef.Entry: method 'getActiveAccess' is not callable");
