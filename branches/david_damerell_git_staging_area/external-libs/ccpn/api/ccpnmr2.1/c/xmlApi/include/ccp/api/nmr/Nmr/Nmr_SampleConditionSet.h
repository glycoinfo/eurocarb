...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
extern Acco_AccessObject Nmr_SampleConditionSet_GetActiveAccess(Nmr_SampleConditionSet self);
...
- for easier user reference
  ...
  @returns   the result
**/
extern ApiString Nmr_SampleConditionSet_GetName(Nmr_SampleConditionSet self);
...
- for easier user reference
  ...
  @param  ApiString value
**/
extern void *Nmr_SampleConditionSet_SetName(Nmr_SampleConditionSet self, ApiString value);
