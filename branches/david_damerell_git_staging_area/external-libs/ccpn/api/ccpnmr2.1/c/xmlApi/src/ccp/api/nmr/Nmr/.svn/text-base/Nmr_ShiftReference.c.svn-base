...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Nmr_ShiftReference_GetActiveAccess(Nmr_ShiftReference self)
{
  ...
  if (!method)
    return raiseApiException("ccp.nmr.Nmr.ShiftReference: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccp.nmr.Nmr.ShiftReference: method 'getActiveAccess' is not callable");
