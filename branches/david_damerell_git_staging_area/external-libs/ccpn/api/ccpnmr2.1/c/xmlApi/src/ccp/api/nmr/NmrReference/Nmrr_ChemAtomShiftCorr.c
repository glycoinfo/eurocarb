...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Nmrr_ChemAtomShiftCorr_GetActiveAccess(Nmrr_ChemAtomShiftCorr self)
{
  ...
  if (!method)
    return raiseApiException("ccp.nmr.NmrReference.ChemAtomShiftCorr: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccp.nmr.NmrReference.ChemAtomShiftCorr: method 'getActiveAccess' is not callable");
