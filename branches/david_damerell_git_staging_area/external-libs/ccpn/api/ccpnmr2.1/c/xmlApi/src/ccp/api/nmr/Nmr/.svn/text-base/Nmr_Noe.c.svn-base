...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Nmr_Noe_GetActiveAccess(Nmr_Noe self)
{
  ...
  if (!method)
    return raiseApiException("ccp.nmr.Nmr.Noe: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccp.nmr.Nmr.Noe: method 'getActiveAccess' is not callable");
