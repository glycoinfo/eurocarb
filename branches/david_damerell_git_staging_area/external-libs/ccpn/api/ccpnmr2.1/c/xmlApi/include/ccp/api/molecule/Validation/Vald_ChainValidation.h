...
#ifndef __incl__ccp_api_molecule_Validation_ChainValidation_h__
#define __incl__ccp_api_molecule_Validation_ChainValidation_h__
...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
extern Acco_AccessObject Vald_ChainValidation_GetActiveAccess(Vald_ChainValidation self);
...
#endif /* __incl__ccp_api_molecule_Validation_ChainValidation_h__ */
