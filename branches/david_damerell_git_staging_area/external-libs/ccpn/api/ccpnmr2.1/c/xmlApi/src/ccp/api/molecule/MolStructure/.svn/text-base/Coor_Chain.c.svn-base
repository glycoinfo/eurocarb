...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Coor_Chain_GetActiveAccess(Coor_Chain self)
{
  ...
  if (!method)
    return raiseApiException("ccp.molecule.MolStructure.Chain: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccp.molecule.MolStructure.Chain: method 'getActiveAccess' is not callable");
