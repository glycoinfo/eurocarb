...
**/
Impl_AppDataString Impl_AppDataString_Clone(Impl_AppDataString self, ApiMap attrDict)
{
  ...
  if (!method)
    return raiseApiException("memops.Implementation.AppDataString: cannot find method 'clone'");
  if (!PyCallable_Check(method))
    return raiseApiException("memops.Implementation.AppDataString: method 'clone' is not callable");
