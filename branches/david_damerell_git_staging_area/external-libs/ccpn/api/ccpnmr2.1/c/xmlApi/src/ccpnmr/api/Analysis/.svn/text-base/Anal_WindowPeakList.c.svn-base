...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Anal_WindowPeakList_GetActiveAccess(Anal_WindowPeakList self)
{
  ...
  if (!method)
    return raiseApiException("ccpnmr.Analysis.WindowPeakList: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccpnmr.Analysis.WindowPeakList: method 'getActiveAccess' is not callable");
