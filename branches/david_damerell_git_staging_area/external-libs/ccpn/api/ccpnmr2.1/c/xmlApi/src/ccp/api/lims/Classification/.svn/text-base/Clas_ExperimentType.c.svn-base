...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Clas_ExperimentType_GetActiveAccess(Clas_ExperimentType self)
{
  ...
  if (!method)
    return raiseApiException("ccp.lims.Classification.ExperimentType: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccp.lims.Classification.ExperimentType: method 'getActiveAccess' is not callable");
