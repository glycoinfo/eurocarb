...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Nmr_T2List_GetActiveAccess(Nmr_T2List self)
{
  ...
  if (!method)
    return raiseApiException("ccp.nmr.Nmr.T2List: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccp.nmr.Nmr.T2List: method 'getActiveAccess' is not callable");
...
/**
  Get for ccp.nmr.Nmr.T2List.tempCalibMethod
...
method (open string enumeration)
  ...
  @returns   the result
**/
ApiString Nmr_T2List_GetTempCalibMethod(Nmr_T2List self)
{
  ...
  if (!method)
    return raiseApiException("ccp.nmr.Nmr.T2List: cannot find method 'getTempCalibMethod'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccp.nmr.Nmr.T2List: method 'getTempCalibMethod' is not callable");
...
/**
  Get for ccp.nmr.Nmr.T2List.tempControlMethod

Temperature control method 
(open string enumeration)
  @param  Nmr_T2List self
  @returns   the result
**/
ApiString Nmr_T2List_GetTempControlMethod(Nmr_T2List self)
{
  ...
  if (!method)
    return raiseApiException("ccp.nmr.Nmr.T2List: cannot find method 'getTempControlMethod'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccp.nmr.Nmr.T2List: method 'getTempControlMethod' is not callable");
...
/**
  Set for ccp.nmr.Nmr.T2List.tempCalibMethod
...
method (open string enumeration)
  ...
  @param  ApiString value
**/
void *Nmr_T2List_SetTempCalibMethod(Nmr_T2List self, ApiString value)
{
  ...
  if (!method)
    return raiseApiException("ccp.nmr.Nmr.T2List: cannot find method 'setTempCalibMethod'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccp.nmr.Nmr.T2List: method 'setTempCalibMethod' is not callable");
...
/**
  Set for ccp.nmr.Nmr.T2List.tempControlMethod
...
(open string enumeration)
  ...
  @param  ApiString value
**/
void *Nmr_T2List_SetTempControlMethod(Nmr_T2List self, ApiString value)
{
  ...
  if (!method)
    return raiseApiException("ccp.nmr.Nmr.T2List: cannot find method 'setTempControlMethod'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccp.nmr.Nmr.T2List: method 'setTempControlMethod' is not callable");
