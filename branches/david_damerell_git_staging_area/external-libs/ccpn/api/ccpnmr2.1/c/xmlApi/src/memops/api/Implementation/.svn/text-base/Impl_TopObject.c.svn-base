...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Impl_TopObject_GetActiveAccess(Impl_TopObject self)
{
  ...
  if (!method)
    return raiseApiException("memops.Implementation.TopObject: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("memops.Implementation.TopObject: method 'getActiveAccess' is not callable");
