...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Chem_ChemTorsion_GetActiveAccess(Chem_ChemTorsion self)
{
  ...
  if (!method)
    return raiseApiException("ccp.molecule.ChemComp.ChemTorsion: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccp.molecule.ChemComp.ChemTorsion: method 'getActiveAccess' is not callable");
