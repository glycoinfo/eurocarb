...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Dloc_DataUrl_GetActiveAccess(Dloc_DataUrl self)
{
  ...
  if (!method)
    return raiseApiException("ccp.general.DataLocation.DataUrl: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccp.general.DataLocation.DataUrl: method 'getActiveAccess' is not callable");
