...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Clas_SampleCategory_GetActiveAccess(Clas_SampleCategory self)
{
  ...
  if (!method)
    return raiseApiException("ccp.lims.Classification.SampleCategory: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccp.lims.Classification.SampleCategory: method 'getActiveAccess' is not callable");
