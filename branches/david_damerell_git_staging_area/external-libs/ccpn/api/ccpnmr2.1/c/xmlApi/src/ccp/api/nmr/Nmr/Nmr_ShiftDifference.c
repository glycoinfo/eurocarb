...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Nmr_ShiftDifference_GetActiveAccess(Nmr_ShiftDifference self)
{
  ...
  if (!method)
    return raiseApiException("ccp.nmr.Nmr.ShiftDifference: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccp.nmr.Nmr.ShiftDifference: method 'getActiveAccess' is not callable");
