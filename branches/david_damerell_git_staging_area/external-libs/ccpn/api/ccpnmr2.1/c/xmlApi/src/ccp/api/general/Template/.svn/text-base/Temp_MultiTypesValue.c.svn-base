...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Temp_MultiTypesValue_GetActiveAccess(Temp_MultiTypesValue self)
{
  ...
  if (!method)
    return raiseApiException("ccp.general.Template.MultiTypesValue: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccp.general.Template.MultiTypesValue: method 'getActiveAccess' is not callable");
