...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Hold_HolderTypePosition_GetActiveAccess(Hold_HolderTypePosition self)
{
  ...
  if (!method)
    return raiseApiException("ccp.lims.Holder.HolderTypePosition: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccp.lims.Holder.HolderTypePosition: method 'getActiveAccess' is not callable");
