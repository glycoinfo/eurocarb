...
class DangleChain(memops.api.Implementation.DataObject):
  ...
  """
  #   from data model element cambridge.Dangle.DangleChain revision 1.1.2.9
...
class DangleResidue(memops.api.Implementation.DataObject):
  ...
  """
  #   from data model element cambridge.Dangle.DangleResidue revision 1.2.2.9
...
class serves as TopObject. 
  """
  #   from data model element cambridge.Dangle.DangleStore revision 1.1.2.9
