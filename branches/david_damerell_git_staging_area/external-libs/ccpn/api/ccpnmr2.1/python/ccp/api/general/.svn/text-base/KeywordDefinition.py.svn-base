...
Autogenerated by PyFileApiGen revision 1.51.2.5 on Fri Sep 18 15:08:44 2009
...
class KeywordDefinition(memops.api.Implementation.DataObject):
  r"""
  """
  #   from data model element ccp.general.KeywordDefinition.KeywordDefinition revision 1.8.2.10
...
program or standard). 
  """
  #   from data model element ccp.general.KeywordDefinition.KeywordDefinitionStore revision 1.8.2.10
