...
Autogenerated by PyFileApiGen revision 1.51.2.5 on Fri Sep 18 15:09:32 2009
...
cleared first.
  """
  #   from data model element ccp.molecule.MolSystem.Atom revision 1.41.2.10
...
normal way of dividing a Chain in ChainFragments.
  """
  #   from data model element ccp.molecule.MolSystem.ChainFragment revision 1.38.2.10
...
class ChainInteraction(memops.api.Implementation.DataObject):
  ...
  """
  #   from data model element ccp.molecule.MolSystem.ChainInteraction revision 1.36.2.10
...
NMR-observable impurities in an Nmr study). 
  """
  #   from data model element ccp.molecule.MolSystem.MolSystem revision 1.41.2.10
  _metaclass = metaPackage.getElement('MolSystem')
  _packageName = 'ccp.molecule.MolSystem'
  _packageShortName = 'MOLS'
  _fieldNames = ('applicationData', 'className', 'code', 'commonNames', 'createdBy', 'details', 'fieldNames', 'functions', 'guid', 'hasChemExchange', 'inConstructor', 'isDeleted', 'isLoaded', 'isModifiable', 'isModified', 'isParamagnetic', 'isReading', 'keywords', 'lastUnlockedBy', 'metaclass', 'molecularMass', 'name', 'numChains', 'packageName', 'packageShortName', 'qualifiedName', 'access', 'activeAccess', 'activeRepositories', 'chainInteractions', 'chains', 'citations', 'dbReferences', 'entries', 'memopsRoot', 'molSystemLinks', 'molSystemSymmetrySets', 'molSystemSysNames', 'molSystemValidations', 'nmrExperiments', 'nmrSimRuns', 'nonCovalentBonds', 'packageLocator', 'parent', 'root', 'structureEnsembles', 'structureGroups', 'topObject',)
...
links.
  """
  #   from data model element ccp.molecule.MolSystem.MolSystemLink revision 1.36.2.10
...
of the MolSystem
  """
  #   from data model element ccp.molecule.MolSystem.MolSystemLinkEnd revision 1.41.2.10
...
class MolSystemSysName(memops.api.Implementation.DataObject):
  ...
  """
  #   from data model element ccp.molecule.MolSystem.MolSystemSysName revision 1.36.2.10
...
class NonCovalentBond(memops.api.Implementation.DataObject):
  ...
  """
  #   from data model element ccp.molecule.MolSystem.NonCovalentBond revision 1.36.2.10
...
(Chain)). 
  """
  #   from data model element ccp.molecule.MolSystem.Residue revision 1.46.2.10
...
structures. May be from same or different generation cycles.
  """
  #   from data model element ccp.molecule.MolSystem.StructureGroup revision 1.37.2.10
