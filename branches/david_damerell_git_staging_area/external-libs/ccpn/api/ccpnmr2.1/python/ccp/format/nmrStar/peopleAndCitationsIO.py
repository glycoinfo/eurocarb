...
from ccp.format.general.formatIO import Person, Citation, Keyword
    ...
    if self.version in ('3.0','3.1'): 
      ...
      #
        ...
        if citationType == 'journal':
          citationTagNames += ['Journal_abbrev','Journal_volume','Journal_issue','Page_first','Year',None,None,None,'isPrimary','Page_last','Journal_name_full','PubMed_ID','Details',None,None]
        elif citationType == 'book':
          citationTagNames += [None,'Book_volume',None,'Page_first','Year','Book_publisher_city','Book_publisher',None,'isPrimary','Page_last',None,None,'Details','Book_title','Book_series']
        elif citationType == 'conference' or citationType == 'abstract':
          citationTagNames += [None,None,None,'Page_first','Year','Conference_site',None,'Conference_country','isPrimary','Page_last',None,None,'Details','Conference_title',None]
        elif citationType == 'thesis':
          citationTagNames += [None,None,None,'Page_first','Year','Thesis_institution_city','Thesis_institution','Thesis_institution_country','isPrimary','Page_last',None,None,'Details',None,None]
        elif citationType == 'BMRB only':
          citationTagNames += [None,None,None,None,None,None,None,None,'isPrimary',None,None,None,'Details',None,None]
        ...
        for tagName in citationTagNames:
          ...
          elif self.saveFrame.tags.has_key(tagName):
