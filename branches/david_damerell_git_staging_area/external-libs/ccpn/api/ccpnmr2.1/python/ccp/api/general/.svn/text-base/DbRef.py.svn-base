...
Autogenerated by PyFileApiGen revision 1.51.2.5 on Fri Sep 18 15:08:53 2009
  from data model element ccp.general.DbRef revision 1.34.2.10
...
class Database(memops.api.Implementation.TopObject):
  ...
  """
  #   from data model element ccp.general.DbRef.Database revision 1.37.2.10
...
database.
  """
  #   from data model element ccp.general.DbRef.Entry revision 1.37.2.10
