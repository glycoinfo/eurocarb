...
Autogenerated by PyFileApiGen revision 1.51.2.5 on Fri Sep 18 15:09:16 2009
  from data model element ccp.molecule.ChemCompCharge revision 1.35.2.10
...
class ChemAtomCharge(memops.api.Implementation.DataObject):
  ...
  """
  #   from data model element ccp.molecule.ChemCompCharge.ChemAtomCharge revision 1.42.2.10
...
class ChemCompCharge(memops.api.Implementation.TopObject):
  ...
  """
  #   from data model element ccp.molecule.ChemCompCharge.ChemCompCharge revision 1.41.2.10
...
with an 'any' attribute must belong to all the relevant Vars
  """
  #   from data model element ccp.molecule.ChemCompCharge.ChemCompVarCharge revision 1.39.2.10
