...
Autogenerated by PyFileApiGen revision 1.51.2.5 on Fri Sep 18 15:08:54 2009
  from data model element ccp.general.Taxonomy revision 1.36.2.10
...
class NaturalSource(memops.api.Implementation.DataObject):
  ...
  """
  #   from data model element ccp.general.Taxonomy.NaturalSource revision 1.36.2.10
...
class Taxonomy(memops.api.Implementation.TopObject):
  ...
  """
  #   from data model element ccp.general.Taxonomy.Taxonomy revision 1.38.2.10
