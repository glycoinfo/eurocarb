...
currentModelVersion = Version.Version(2,0,'b',3,'','DataModel')
...
emptyRepositoryId = "$Id: Constants.py,v 1.45.2.6 2009/09/14 14:45:29 wimvranken Exp $"
emptyRepositoryTag = "$Name: release_2_1_0_2 $"
