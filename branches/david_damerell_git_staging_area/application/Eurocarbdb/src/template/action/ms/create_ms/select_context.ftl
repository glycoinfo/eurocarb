...
<h2>Alternatively</h2>
<@ecdb.actionlink name="contribute_structure">Create a new sequence and/or context</@><br/>
<@ecdb.actionlink name="create_acquisition!input">Directly upload mzXML file</@>
