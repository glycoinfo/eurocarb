...
<h1>Overview of Acquisition num. ${acquisition.acquisitionId} <#if acquisition.contributor.equals(currentContributor)><@ecdb.actionlink name="edit_acquisition!input" class="ecdb_button" params="acquisition.acquisitionId=${acquisition.acquisitionId}&acquisition.evidenceId=${acquisition.evidenceId}">Edit</@></#if></h1>
