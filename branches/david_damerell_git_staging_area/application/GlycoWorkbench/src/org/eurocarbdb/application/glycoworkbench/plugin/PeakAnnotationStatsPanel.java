...
public class PeakAnnotationStatsPanel extends SortingTablePanel<AnnotatedPeakList> implements ActionListener {
    ...
    theActionManager.add("transfer",FileUtils.getIcon("transfer"),"Copy structures into canvas",KeyEvent.VK_V, "",this);

    theActionManager.add("showdetails",FileUtils.getIcon("showdetails"),"Show annotation details",KeyEvent.VK_D, "",this);
    }
