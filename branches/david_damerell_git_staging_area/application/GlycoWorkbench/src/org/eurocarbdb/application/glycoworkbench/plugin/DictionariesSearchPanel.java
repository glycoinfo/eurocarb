...
public class DictionariesSearchPanel extends TablePanel<ProfilerPlugin> implements ActionListener, ChangeListener {
    ...
    theActionManager.add("search",FileUtils.getIcon("search"),"Search the dictionary",-1, "",this);
    theActionManager.add("searchagain",FileUtils.getIcon("searchagain"),"Search in the current results",-1, "",this);
    theActionManager.add("clearsearch",FileUtils.getIcon("clearsearch"),"Clear search",-1, "",this);
    }
