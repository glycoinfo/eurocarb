...
public class GAGPlugin implements Plugin, ActionListener {
    ...
    actions.add(new GlycanAction("computeStructures",FileUtils.getIcon(""),"Compute all the possible structures for a given family",KeyEvent.VK_M,"",this));
    actions.add(new GlycanAction("findStructures",FileUtils.getIcon(""),"Find all the structures of a given family with a certain m/z value",KeyEvent.VK_F,"",this));
    actions.add(new GlycanAction("matchStructures",FileUtils.getIcon(""),"Annotate peaks with structures from a given family",KeyEvent.VK_N,"",this));

    actions.add(null);

    actions.add(new GlycanAction("findSulfationsCurrent",FileUtils.getIcon(""),"Find the sulfation patterns of the current structures with a given m/z value",KeyEvent.VK_C,"",this));
    actions.add(new GlycanAction("findSulfationsSelected",FileUtils.getIcon(""),"Find the sulfation patterns of the selected structures with a given m/z value",KeyEvent.VK_S,"",this));
    actions.add(new GlycanAction("findSulfationsAll",FileUtils.getIcon(""),"Find the sulfation patterns of all structures with a given m/z value",KeyEvent.VK_A,"",this));

    actions.add(null);

    actions.add(new GlycanAction("matchSulfationsCurrent",FileUtils.getIcon(""),"Annotate peaks with sulfation patterns of the current structures",KeyEvent.VK_U,"",this));
    actions.add(new GlycanAction("matchSulfationsSelected",FileUtils.getIcon(""),"Annotate peaks with sulfation patterns of the selected structures",KeyEvent.VK_E,"",this));
    actions.add(new GlycanAction("matchSulfationsAll",FileUtils.getIcon(""),"Annotate peaks with sulfation patterns of all structures",KeyEvent.VK_L,"",this));    
    ...
    theManager = manager;
    if( theManager!=null ) 
        theManager.addMsPeakAction(new GlycanAction("findStructures",FileUtils.getIcon(""),"Find all GAG structures matching the peaks",KeyEvent.VK_F,"",this));
    }
