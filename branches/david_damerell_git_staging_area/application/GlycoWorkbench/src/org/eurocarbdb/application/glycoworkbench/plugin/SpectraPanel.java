...
public class SpectraPanel extends DocumentPanel<SpectraDocument> implements ActionListener, MouseListener, MouseMotionListener {        
    ...
    theActionManager.add("mslevel=ms",FileUtils.getIcon("msms"),"Change current scan level",-1, "",this);
    theActionManager.add("mslevel=msms",FileUtils.getIcon("ms"),"Change current scan level",-1, "",this);

    theActionManager.add("updateisotopecurves=true",FileUtils.getIcon("isotopesoff"),"Automatic computation of isotopic distributions inactive",-1, "",this);
    theActionManager.add("updateisotopecurves=false",FileUtils.getIcon("isotopeson"),"Automatic computation of isotopic distributions active",-1, "",this);

    theActionManager.add("showallisotopes=true",FileUtils.getIcon("ftmodeoff"),"FTICR mode inactive",-1, "",this);
    theActionManager.add("showallisotopes=false",FileUtils.getIcon("ftmodeon"),"FTICR mode active",-1, "",this);

    theActionManager.add("close",FileUtils.getIcon("close"),"Close structure",KeyEvent.VK_S, "",this);
    theActionManager.add("previous",FileUtils.getIcon("previous"),"Previous structure",KeyEvent.VK_L, "",this);
    theActionManager.add("next",FileUtils.getIcon("next"),"Next structure",KeyEvent.VK_N, "",this);

    theActionManager.add("edit",FileUtils.getIcon("edit"),"Edit scan data",-1, "",this);

    theActionManager.add("new",FileUtils.getIcon("new"),"Clear",KeyEvent.VK_N, "",this);
    theActionManager.add("openspectra",FileUtils.getIcon("openspectra"),"Open Spectra",KeyEvent.VK_O, "",this);

    theActionManager.add("print",FileUtils.getIcon("print"),"Print...",KeyEvent.VK_P, "",this);

    theActionManager.add("addpeaks",FileUtils.getIcon("addpeaks"),"Add selected peaks to list",-1, "",this);
    theActionManager.add("annotatepeaks",FileUtils.getIcon("annotatepeaks"),"Find possible annotations for selected peaks",-1, "",this);
    theActionManager.add("baselinecorrection",FileUtils.getIcon("baseline"),"Baseline correction of current spectrum", -1, "", this);
    theActionManager.add("noisefilter",FileUtils.getIcon("noisefilter"),"Filter noise in current spectrum", -1, "", this);
    theActionManager.add("centroid",FileUtils.getIcon("centroid"),"Compute peak centroids",-1, "",this);

    theActionManager.add("arrow",FileUtils.getIcon("arrow"),"Activate zoom",-1, "",this);
    theActionManager.add("hand",FileUtils.getIcon("hand"),"Activate moving",-1, "",this);

    theActionManager.add("zoomnone",FileUtils.getIcon("zoomnone"),"Reset zoom",-1, "",this);
    theActionManager.add("zoomin",FileUtils.getIcon("zoomin"),"Zoom in",-1, "",this);
    theActionManager.add("zoomout",FileUtils.getIcon("zoomout"),"Zoom out",-1, "",this);
    }
