...
public class DictionariesEditPanel extends TablePanel<ProfilerPlugin> implements ActionListener, ItemListener, ChangeListener, ProfilerPlugin.DictionariesChangeListener {
    ...
    theActionManager.add("first",FileUtils.getIcon("first"),"First page",-1, "",this);
    theActionManager.add("pprevious",FileUtils.getIcon("pprevious"),"Five pages before",-1, "",this);
    theActionManager.add("previous",FileUtils.getIcon("previous"),"Previous page",-1, "",this);
    theActionManager.add("next",FileUtils.getIcon("next"),"Next page",-1, "",this);
    theActionManager.add("nnext",FileUtils.getIcon("nnext"),"Five pages after",-1, "",this);
    theActionManager.add("last",FileUtils.getIcon("last"),"Last page",-1, "",this);
    ...
    theActionManager.add("paste",FileUtils.getIcon("paste"),"Paste",KeyEvent.VK_C, "",this);
    theActionManager.add("delete",FileUtils.getIcon("delete"),"Delete",-1, "",this);
    
    theActionManager.add("transfer",FileUtils.getIcon("transfer"),"Copy structures to canvas",KeyEvent.VK_V, "",this);

    theActionManager.add("goto",FileUtils.getIcon("goto"),"Jump to a specific m/z value",-1, "",this);
    theActionManager.add("search",FileUtils.getIcon("search"),"Search in the current database",-1, "",this);
