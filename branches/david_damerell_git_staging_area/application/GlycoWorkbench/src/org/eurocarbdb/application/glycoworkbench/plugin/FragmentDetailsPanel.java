...
public class FragmentDetailsPanel extends SortingTablePanel<FragmentDocument> implements ActionListener {    
    ...
    theActionManager.add("charges",FileUtils.getIcon("charges"),"Compute multiple charges and exchanges",-1, "",this);

    theActionManager.add("filterselection",FileUtils.getIcon(""),"Show only selected fragments",-1, "",this);
    theActionManager.add("showallrows",FileUtils.getIcon(""),"Show all fragments",-1, "",this);
    }
