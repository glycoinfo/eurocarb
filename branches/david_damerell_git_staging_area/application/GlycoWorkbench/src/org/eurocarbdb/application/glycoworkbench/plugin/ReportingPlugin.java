...
public class ReportingPlugin implements Plugin, ActionListener {
    ...
    actions.add(new GlycanAction("reportAnnotations",FileUtils.getIcon(""),"Create a report of the annotations",KeyEvent.VK_C,"",this));
    actions.add(new GlycanAction("openAnnotationsReport",FileUtils.getIcon(""),"Open a previous annotations report",KeyEvent.VK_O,"",this));
        actions.add(null);
    actions.add(new GlycanAction("deisotope",FileUtils.getIcon(""),"Deisotope the annotated peaklist using the annotations",KeyEvent.VK_D,"",this));
    actions.add(new GlycanAction("reportProfilesComparison",FileUtils.getIcon(""),"Create a report comparing different profiles",KeyEvent.VK_P,"",this));
