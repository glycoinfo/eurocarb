...
public class ProfilerPlugin implements Plugin, ActionListener, BaseDocument.DocumentChangeListener {
    ...
    actions.add(new GlycanAction("findDatabase",FileUtils.getIcon("finddatabase"),"Find all structures with a given m/z value",KeyEvent.VK_F,"",this));
    actions.add(new GlycanAction("matchDatabase",FileUtils.getIcon(""),"Annotate peaks with structures from the database",KeyEvent.VK_N,"",this));    

    actions.add(null);

    actions.add(new GlycanAction("matchStructuresCurrent",FileUtils.getIcon(""),"Annotate peaks with current structure",KeyEvent.VK_C,"",this));
    actions.add(new GlycanAction("matchStructuresSelected",FileUtils.getIcon("matchstructures"),"Annotate peaks with selected structures",KeyEvent.VK_S,"",this));
    actions.add(new GlycanAction("matchStructuresAll",FileUtils.getIcon(""),"Annotate peaks with all structures",KeyEvent.VK_A,"",this));

    actions.add(null);

    actions.add(new GlycanAction("search",FileUtils.getIcon("search"),"Search the databases",KeyEvent.VK_D,"",this));
    actions.add(new GlycanAction("searchAgain",FileUtils.getIcon("searchagain"),"Filter the search results",KeyEvent.VK_R,"",this));
    actions.add(new GlycanAction("searchCurrent",FileUtils.getIcon(""),"Search for the current structure in the databases",KeyEvent.VK_H,"",this));

    actions.add(null);

    actions.add(new GlycanAction("storeStructuresCurrent",FileUtils.getIcon(""),"Store current structure in a user database",KeyEvent.VK_U,"",this));
    actions.add(new GlycanAction("storeStructuresSelected",FileUtils.getIcon("storedatabase"),"Store selected structures in a user database",KeyEvent.VK_E,"",this));
    actions.add(new GlycanAction("storeStructuresAll",FileUtils.getIcon(""),"Store all structures in a user database",KeyEvent.VK_L,"",this));
    ...
    /*if( prototype instanceof PeakAnnotation ) {
        al = (al==null) ?this :al;        
        actions.add(new GlycanAction("storeAnnotations",FileUtils.getIcon(""),"Store structures in a user database",-1,"",al));
        actions.add(new GlycanAction("editAnnotations",FileUtils.getIcon(""),"Edit structure details",-1,"",al));
        actions.add(new GlycanAction("removeAnnotations",FileUtils.getIcon(""),"Remove structures from the user database",-1,"",al));
        }*/
    return actions;
    }
    ...
    theManager = manager;
        if( theManager!=null ) 
        theManager.addMsPeakAction(new GlycanAction("findDatabase",FileUtils.getIcon(this.getClass(),"finddatabase"),"Find all structures matching the peaks",KeyEvent.VK_D,"",this));
    }
    ...
    */
    ...
    public boolean search(Glycan g, StructureDictionary d, boolean search_again) {
    // show dialog
    SearchDialog dlg = new SearchDialog(theApplication,this,search_again,theWorkspace.getGraphicOptions());
    dlg.setStructure(g);
    dlg.setDatabase(d);
    dlg.setVisible(true);
