...
public class PeakFinderPlugin implements Plugin, ActionListener {
    ...
    actions.add(new GlycanAction("findCompositions",FileUtils.getIcon(""),"Find structure compositions with a given m/z value",KeyEvent.VK_F,"",this));
    actions.add(new GlycanAction("matchCompositions",FileUtils.getIcon(""),"Find structure compositions matching the peak list",KeyEvent.VK_P,"",this));
    
    actions.add(null);
    
    actions.add(new GlycanAction("findFragmentCompositions",FileUtils.getIcon(""),"Find fragments compositions with a given m/z value",KeyEvent.VK_I,"",this));
    actions.add(new GlycanAction("matchFragmentCompositions",FileUtils.getIcon(""),"Find fragments compositions matching the peak list",KeyEvent.VK_L,"",this));
    ...
    theManager = manager;
    theManager.addMsPeakAction(new GlycanAction("findCompositions",FileUtils.getIcon(""),"Find structure compositions matching the peaks",KeyEvent.VK_P,"",this));
    theManager.addMsMsPeakAction(new GlycanAction("findFragmentCompositions",FileUtils.getIcon(""),"Find fragments compositions matching the peaks",KeyEvent.VK_P,"",this));
