...
- synonym for spectrumWindow
  ...
  @returns   the result
**/
Anal_SpectrumWindow Anal_SpectrumWindowView_GetParent(Anal_SpectrumWindowView self)
{
...
parent link
  ...
  @returns   the result
**/
Anal_SpectrumWindow Anal_SpectrumWindowView_GetSpectrumWindow(Anal_SpectrumWindowView self)
{
  ...
  if (!method)
    return raiseApiException("ccpnmr.Analysis.SpectrumWindowView: cannot find method 'getSpectrumWindow'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccpnmr.Analysis.SpectrumWindowView: method 'getSpectrumWindow' is not callable");
...
**/
Anal_SpectrumWindowView Anal_SpectrumWindowView_Init(Anal_SpectrumWindow parent, ApiMap attrlinks)
{
  
  return Anal_SpectrumWindow_NewSpectrumWindowView(parent, attrlinks);
}
...
/**
  ...
  @returns  the new object
**/
Anal_SpectrumWindowView Anal_SpectrumWindowView_Init_reqd(Anal_SpectrumWindow parent, Anal_AnalysisSpectrum analysisSpectrum)
{
