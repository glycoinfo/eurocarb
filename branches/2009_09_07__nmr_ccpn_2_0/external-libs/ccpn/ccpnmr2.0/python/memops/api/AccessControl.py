...
Autogenerated by PyFileApiGen revision 1.51.2.3 on Mon Apr  6 17:02:47 2009
...
class AccessControlStore(memops.api.Implementation.TopObject):
  ...
  """
  #   from data model element memops.AccessControl.AccessControlStore revision 1.38.2.9
  _metaclass = metaPackage.getElement('AccessControlStore')
  _packageName = 'memops.AccessControl'
  _packageShortName = 'ACCO'
  _fieldNames = ('applicationData', 'className', 'createdBy', 'fieldNames', 'guid', 'inConstructor', 'isDeleted', 'isLoaded', 'isModifiable', 'isModified', 'isReading', 'lastUnlockedBy', 'metaclass', 'name', 'packageName', 'packageShortName', 'qualifiedName', 'access', 'accessObjects', 'activeRepositories', 'memopsRoot', 'packageLocator', 'parent', 'permissions', 'root', 'topObject', 'userGroups', 'users',)
  ...
  def findAllAccessObjects(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        ...
        directAttrs = frozenset(('description', 'name', 'access', 'accessControlStore',))
  ...
  def findAllPermissions(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        (key, condition) = items[0]
        directAttrs = frozenset(('opType', 'permission', 'permissionClass', 'roleName', 'access', 'accessControlStore', 'accessObject', 'userGroup',))
        if (key in directAttrs):
          for v in currentValues:
            if (condition == v.__dict__.get(key)):
              result.add(v)
  ...
  def findFirstPermission(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      ll.append(objKey)
      if (objKey is not None):
        objKey = conditions.get('accessObject')
        ll.append(objKey)
        if (objKey is not None):
...
class AccessObject(memops.api.Implementation.DataObject):
  r"""
  """
  #   from data model element memops.AccessControl.AccessObject revision 1.38.2.9
  _metaclass = metaPackage.getElement('AccessObject')
  _packageName = 'memops.AccessControl'
  _packageShortName = 'ACCO'
  _fieldNames = ('applicationData', 'className', 'description', 'fieldNames', 'inConstructor', 'isDeleted', 'metaclass', 'name', 'packageName', 'packageShortName', 'qualifiedName', 'access', 'accessControlStore', 'dataObjects', 'parent', 'permissions', 'root', 'topObject',)
  ...
  def _checkDelete(self, objsToBeDeleted, objsToBeChecked, linkCounter, topObjectsToCheck):
    ...
    dataDict = self.__dict__
    objsToBeDeleted.add(self)
    dataObjects = dataDict.get('dataObjects')
    pass
  ...
  def _singleDelete(self, objsToBeDeleted):
    ...
    *Implementation function* - will CORRUPT DATA if called outside 
    ...
    for dataObject in dataDict.get('dataObjects'):
      if (not (dataObject in objsToBeDeleted)):
  ...
  def addDataObject(self, value):
    ...
    if (notIsReading):
      ...
      topObjectsToCheck.add(topObject)
      if (not (value.__dict__.get('topObject').__dict__.get('isLoaded'))):
        value.__dict__.get('topObject').load()
    ...
    if (notOverride):
      if (value is not None):
        ...
        if (not (xx1 is yy1)):
          raise ApiError("""%s.addDataObject:
           Link dataObjects between objects from separate partitions
           - memops.Implementation.MemopsRoot does not match""" % self.qualifiedName
           + ": %s:%s" % (self, value)
          )
    ...
    oldSelf = value.__dict__.get('access')
    if (oldSelf is not None):
      siblingValues = oldSelf.__dict__.get('dataObjects')
    ...
    if ((notInConstructor and notOverride)):
      ...
      ll = _notifies.get('addDataObject')
      if ll:
        for notify in ll:
  ...
  def checkValid(self, complete=False):
    ...
    if (complete):
      ...
      values = dataDict.get('dataObjects')
      for value in values:
        from memops.api.Implementation import DataObject as importedType
        if (not isinstance(value, importedType)):
          raise ApiError("""%s.checkValid: dataObjects:
           value is not of class memops.Implementation.DataObject""" % self.qualifiedName
           + ": %s" % (value,)
          )
  ...
  def findAllDataObjects(self, **conditions):
    """
  ...
  def findFirstDataObject(self, **conditions):
    """
  ...
  def getDataObjects(self):
    ...
    """
    dataDict = self.__dict__
    tempVar = dataDict.get('dataObjects')
    result = frozenset(tempVar)
    return result
  ...
  def removeDataObject(self, value):
    """
    ...
    from memops.api.Implementation import DataObject as importedType
    if (not isinstance(value, importedType)):
      raise ApiError("""%s.removeDataObject:
       value is not of class memops.Implementation.DataObject""" % self.qualifiedName
       + ": %s" % (value,)
      )
    ...
    if ((notInConstructor and notOverride)):
      ...
      ll = _notifies.get('removeDataObject')
      if ll:
        for notify in ll:
          if notify not in ll1:
            notify(self)
  ...
  def setDataObjects(self, values):
    """
    ...
    if (len(values) != len(xx)):
      raise ApiError("""%s.setDataObjects:
    ...
    if (notIsReading):
      ...
      for pv in values:
        if (not (pv in currentValues)):
          topObject = pv.__dict__.get('topObject')
          topObjectsToCheck.add(topObject)
          oldSelf = pv.__dict__.get('access')
          if (oldSelf is not None):
            if (notIsReading):
              topObject = oldSelf.__dict__.get('topObject')
              topObjectsToCheck.add(topObject)
    ...
    for cv in currentValues:
      if (not (cv in values)):
        cv.__dict__['access'] = None

    for cv in values:
      if (not (cv in currentValues)):
        oldSelf = cv.__dict__.get('access')
        if (oldSelf is not None):
          vv = oldSelf.__dict__.get('dataObjects')
          vv.remove(cv)

      cv.__dict__['access'] = self

    dataDict['dataObjects'] = values
    if (notIsReading):
      for topObjectModify in topObjectsToCheck:
        topObjectModify.__dict__['isModified'] = True
    ...
    if ((notInConstructor and notOverride)):
      ...
      ll = _notifies.get('setDataObjects')
      if ll:
        for notify in ll:
          if notify not in ll1:
            notify(self)
  ...
  def setPermissions(self, values):
    ...
    if (notOverride):
      for cv in currentValues:
        if (not (cv in values)):
          raise ApiError("""%s.setPermissions:
           locard accessObject: cannot set because some of current values not in values""" % self.qualifiedName
           + ": %s" % (self,)
          )
  ...
  dataObjects = property(getDataObjects, setDataObjects, None,
  r"""DataObjects that are controlled by AccessObject
  """)
...
class Permission(memops.api.Implementation.DataObject):
  r"""
  """
  #   from data model element memops.AccessControl.Permission revision 1.37.2.9
  _metaclass = metaPackage.getElement('Permission')
  _packageName = 'memops.AccessControl'
  _packageShortName = 'ACCO'
  _fieldNames = ('applicationData', 'className', 'fieldNames', 'inConstructor', 'isDeleted', 'metaclass', 'opType', 'packageName', 'packageShortName', 'permission', 'permissionClass', 'qualifiedName', 'roleName', 'access', 'accessControlStore', 'accessObject', 'parent', 'root', 'topObject', 'userGroup',)
  ...
  def __init__(self, parent, **attrlinks):
    ...
    try:
      ...
      if (notIsReading):
        ...
        ll.append(objKey)
        if (objKey is not None):
          objKey = dataDict.get('accessObject')
          ll.append(objKey)
          if (objKey is not None):
        ...
        if (objKey is None):
          raise ApiError("""%s.__init__:
           Key attribute or link not set (from ['userGroup', 'accessObject', 'permissionClass', 'opType', 'roleName'])""" % self.qualifiedName
           + ": %s" % (self,)
          )
        else:
          if (childrenDict.get(objKey) is None):
  ...
  def _singleDelete(self, objsToBeDeleted):
    ...
    *Implementation function* - will CORRUPT DATA if called outside 
    ...
    if ((accessObject is not None and not (accessObject in objsToBeDeleted))):
      permissions = accessObject.__dict__.get('permissions')
    ...
    if (not (accessControlStore in objsToBeDeleted)):
      ...
      if (objKey is None):
        ...
        dd = accessControlStore.__dict__.get('permissions')
        if (self is dd.get(objKey)):
          del dd[objKey]
  ...
  def getByKey(startObj, fullKey):
    ...
    if (obj1 is not None):
      ...
      obj2 = obj1.__dict__.get('permissions').get(objKey)
      result = obj2
  ...
  def getFullKey(self, useGuid=False):
    ...
    result.append(dataDict.get('accessObject'))
  ...
  def setAccessObject(self, value):
    """
    Set for memops.AccessControl.Permission.accessObject
    """
    dataDict = self.__dict__
    if (not isinstance(value, AccessObject)):
      raise ApiError("""%s.setAccessObject:
       value is not of class memops.AccessControl.AccessObject""" % self.qualifiedName
       + ": %s" % (value,)
      )

    topObject = dataDict.get('topObject')
    currentValue = dataDict.get('accessObject')
    notInConstructor = not (dataDict.get('inConstructor'))
    ...
    if (notOverride):
      if (notInConstructor):
        raise ApiError("""%s.setAccessObject:
         cannot set accessObject, frozen""" % self.qualifiedName
         + ": %s" % (self,)
        )
      ...
      if (not (xx1 is yy1)):
        raise ApiError("""%s.setAccessObject:
         Link accessObject between objects from separate partitions
         - memops.Implementation.TopObject does not match""" % self.qualifiedName
         + ": %s:%s" % (self, value)
        )
    ...
    if (currentValue is not None):
      if (notIsReading):
        ...
        raise ApiError("""%s.setAccessObject:
         Read link 'accessObject' incompatible with pre-existing link""" % self.qualifiedName
         + ": %s" % (self,)
        )
  ...
  accessObject = property(getAccessObject, setAccessObject, None,
  r"""
  """)
...
class User(memops.api.Implementation.DataObject):
  r"""
  """
  #   from data model element memops.AccessControl.User revision 1.36.2.9
  _metaclass = metaPackage.getElement('User')
  _packageName = 'memops.AccessControl'
  _packageShortName = 'ACCO'
  _fieldNames = ('applicationData', 'className', 'fieldNames', 'inConstructor', 'isDeleted', 'metaclass', 'name', 'packageName', 'packageShortName', 'qualifiedName', 'access', 'accessControlStore', 'ledGroups', 'parent', 'person', 'root', 'topObject', 'userGroups',)
...
class UserGroup(memops.api.Implementation.DataObject):
  r"""
  """
  #   from data model element memops.AccessControl.UserGroup revision 1.36.2.9
  _metaclass = metaPackage.getElement('UserGroup')
  _packageName = 'memops.AccessControl'
  _packageShortName = 'ACCO'
  _fieldNames = ('applicationData', 'className', 'fieldNames', 'inConstructor', 'isDeleted', 'metaclass', 'name', 'packageName', 'packageShortName', 'qualifiedName', 'access', 'accessControlStore', 'leaders', 'members', 'parent', 'permissions', 'root', 'topObject',)
