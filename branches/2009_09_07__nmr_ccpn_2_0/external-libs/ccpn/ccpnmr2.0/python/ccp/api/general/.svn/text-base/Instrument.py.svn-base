...
Autogenerated by PyFileApiGen revision 1.51.2.3 on Mon Apr  6 17:03:15 2009
...
experiment.
  """
  #   from data model element ccp.general.Instrument.AbstractInstrument revision 1.38.2.9
  _metaclass = metaPackage.getElement('AbstractInstrument')
  _packageName = 'ccp.general.Instrument'
  _packageShortName = 'INST'
  _fieldNames = ('applicationData', 'className', 'details', 'fieldNames', 'inConstructor', 'instrumentType', 'isDeleted', 'metaclass', 'model', 'name', 'packageName', 'packageShortName', 'qualifiedName', 'serial', 'serialNumber', 'access', 'contactPerson', 'instrumentStore', 'manufacturer', 'parent', 'root', 'topObject',)
...
class InstrumentStore(memops.api.Implementation.TopObject):
  ...
  """
  #   from data model element ccp.general.Instrument.InstrumentStore revision 1.37.2.9
  _metaclass = metaPackage.getElement('InstrumentStore')
  _packageName = 'ccp.general.Instrument'
  _packageShortName = 'INST'
  _fieldNames = ('applicationData', 'className', 'createdBy', 'fieldNames', 'guid', 'inConstructor', 'isDeleted', 'isLoaded', 'isModifiable', 'isModified', 'isReading', 'lastUnlockedBy', 'metaclass', 'name', 'packageName', 'packageShortName', 'qualifiedName', 'access', 'activeRepositories', 'instruments', 'memopsRoot', 'packageLocator', 'parent', 'root', 'topObject',)
...
class NmrProbe(AbstractInstrument):
  r"""NMR probe used. 
  """
  #   from data model element ccp.general.Instrument.NmrProbe revision 1.38.2.9
  _metaclass = metaPackage.getElement('NmrProbe')
  _packageName = 'ccp.general.Instrument'
  _packageShortName = 'INST'
  _fieldNames = ('applicationData', 'className', 'details', 'diameter', 'fieldNames', 'inConstructor', 'instrumentType', 'isDeleted', 'metaclass', 'model', 'name', 'packageName', 'packageShortName', 'probeType', 'qualifiedName', 'serial', 'serialNumber', 'access', 'citations', 'contactPerson', 'experiments', 'instrumentStore', 'manufacturer', 'parent', 'root', 'topObject',)
...
class NmrSpectrometer(AbstractInstrument):
  ...
  """
  #   from data model element ccp.general.Instrument.NmrSpectrometer revision 1.38.2.9
  _metaclass = metaPackage.getElement('NmrSpectrometer')
  _packageName = 'ccp.general.Instrument'
  _packageShortName = 'INST'
  _fieldNames = ('applicationData', 'className', 'details', 'fieldNames', 'inConstructor', 'instrumentType', 'isDeleted', 'metaclass', 'model', 'name', 'nominalFreq', 'packageName', 'packageShortName', 'protonFreq', 'qualifiedName', 'serial', 'serialNumber', 'access', 'citations', 'contactPerson', 'experiments', 'instrumentStore', 'manufacturer', 'parent', 'root', 'topObject',)
...
class Instrument(AbstractInstrument):
  r"""Instrument used.
  """
  #   from data model element ccp.general.Instrument.Instrument revision 1.37.2.9
  _metaclass = metaPackage.getElement('Instrument')
  _packageName = 'ccp.general.Instrument'
  _packageShortName = 'INST'
  _fieldNames = ('applicationData', 'className', 'details', 'fieldNames', 'inConstructor', 'instrumentType', 'isDeleted', 'metaclass', 'model', 'name', 'packageName', 'packageShortName', 'qualifiedName', 'serial', 'serialNumber', 'access', 'contactPerson', 'experiments', 'instrumentStore', 'instrumentTypes', 'manufacturer', 'methods', 'parent', 'root', 'topObject',)
