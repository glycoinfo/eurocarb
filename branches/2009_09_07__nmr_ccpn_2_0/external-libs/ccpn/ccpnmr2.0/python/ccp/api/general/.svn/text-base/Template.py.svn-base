...
Autogenerated by PyFileApiGen revision 1.51.2.3 on Mon Apr  6 17:02:58 2009
...
checked by the software. 
  """
  #   from data model element ccp.general.Template.AbstractProbability revision 1.35.2.9
  _metaclass = metaPackage.getElement('AbstractProbability')
  _packageName = 'ccp.general.Template'
  _packageShortName = 'TEMP'
  _fieldNames = ('applicationData', 'className', 'fieldNames', 'inConstructor', 'isDeleted', 'metaclass', 'packageName', 'packageShortName', 'qualifiedName', 'weight', 'access', 'root', 'topObject',)
...
class MultiTypeValue(memops.api.Implementation.DataObject):
  r"""Typed value data
  """
  #   from data model element ccp.general.Template.MultiTypeValue revision 1.7.2.9
  _metaclass = metaPackage.getElement('MultiTypeValue')
  _packageName = 'ccp.general.Template'
  _packageShortName = 'TEMP'
  _fieldNames = ('applicationData', 'booleanValue', 'className', 'fieldNames', 'floatValue', 'inConstructor', 'intValue', 'isDeleted', 'metaclass', 'packageName', 'packageShortName', 'qualifiedName', 'textValue', 'access', 'root', 'topObject',)
...
class MultiTypesValue(memops.api.Implementation.DataObject):
  r"""
  """
  #   from data model element ccp.general.Template.MultiTypesValue revision 1.3.2.8
  _metaclass = metaPackage.getElement('MultiTypesValue')
  _packageName = 'ccp.general.Template'
  _packageShortName = 'TEMP'
  _fieldNames = ('applicationData', 'boolValues', 'className', 'fieldNames', 'floatValues', 'inConstructor', 'intValues', 'isDeleted', 'metaclass', 'packageName', 'packageShortName', 'qualifiedName', 'textValues', 'access', 'root', 'topObject',)
