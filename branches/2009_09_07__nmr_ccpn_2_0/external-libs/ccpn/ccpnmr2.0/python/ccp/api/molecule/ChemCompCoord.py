...
Autogenerated by PyFileApiGen revision 1.51.2.3 on Mon Apr  6 17:03:21 2009
  from data model element ccp.molecule.ChemCompCoord revision 1.34.2.9
...
class ChemAtomCoord(memops.api.Implementation.DataObject):
  ...
  """
  #   from data model element ccp.molecule.ChemCompCoord.ChemAtomCoord revision 1.42.2.9
  _metaclass = metaPackage.getElement('ChemAtomCoord')
  _packageName = 'ccp.molecule.ChemCompCoord'
  _packageShortName = 'CCCO'
  _fieldNames = ('applicationData', 'className', 'fieldNames', 'inConstructor', 'isDeleted', 'metaclass', 'name', 'packageName', 'packageShortName', 'qualifiedName', 'serial', 'subType', 'x', 'y', 'z', 'access', 'chemAtom', 'chemCompCoord', 'chemCompVarCoords', 'parent', 'root', 'topObject',)
...
class ChemCompCoord(memops.api.Implementation.TopObject):
  ...
  """
  #   from data model element ccp.molecule.ChemCompCoord.ChemCompCoord revision 1.41.2.9
  _metaclass = metaPackage.getElement('ChemCompCoord')
  _packageName = 'ccp.molecule.ChemCompCoord'
  _packageShortName = 'CCCO'
  _fieldNames = ('applicationData', 'ccpCode', 'className', 'createdBy', 'details', 'fieldNames', 'guid', 'inConstructor', 'isDeleted', 'isLoaded', 'isModifiable', 'isModified', 'isReading', 'lastUnlockedBy', 'metaclass', 'molType', 'packageName', 'packageShortName', 'qualifiedName', 'sourceName', 'access', 'activeRepositories', 'chemAtomCoords', 'chemComp', 'chemCompVarCoords', 'memopsRoot', 'packageLocator', 'parent', 'root', 'topObject',)
...
relevant Vars
  """
  #   from data model element ccp.molecule.ChemCompCoord.ChemCompVarCoord revision 1.39.2.9
  _metaclass = metaPackage.getElement('ChemCompVarCoord')
  _packageName = 'ccp.molecule.ChemCompCoord'
  _packageShortName = 'CCCO'
  _fieldNames = ('applicationData', 'className', 'descriptor', 'fieldNames', 'inConstructor', 'isDeleted', 'linking', 'metaclass', 'packageName', 'packageShortName', 'qualifiedName', 'access', 'chemAtomCoords', 'chemCompCoord', 'chemCompVars', 'parent', 'root', 'topObject',)
