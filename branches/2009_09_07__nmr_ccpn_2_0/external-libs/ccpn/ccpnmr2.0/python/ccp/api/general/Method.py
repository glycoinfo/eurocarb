...
Autogenerated by PyFileApiGen revision 1.51.2.3 on Mon Apr  6 17:03:22 2009
...
class MethodStore(memops.api.Implementation.TopObject):
  ...
  """
  #   from data model element ccp.general.Method.MethodStore revision 1.38.2.9
  _metaclass = metaPackage.getElement('MethodStore')
  _packageName = 'ccp.general.Method'
  _packageShortName = 'METH'
  _fieldNames = ('applicationData', 'className', 'createdBy', 'fieldNames', 'guid', 'inConstructor', 'isDeleted', 'isLoaded', 'isModifiable', 'isModified', 'isReading', 'lastUnlockedBy', 'metaclass', 'name', 'packageName', 'packageShortName', 'qualifiedName', 'access', 'activeRepositories', 'memopsRoot', 'methods', 'packageLocator', 'parent', 'root', 'software', 'topObject',)
...
class Parameter(memops.api.Implementation.DataObject):
  ...
  """
  #   from data model element ccp.general.Method.Parameter revision 1.37.2.9
  _metaclass = metaPackage.getElement('Parameter')
  _packageName = 'ccp.general.Method'
  _packageShortName = 'METH'
  _fieldNames = ('applicationData', 'className', 'fieldNames', 'inConstructor', 'isDeleted', 'metaclass', 'name', 'packageName', 'packageShortName', 'paramType', 'qualifiedName', 'serial', 'unit', 'value', 'access', 'method', 'parent', 'root', 'topObject',)
...
class Software(memops.api.Implementation.DataObject):
  ...
  """
  #   from data model element ccp.general.Method.Software revision 1.36.2.9
  _metaclass = metaPackage.getElement('Software')
  _packageName = 'ccp.general.Method'
  _packageShortName = 'METH'
  _fieldNames = ('applicationData', 'className', 'details', 'fieldNames', 'inConstructor', 'isDeleted', 'metaclass', 'name', 'packageName', 'packageShortName', 'qualifiedName', 'tasks', 'vendorAddress', 'vendorName', 'vendorWebAddress', 'version', 'access', 'citations', 'dropAnnotations', 'entries', 'methodStore', 'methods', 'parent', 'root', 'topObject', 'validationStores',)
