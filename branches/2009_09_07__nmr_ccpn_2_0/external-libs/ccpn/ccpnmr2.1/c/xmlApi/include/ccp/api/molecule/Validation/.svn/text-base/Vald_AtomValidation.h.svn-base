...
#ifndef __incl__ccp_api_molecule_Validation_AtomValidation_h__
#define __incl__ccp_api_molecule_Validation_AtomValidation_h__
...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
extern Acco_AccessObject Vald_AtomValidation_GetActiveAccess(Vald_AtomValidation self);
...
#endif /* __incl__ccp_api_molecule_Validation_AtomValidation_h__ */
