...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Clas_HolderCategory_GetActiveAccess(Clas_HolderCategory self)
{
  ...
  if (!method)
    return raiseApiException("ccp.lims.Classification.HolderCategory: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccp.lims.Classification.HolderCategory: method 'getActiveAccess' is not callable");
