...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Prot_RefInputSample_GetActiveAccess(Prot_RefInputSample self)
{
  ...
  if (!method)
    return raiseApiException("ccp.lims.Protocol.RefInputSample: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccp.lims.Protocol.RefInputSample: method 'getActiveAccess' is not callable");
