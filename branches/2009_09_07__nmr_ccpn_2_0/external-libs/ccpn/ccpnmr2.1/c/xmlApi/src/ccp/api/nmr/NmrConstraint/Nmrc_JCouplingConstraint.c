...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Nmrc_JCouplingConstraint_GetActiveAccess(Nmrc_JCouplingConstraint self)
{
  ...
  if (!method)
    return raiseApiException("ccp.nmr.NmrConstraint.JCouplingConstraint: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccp.nmr.NmrConstraint.JCouplingConstraint: method 'getActiveAccess' is not callable");
