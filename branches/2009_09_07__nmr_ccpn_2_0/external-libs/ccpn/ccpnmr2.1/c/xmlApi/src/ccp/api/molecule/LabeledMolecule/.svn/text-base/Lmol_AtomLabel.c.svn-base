...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Lmol_AtomLabel_GetActiveAccess(Lmol_AtomLabel self)
{
  ...
  if (!method)
    return raiseApiException("ccp.molecule.LabeledMolecule.AtomLabel: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccp.molecule.LabeledMolecule.AtomLabel: method 'getActiveAccess' is not callable");
