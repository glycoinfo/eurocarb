...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Cryz_DropAnnotation_GetActiveAccess(Cryz_DropAnnotation self)
{
  ...
  if (!method)
    return raiseApiException("ccp.lims.Crystallization.DropAnnotation: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccp.lims.Crystallization.DropAnnotation: method 'getActiveAccess' is not callable");
