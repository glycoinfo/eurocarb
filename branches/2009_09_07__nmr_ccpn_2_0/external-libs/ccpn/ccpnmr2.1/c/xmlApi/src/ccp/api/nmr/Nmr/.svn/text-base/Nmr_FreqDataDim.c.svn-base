...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Nmr_FreqDataDim_GetActiveAccess(Nmr_FreqDataDim self)
{
  ...
  if (!method)
    return raiseApiException("ccp.nmr.Nmr.FreqDataDim: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccp.nmr.Nmr.FreqDataDim: method 'getActiveAccess' is not callable");
