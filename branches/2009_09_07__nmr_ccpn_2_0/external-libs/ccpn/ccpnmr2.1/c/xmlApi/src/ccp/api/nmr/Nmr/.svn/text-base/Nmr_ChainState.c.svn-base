...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Nmr_ChainState_GetActiveAccess(Nmr_ChainState self)
{
  ...
  if (!method)
    return raiseApiException("ccp.nmr.Nmr.ChainState: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccp.nmr.Nmr.ChainState: method 'getActiveAccess' is not callable");
