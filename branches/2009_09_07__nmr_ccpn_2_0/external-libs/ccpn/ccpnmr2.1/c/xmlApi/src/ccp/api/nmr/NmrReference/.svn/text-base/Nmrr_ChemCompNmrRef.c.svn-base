...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Nmrr_ChemCompNmrRef_GetActiveAccess(Nmrr_ChemCompNmrRef self)
{
  ...
  if (!method)
    return raiseApiException("ccp.nmr.NmrReference.ChemCompNmrRef: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccp.nmr.NmrReference.ChemCompNmrRef: method 'getActiveAccess' is not callable");
