...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Prot_ParameterDefinition_GetActiveAccess(Prot_ParameterDefinition self)
{
  ...
  if (!method)
    return raiseApiException("ccp.lims.Protocol.ParameterDefinition: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccp.lims.Protocol.ParameterDefinition: method 'getActiveAccess' is not callable");
