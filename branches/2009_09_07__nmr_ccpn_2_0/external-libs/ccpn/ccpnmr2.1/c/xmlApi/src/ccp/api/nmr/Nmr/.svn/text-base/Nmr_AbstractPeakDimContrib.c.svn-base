...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Nmr_AbstractPeakDimContrib_GetActiveAccess(Nmr_AbstractPeakDimContrib self)
{
  ...
  if (!method)
    return raiseApiException("ccp.nmr.Nmr.AbstractPeakDimContrib: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccp.nmr.Nmr.AbstractPeakDimContrib: method 'getActiveAccess' is not callable");
