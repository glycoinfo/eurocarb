...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Nmr_DipolarRelaxList_GetActiveAccess(Nmr_DipolarRelaxList self)
{
  ...
  if (!method)
    return raiseApiException("ccp.nmr.Nmr.DipolarRelaxList: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccp.nmr.Nmr.DipolarRelaxList: method 'getActiveAccess' is not callable");
