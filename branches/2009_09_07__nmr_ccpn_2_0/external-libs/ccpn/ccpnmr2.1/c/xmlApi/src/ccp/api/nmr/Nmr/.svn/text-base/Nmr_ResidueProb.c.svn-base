...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Nmr_ResidueProb_GetActiveAccess(Nmr_ResidueProb self)
{
  ...
  if (!method)
    return raiseApiException("ccp.nmr.Nmr.ResidueProb: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccp.nmr.Nmr.ResidueProb: method 'getActiveAccess' is not callable");
