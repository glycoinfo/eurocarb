...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Nmrc_ChemShiftConstraint_GetActiveAccess(Nmrc_ChemShiftConstraint self)
{
  ...
  if (!method)
    return raiseApiException("ccp.nmr.NmrConstraint.ChemShiftConstraint: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccp.nmr.NmrConstraint.ChemShiftConstraint: method 'getActiveAccess' is not callable");
