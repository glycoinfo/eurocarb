...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Nmr_PkaList_GetActiveAccess(Nmr_PkaList self)
{
  ...
  if (!method)
    return raiseApiException("ccp.nmr.Nmr.PkaList: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccp.nmr.Nmr.PkaList: method 'getActiveAccess' is not callable");
