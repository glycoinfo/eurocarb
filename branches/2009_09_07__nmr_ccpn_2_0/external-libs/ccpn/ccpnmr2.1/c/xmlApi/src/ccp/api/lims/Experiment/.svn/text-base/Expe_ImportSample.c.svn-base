...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Expe_ImportSample_GetActiveAccess(Expe_ImportSample self)
{
  ...
  if (!method)
    return raiseApiException("ccp.lims.Experiment.ImportSample: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccp.lims.Experiment.ImportSample: method 'getActiveAccess' is not callable");
