...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Nmr_PeakIntensity_GetActiveAccess(Nmr_PeakIntensity self)
{
  ...
  if (!method)
    return raiseApiException("ccp.nmr.Nmr.PeakIntensity: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccp.nmr.Nmr.PeakIntensity: method 'getActiveAccess' is not callable");
