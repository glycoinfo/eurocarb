...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Hold_AbstractHolderType_GetActiveAccess(Hold_AbstractHolderType self)
{
  ...
  if (!method)
    return raiseApiException("ccp.lims.Holder.AbstractHolderType: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccp.lims.Holder.AbstractHolderType: method 'getActiveAccess' is not callable");
