...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Nmr_HExchRate_GetActiveAccess(Nmr_HExchRate self)
{
  ...
  if (!method)
    return raiseApiException("ccp.nmr.Nmr.HExchRate: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccp.nmr.Nmr.HExchRate: method 'getActiveAccess' is not callable");
