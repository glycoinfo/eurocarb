...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Meth_Parameter_GetActiveAccess(Meth_Parameter self)
{
  ...
  if (!method)
    return raiseApiException("ccp.general.Method.Parameter: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccp.general.Method.Parameter: method 'getActiveAccess' is not callable");
