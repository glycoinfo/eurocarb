...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Nmrr_NmrReferenceStore_GetActiveAccess(Nmrr_NmrReferenceStore self)
{
  ...
  if (!method)
    return raiseApiException("ccp.nmr.NmrReference.NmrReferenceStore: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccp.nmr.NmrReference.NmrReferenceStore: method 'getActiveAccess' is not callable");
