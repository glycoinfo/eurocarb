...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Acco_User_GetActiveAccess(Acco_User self)
{
  ...
  if (!method)
    return raiseApiException("memops.AccessControl.User: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("memops.AccessControl.User: method 'getActiveAccess' is not callable");
...
user
  ...
  @returns   the result
**/
ApiString Acco_User_GetPasswordHashed(Acco_User self)
{
  
  ApiString obj;
  PyObject *args, *method = PyObject_GetAttrString(self, "getPasswordHashed");
  
  if (!method)
    return raiseApiException("memops.AccessControl.User: cannot find method 'getPasswordHashed'");
  if (!PyCallable_Check(method))
    return raiseApiException("memops.AccessControl.User: method 'getPasswordHashed' is not callable");
...
user
  ...
  @param  ApiString value
**/
void *Acco_User_SetPasswordHashed(Acco_User self, ApiString value)
{
  
  void *obj;
  PyObject *args, *method = PyObject_GetAttrString(self, "setPasswordHashed");
  
  if (!method)
    return raiseApiException("memops.AccessControl.User: cannot find method 'setPasswordHashed'");
  if (!PyCallable_Check(method))
    return raiseApiException("memops.AccessControl.User: method 'setPasswordHashed' is not callable");
