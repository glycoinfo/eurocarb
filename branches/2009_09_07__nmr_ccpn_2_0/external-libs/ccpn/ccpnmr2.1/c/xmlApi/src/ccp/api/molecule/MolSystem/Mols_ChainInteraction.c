...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Mols_ChainInteraction_GetActiveAccess(Mols_ChainInteraction self)
{
  ...
  if (!method)
    return raiseApiException("ccp.molecule.MolSystem.ChainInteraction: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccp.molecule.MolSystem.ChainInteraction: method 'getActiveAccess' is not callable");
