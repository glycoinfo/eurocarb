...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Lmol_LabeledMolecule_GetActiveAccess(Lmol_LabeledMolecule self)
{
  ...
  if (!method)
    return raiseApiException("ccp.molecule.LabeledMolecule.LabeledMolecule: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccp.molecule.LabeledMolecule.LabeledMolecule: method 'getActiveAccess' is not callable");
