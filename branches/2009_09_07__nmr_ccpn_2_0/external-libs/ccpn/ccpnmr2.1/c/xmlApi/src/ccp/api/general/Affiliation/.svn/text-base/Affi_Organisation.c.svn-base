...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Affi_Organisation_GetActiveAccess(Affi_Organisation self)
{
  ...
  if (!method)
    return raiseApiException("ccp.general.Affiliation.Organisation: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccp.general.Affiliation.Organisation: method 'getActiveAccess' is not callable");
...
State or province 
(e.g. Utah, Manitoba, Lincolnshire).
  @param  Affi_Organisation self
  @returns   the result
**/
ApiString Affi_Organisation_GetProvince(Affi_Organisation self)
{
  
  ApiString obj;
  PyObject *args, *method = PyObject_GetAttrString(self, "getProvince");
  
  if (!method)
    return raiseApiException("ccp.general.Affiliation.Organisation: cannot find method 'getProvince'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccp.general.Affiliation.Organisation: method 'getProvince' is not callable");
...
(e.g. Utah, Manitoba, Lincolnshire).
  ...
  @param  ApiString value
**/
void *Affi_Organisation_SetProvince(Affi_Organisation self, ApiString value)
{
  
  void *obj;
  PyObject *args, *method = PyObject_GetAttrString(self, "setProvince");
  
  if (!method)
    return raiseApiException("ccp.general.Affiliation.Organisation: cannot find method 'setProvince'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccp.general.Affiliation.Organisation: method 'setProvince' is not callable");
