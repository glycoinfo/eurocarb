...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Entr_RelatedEntry_GetActiveAccess(Entr_RelatedEntry self)
{
  ...
  if (!method)
    return raiseApiException("ccp.nmr.NmrEntry.RelatedEntry: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccp.nmr.NmrEntry.RelatedEntry: method 'getActiveAccess' is not callable");
...
related entry
  ...
  @returns   the result
**/
ApiString Entr_RelatedEntry_GetDbCode(Entr_RelatedEntry self)
{
  
  ApiString obj;
  PyObject *args, *method = PyObject_GetAttrString(self, "getDbCode");
  
  if (!method)
    return raiseApiException("ccp.nmr.NmrEntry.RelatedEntry: cannot find method 'getDbCode'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccp.nmr.NmrEntry.RelatedEntry: method 'getDbCode' is not callable");
...
explanatory comments, etc.
  ...
  @returns   the result
**/
ApiString Entr_RelatedEntry_GetDetails(Entr_RelatedEntry self)
{
  ...
  if (!method)
    return raiseApiException("ccp.nmr.NmrEntry.RelatedEntry: cannot find method 'getDetails'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccp.nmr.NmrEntry.RelatedEntry: method 'getDetails' is not callable");
...
/**
  ...
  @returns  the new object
**/
Entr_RelatedEntry Entr_RelatedEntry_Init_reqd(Entr_Entry parent, char * dbCode)
{
...
**/
void *Entr_RelatedEntry_SetDbCode(Entr_RelatedEntry self, ApiString value)
{
  
  void *obj;
  PyObject *args, *method = PyObject_GetAttrString(self, "setDbCode");
  
  if (!method)
    return raiseApiException("ccp.nmr.NmrEntry.RelatedEntry: cannot find method 'setDbCode'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccp.nmr.NmrEntry.RelatedEntry: method 'setDbCode' is not callable");
...
explanatory comments, etc.
  ...
  @param  ApiString value
**/
void *Entr_RelatedEntry_SetDetails(Entr_RelatedEntry self, ApiString value)
{
  ...
  if (!method)
    return raiseApiException("ccp.nmr.NmrEntry.RelatedEntry: cannot find method 'setDetails'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccp.nmr.NmrEntry.RelatedEntry: method 'setDetails' is not callable");
