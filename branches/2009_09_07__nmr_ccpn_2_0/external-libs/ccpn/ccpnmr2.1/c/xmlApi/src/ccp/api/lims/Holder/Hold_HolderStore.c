...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Hold_HolderStore_GetActiveAccess(Hold_HolderStore self)
{
  ...
  if (!method)
    return raiseApiException("ccp.lims.Holder.HolderStore: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccp.lims.Holder.HolderStore: method 'getActiveAccess' is not callable");
