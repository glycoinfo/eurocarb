...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Nmr_ResonanceProb_GetActiveAccess(Nmr_ResonanceProb self)
{
  ...
  if (!method)
    return raiseApiException("ccp.nmr.Nmr.ResonanceProb: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccp.nmr.Nmr.ResonanceProb: method 'getActiveAccess' is not callable");
