...
child 
link to class SpectrumWindowPane
  @param  Anal_SpectrumWindow self
  @param  ApiMap conditions
  @returns  all value that satisfy the conditions 
**/
ApiSet Anal_SpectrumWindow_FindAllSpectrumWindowPanes(Anal_SpectrumWindow self, ApiMap conditions)
{
  
  ApiSet obj;
  PyObject *args, *method = PyObject_GetAttrString(self, "findAllSpectrumWindowPanes");
  
  if (!method)
    return raiseApiException("ccpnmr.Analysis.SpectrumWindow: cannot find method 'findAllSpectrumWindowPanes'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccpnmr.Analysis.SpectrumWindow: method 'findAllSpectrumWindowPanes' is not callable");
...
link to class SpectrumWindowPane
  ...
  @returns  all value that satisfy the conditions 
**/
ApiSet Anal_SpectrumWindow_FindAllSpectrumWindowPanes_keyval0(Anal_SpectrumWindow self)
{
  
  ApiSet  obj;
  PyObject *conditions = PyDict_New();
  
  obj = Anal_SpectrumWindow_FindAllSpectrumWindowPanes(self, conditions);
...
link to class SpectrumWindowPane
  ...
  @returns  all value that satisfy the conditions 
**/
ApiSet Anal_SpectrumWindow_FindAllSpectrumWindowPanes_keyval1(Anal_SpectrumWindow self, char * key, ApiObject value)
{
...
link to class SpectrumWindowPane
  ...
  @returns  all value that satisfy the conditions 
**/
ApiSet Anal_SpectrumWindow_FindAllSpectrumWindowPanes_keyval2(Anal_SpectrumWindow self, char * key1, ApiObject value1, char * key2, ApiObject value2)
{
...
link to class SpectrumWindowPane
  ...
  @returns  all value that satisfy the conditions 
**/
ApiSet Anal_SpectrumWindow_FindAllSpectrumWindowPanes_keyval3(Anal_SpectrumWindow self, char * key1, ApiObject value1, char * key2, ApiObject value2, char * key3, ApiObject value3)
{
...
link to class SpectrumWindowPane
  ...
  @returns  all value that satisfy the conditions 
**/
ApiSet Anal_SpectrumWindow_FindAllSpectrumWindowPanes_keyval4(Anal_SpectrumWindow self, char * key1, ApiObject value1, char * key2, ApiObject value2, char * key3, ApiObject value3, char * key4, ApiObject value4)
{
...
link to class SpectrumWindowPane
  ...
  @returns  the first value that satisfies the conditions 
**/
Anal_SpectrumWindowPane Anal_SpectrumWindow_FindFirstSpectrumWindowPane(Anal_SpectrumWindow self, ApiMap conditions)
{
  
  Anal_SpectrumWindowPane obj;
  PyObject *args, *method = PyObject_GetAttrString(self, "findFirstSpectrumWindowPane");
  
  if (!method)
    return raiseApiException("ccpnmr.Analysis.SpectrumWindow: cannot find method 'findFirstSpectrumWindowPane'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccpnmr.Analysis.SpectrumWindow: method 'findFirstSpectrumWindowPane' is not callable");
...
link to class SpectrumWindowPane
  ...
  @returns  the first value that satisfies the conditions 
**/
Anal_SpectrumWindowPane Anal_SpectrumWindow_FindFirstSpectrumWindowPane_keyval0(Anal_SpectrumWindow self)
{
  
  Anal_SpectrumWindowPane  obj;
  PyObject *conditions = PyDict_New();
  
  obj = Anal_SpectrumWindow_FindFirstSpectrumWindowPane(self, conditions);
...
link to class SpectrumWindowPane
  ...
  @returns  the first value that satisfies the conditions 
**/
Anal_SpectrumWindowPane Anal_SpectrumWindow_FindFirstSpectrumWindowPane_keyval1(Anal_SpectrumWindow self, char * key, ApiObject value)
{
...
link to class SpectrumWindowPane
  ...
  @returns  the first value that satisfies the conditions 
**/
Anal_SpectrumWindowPane Anal_SpectrumWindow_FindFirstSpectrumWindowPane_keyval2(Anal_SpectrumWindow self, char * key1, ApiObject value1, char * key2, ApiObject value2)
{
...
link to class SpectrumWindowPane
  ...
  @returns  the first value that satisfies the conditions 
**/
Anal_SpectrumWindowPane Anal_SpectrumWindow_FindFirstSpectrumWindowPane_keyval3(Anal_SpectrumWindow self, char * key1, ApiObject value1, char * key2, ApiObject value2, char * key3, ApiObject value3)
{
...
link to class SpectrumWindowPane
  ...
  @returns  the first value that satisfies the conditions 
**/
Anal_SpectrumWindowPane Anal_SpectrumWindow_FindFirstSpectrumWindowPane_keyval4(Anal_SpectrumWindow self, char * key1, ApiObject value1, char * key2, ApiObject value2, char * key3, ApiObject value3, char * key4, ApiObject value4)
{
...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Anal_SpectrumWindow_GetActiveAccess(Anal_SpectrumWindow self)
{
  ...
  if (!method)
    return raiseApiException("ccpnmr.Analysis.SpectrumWindow: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccpnmr.Analysis.SpectrumWindow: method 'getActiveAccess' is not callable");
...
/**
  Get for ccpnmr.Analysis.SpectrumWindow.spectrumWindowPanes

child link 
to class SpectrumWindowPane
  @param  Anal_SpectrumWindow self
  @returns   the result
**/
ApiSet Anal_SpectrumWindow_GetSpectrumWindowPanes(Anal_SpectrumWindow self)
{
  
  ApiSet obj;
  PyObject *args, *method = PyObject_GetAttrString(self, "getSpectrumWindowPanes");
  
  if (!method)
    return raiseApiException("ccpnmr.Analysis.SpectrumWindow: cannot find method 'getSpectrumWindowPanes'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccpnmr.Analysis.SpectrumWindow: method 'getSpectrumWindowPanes' is not callable");
...
/**
  Factory function to create ccpnmr.Analysis.SpectrumWindowPane
  @param  Anal_SpectrumWindow self
  @param  ApiMap attrlinks
  @returns  the new object
**/
Anal_SpectrumWindowPane Anal_SpectrumWindow_NewSpectrumWindowPane(Anal_SpectrumWindow self, ApiMap attrlinks)
{
  
  Anal_SpectrumWindowPane obj;
  PyObject *args, *method = PyObject_GetAttrString(self, "newSpectrumWindowPane");
  
  if (!method)
    return raiseApiException("ccpnmr.Analysis.SpectrumWindow: cannot find method 'newSpectrumWindowPane'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccpnmr.Analysis.SpectrumWindow: method 'newSpectrumWindowPane' is not callable");
...
/**
  ...
  @returns  the new object
**/
Anal_SpectrumWindowPane Anal_SpectrumWindow_NewSpectrumWindowPane_reqd(Anal_SpectrumWindow self)
{
  
  Anal_SpectrumWindowPane  obj;
  PyObject *attrlinks = PyDict_New();

  obj = Anal_SpectrumWindow_NewSpectrumWindowPane(self, attrlinks);
...
/**
  Sorted for ccpnmr.Analysis.SpectrumWindow.spectrumWindowPanes
...
link to class SpectrumWindowPane
  ...
  @returns   the result
**/
ApiList Anal_SpectrumWindow_SortedSpectrumWindowPanes(Anal_SpectrumWindow self)
{
  
  ApiList obj;
  PyObject *args, *method = PyObject_GetAttrString(self, "sortedSpectrumWindowPanes");
  
  if (!method)
    return raiseApiException("ccpnmr.Analysis.SpectrumWindow: cannot find method 'sortedSpectrumWindowPanes'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccpnmr.Analysis.SpectrumWindow: method 'sortedSpectrumWindowPanes' is not callable");
