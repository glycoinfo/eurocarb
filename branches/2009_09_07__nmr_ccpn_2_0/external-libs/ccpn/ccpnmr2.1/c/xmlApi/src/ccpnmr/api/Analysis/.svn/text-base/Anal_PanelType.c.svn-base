...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Anal_PanelType_GetActiveAccess(Anal_PanelType self)
{
  ...
  if (!method)
    return raiseApiException("ccpnmr.Analysis.PanelType: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccpnmr.Analysis.PanelType: method 'getActiveAccess' is not callable");
