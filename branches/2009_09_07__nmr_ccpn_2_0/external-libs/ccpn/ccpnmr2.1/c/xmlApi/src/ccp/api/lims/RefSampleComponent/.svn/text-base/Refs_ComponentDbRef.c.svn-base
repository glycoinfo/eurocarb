...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Refs_ComponentDbRef_GetActiveAccess(Refs_ComponentDbRef self)
{
  ...
  if (!method)
    return raiseApiException("ccp.lims.RefSampleComponent.ComponentDbRef: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccp.lims.RefSampleComponent.ComponentDbRef: method 'getActiveAccess' is not callable");
