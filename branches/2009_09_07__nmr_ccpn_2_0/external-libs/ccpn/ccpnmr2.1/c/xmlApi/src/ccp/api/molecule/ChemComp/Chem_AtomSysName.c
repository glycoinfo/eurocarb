...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Chem_AtomSysName_GetActiveAccess(Chem_AtomSysName self)
{
  ...
  if (!method)
    return raiseApiException("ccp.molecule.ChemComp.AtomSysName: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccp.molecule.ChemComp.AtomSysName: method 'getActiveAccess' is not callable");
