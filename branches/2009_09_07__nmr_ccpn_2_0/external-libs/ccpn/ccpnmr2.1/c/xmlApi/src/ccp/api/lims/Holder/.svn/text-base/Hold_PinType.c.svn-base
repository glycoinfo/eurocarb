...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Hold_PinType_GetActiveAccess(Hold_PinType self)
{
  ...
  if (!method)
    return raiseApiException("ccp.lims.Holder.PinType: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccp.lims.Holder.PinType: method 'getActiveAccess' is not callable");
