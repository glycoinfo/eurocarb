...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Prot_FiltrationStep_GetActiveAccess(Prot_FiltrationStep self)
{
  ...
  if (!method)
    return raiseApiException("ccp.lims.Protocol.FiltrationStep: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccp.lims.Protocol.FiltrationStep: method 'getActiveAccess' is not callable");
