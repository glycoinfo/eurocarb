...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Chem_LinkEnd_GetActiveAccess(Chem_LinkEnd self)
{
  ...
  if (!method)
    return raiseApiException("ccp.molecule.ChemComp.LinkEnd: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccp.molecule.ChemComp.LinkEnd: method 'getActiveAccess' is not callable");
