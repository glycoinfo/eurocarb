...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Anpr_PotentialScale_GetActiveAccess(Anpr_PotentialScale self)
{
  ...
  if (!method)
    return raiseApiException("molsim.AnnealProtocol.PotentialScale: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("molsim.AnnealProtocol.PotentialScale: method 'getActiveAccess' is not callable");
