...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Dloc_ComponentShape_GetActiveAccess(Dloc_ComponentShape self)
{
  ...
  if (!method)
    return raiseApiException("ccp.general.DataLocation.ComponentShape: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccp.general.DataLocation.ComponentShape: method 'getActiveAccess' is not callable");
