...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Nmr_AbstractMeasurementList_GetActiveAccess(Nmr_AbstractMeasurementList self)
{
  ...
  if (!method)
    return raiseApiException("ccp.nmr.Nmr.AbstractMeasurementList: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccp.nmr.Nmr.AbstractMeasurementList: method 'getActiveAccess' is not callable");
