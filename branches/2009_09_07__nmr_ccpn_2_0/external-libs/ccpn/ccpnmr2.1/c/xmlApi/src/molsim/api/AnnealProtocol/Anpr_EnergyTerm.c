...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Anpr_EnergyTerm_GetActiveAccess(Anpr_EnergyTerm self)
{
  ...
  if (!method)
    return raiseApiException("molsim.AnnealProtocol.EnergyTerm: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("molsim.AnnealProtocol.EnergyTerm: method 'getActiveAccess' is not callable");
