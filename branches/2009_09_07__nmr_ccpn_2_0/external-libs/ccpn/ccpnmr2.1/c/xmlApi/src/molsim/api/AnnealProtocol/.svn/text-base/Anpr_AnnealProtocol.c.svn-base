...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Anpr_AnnealProtocol_GetActiveAccess(Anpr_AnnealProtocol self)
{
  ...
  if (!method)
    return raiseApiException("molsim.AnnealProtocol.AnnealProtocol: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("molsim.AnnealProtocol.AnnealProtocol: method 'getActiveAccess' is not callable");
