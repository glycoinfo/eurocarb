...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Hold_HolderLocation_GetActiveAccess(Hold_HolderLocation self)
{
  ...
  if (!method)
    return raiseApiException("ccp.lims.Holder.HolderLocation: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccp.lims.Holder.HolderLocation: method 'getActiveAccess' is not callable");
