...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Chem_ChemComp_GetActiveAccess(Chem_ChemComp self)
{
  ...
  if (!method)
    return raiseApiException("ccp.molecule.ChemComp.ChemComp: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccp.molecule.ChemComp.ChemComp: method 'getActiveAccess' is not callable");
