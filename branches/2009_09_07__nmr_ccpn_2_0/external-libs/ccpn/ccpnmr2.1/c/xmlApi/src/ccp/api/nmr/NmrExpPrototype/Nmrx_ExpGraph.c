...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Nmrx_ExpGraph_GetActiveAccess(Nmrx_ExpGraph self)
{
  ...
  if (!method)
    return raiseApiException("ccp.nmr.NmrExpPrototype.ExpGraph: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccp.nmr.NmrExpPrototype.ExpGraph: method 'getActiveAccess' is not callable");
