...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Nmap_NameMapping_GetActiveAccess(Nmap_NameMapping self)
{
  ...
  if (!method)
    return raiseApiException("ccpnmr.NameMapping.NameMapping: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccpnmr.NameMapping.NameMapping: method 'getActiveAccess' is not callable");
