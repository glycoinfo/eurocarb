...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Cryz_Image_GetActiveAccess(Cryz_Image self)
{
  ...
  if (!method)
    return raiseApiException("ccp.lims.Crystallization.Image: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccp.lims.Crystallization.Image: method 'getActiveAccess' is not callable");
