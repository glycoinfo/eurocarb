...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Anal_AnalysisPopup_GetActiveAccess(Anal_AnalysisPopup self)
{
  ...
  if (!method)
    return raiseApiException("ccpnmr.Analysis.AnalysisPopup: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccpnmr.Analysis.AnalysisPopup: method 'getActiveAccess' is not callable");
