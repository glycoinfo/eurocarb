...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Nmr_ShiftList_GetActiveAccess(Nmr_ShiftList self)
{
  ...
  if (!method)
    return raiseApiException("ccp.nmr.Nmr.ShiftList: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccp.nmr.Nmr.ShiftList: method 'getActiveAccess' is not callable");
