...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Refs_Composite_GetActiveAccess(Refs_Composite self)
{
  ...
  if (!method)
    return raiseApiException("ccp.lims.RefSampleComponent.Composite: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccp.lims.RefSampleComponent.Composite: method 'getActiveAccess' is not callable");
