...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Cclb_ChemCompLabel_GetActiveAccess(Cclb_ChemCompLabel self)
{
  ...
  if (!method)
    return raiseApiException("ccp.molecule.ChemCompLabel.ChemCompLabel: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccp.molecule.ChemCompLabel.ChemCompLabel: method 'getActiveAccess' is not callable");
