...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Cryz_ScoringScheme_GetActiveAccess(Cryz_ScoringScheme self)
{
  ...
  if (!method)
    return raiseApiException("ccp.lims.Crystallization.ScoringScheme: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccp.lims.Crystallization.ScoringScheme: method 'getActiveAccess' is not callable");
