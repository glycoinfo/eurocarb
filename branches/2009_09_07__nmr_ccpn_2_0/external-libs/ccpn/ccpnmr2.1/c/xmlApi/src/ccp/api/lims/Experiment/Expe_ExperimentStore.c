...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Expe_ExperimentStore_GetActiveAccess(Expe_ExperimentStore self)
{
  ...
  if (!method)
    return raiseApiException("ccp.lims.Experiment.ExperimentStore: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccp.lims.Experiment.ExperimentStore: method 'getActiveAccess' is not callable");
