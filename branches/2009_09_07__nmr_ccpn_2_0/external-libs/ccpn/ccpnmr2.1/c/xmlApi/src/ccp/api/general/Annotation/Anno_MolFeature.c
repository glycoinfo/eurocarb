...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Anno_MolFeature_GetActiveAccess(Anno_MolFeature self)
{
  ...
  if (!method)
    return raiseApiException("ccp.general.Annotation.MolFeature: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccp.general.Annotation.MolFeature: method 'getActiveAccess' is not callable");
