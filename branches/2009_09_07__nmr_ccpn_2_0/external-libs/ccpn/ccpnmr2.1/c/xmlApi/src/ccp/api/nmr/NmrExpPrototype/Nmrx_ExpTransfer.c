...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Nmrx_ExpTransfer_GetActiveAccess(Nmrx_ExpTransfer self)
{
  ...
  if (!method)
    return raiseApiException("ccp.nmr.NmrExpPrototype.ExpTransfer: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccp.nmr.NmrExpPrototype.ExpTransfer: method 'getActiveAccess' is not callable");
