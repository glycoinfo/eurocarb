...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Nsim_EnergyTermParameter_GetActiveAccess(Nsim_EnergyTermParameter self)
{
  ...
  if (!method)
    return raiseApiException("molsim.NmrSim.EnergyTermParameter: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("molsim.NmrSim.EnergyTermParameter: method 'getActiveAccess' is not callable");
