...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Chem_ChemAtom_GetActiveAccess(Chem_ChemAtom self)
{
  ...
  if (!method)
    return raiseApiException("ccp.molecule.ChemComp.ChemAtom: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccp.molecule.ChemComp.ChemAtom: method 'getActiveAccess' is not callable");
