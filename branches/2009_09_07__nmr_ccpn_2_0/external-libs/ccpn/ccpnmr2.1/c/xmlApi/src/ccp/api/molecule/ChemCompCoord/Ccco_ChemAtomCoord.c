...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Ccco_ChemAtomCoord_GetActiveAccess(Ccco_ChemAtomCoord self)
{
  ...
  if (!method)
    return raiseApiException("ccp.molecule.ChemCompCoord.ChemAtomCoord: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccp.molecule.ChemCompCoord.ChemAtomCoord: method 'getActiveAccess' is not callable");
