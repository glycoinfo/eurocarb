...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Refs_CompositeElement_GetActiveAccess(Refs_CompositeElement self)
{
  ...
  if (!method)
    return raiseApiException("ccp.lims.RefSampleComponent.CompositeElement: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccp.lims.RefSampleComponent.CompositeElement: method 'getActiveAccess' is not callable");
