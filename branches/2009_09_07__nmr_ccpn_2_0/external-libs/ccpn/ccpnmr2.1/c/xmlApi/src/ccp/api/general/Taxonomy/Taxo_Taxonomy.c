...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Taxo_Taxonomy_GetActiveAccess(Taxo_Taxonomy self)
{
  ...
  if (!method)
    return raiseApiException("ccp.general.Taxonomy.Taxonomy: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccp.general.Taxonomy.Taxonomy: method 'getActiveAccess' is not callable");
