...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Refs_IsotopeLabel_GetActiveAccess(Refs_IsotopeLabel self)
{
  ...
  if (!method)
    return raiseApiException("ccp.lims.RefSampleComponent.IsotopeLabel: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccp.lims.RefSampleComponent.IsotopeLabel: method 'getActiveAccess' is not callable");
