...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Chem_Stereochemistry_GetActiveAccess(Chem_Stereochemistry self)
{
  ...
  if (!method)
    return raiseApiException("ccp.molecule.ChemComp.Stereochemistry: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccp.molecule.ChemComp.Stereochemistry: method 'getActiveAccess' is not callable");
