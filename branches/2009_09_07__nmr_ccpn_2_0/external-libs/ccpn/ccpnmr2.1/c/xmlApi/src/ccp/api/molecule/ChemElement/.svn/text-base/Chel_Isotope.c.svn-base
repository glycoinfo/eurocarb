...
the access permissions on the (recursive) parents.
  ...
  @returns   the result
**/
Acco_AccessObject Chel_Isotope_GetActiveAccess(Chel_Isotope self)
{
  ...
  if (!method)
    return raiseApiException("ccp.molecule.ChemElement.Isotope: cannot find method 'getActiveAccess'");
  if (!PyCallable_Check(method))
    return raiseApiException("ccp.molecule.ChemElement.Isotope: method 'getActiveAccess' is not callable");
