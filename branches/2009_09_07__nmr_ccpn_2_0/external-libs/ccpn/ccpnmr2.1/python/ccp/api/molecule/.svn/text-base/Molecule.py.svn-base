...
Autogenerated by PyFileApiGen revision 1.51.2.5 on Fri Sep 18 15:09:26 2009
  from data model element ccp.molecule.Molecule revision 1.35.2.10
...
class Alignment(memops.api.Implementation.DataObject):
  ...
  """
  #   from data model element ccp.molecule.Molecule.Alignment revision 1.8.2.10
...
unknown disulfide binding topology). 
  """
  #   from data model element ccp.molecule.Molecule.MolResLink revision 1.38.2.10
...
more chains.
  """
  #   from data model element ccp.molecule.Molecule.MolResLinkEnd revision 1.41.2.10
...
the data bypassing the API.
  """
  #   from data model element ccp.molecule.Molecule.MolResidue revision 1.44.2.10
...
are disjoint and no residue can be a member of more than one.
  """
  #   from data model element ccp.molecule.Molecule.MolSeqFragment revision 1.41.2.10
...
etc. 
  """
  #   from data model element ccp.molecule.Molecule.Molecule revision 1.50.2.11
...
class MoleculeSysName(memops.api.Implementation.DataObject):
  ...
  """
  #   from data model element ccp.molecule.Molecule.MoleculeSysName revision 1.36.2.10
