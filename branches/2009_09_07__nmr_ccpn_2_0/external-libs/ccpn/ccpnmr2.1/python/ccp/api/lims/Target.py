...
Autogenerated by PyFileApiGen revision 1.51.2.5 on Fri Sep 18 15:09:57 2009
...
could groups targets that are not related by their properties.
  """
  #   from data model element ccp.lims.Target.Project revision 1.36.2.10
...
class Target(memops.api.Implementation.DataObject):
  ...
  """
  #   from data model element ccp.lims.Target.Target revision 1.37.2.10
...
protein family.
  """
  #   from data model element ccp.lims.Target.TargetGroup revision 1.36.2.10
...
class TargetStatus(memops.api.Implementation.DataObject):
  ...
  """
  #   from data model element ccp.lims.Target.TargetStatus revision 1.37.2.10
...
class TargetStore(memops.api.Implementation.TopObject):
  ...
  """
  #   from data model element ccp.lims.Target.TargetStore revision 1.37.2.10
