...
class Annotation(memops.api.Implementation.DataObject):
  ...
  """
  #   from data model element ccp.general.Annotation.Annotation revision 1.37.2.10
...
class AnnotationStore(memops.api.Implementation.TopObject):
  ...
  """
  #   from data model element ccp.general.Annotation.AnnotationStore revision 1.37.2.10
...
sequence, or a simple comment for a particular residue.
  """
  #   from data model element ccp.general.Annotation.MolFeature revision 1.37.2.10
