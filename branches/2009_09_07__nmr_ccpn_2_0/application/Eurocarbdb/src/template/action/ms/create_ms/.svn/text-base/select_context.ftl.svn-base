...
<h2>Or, alternatively, <@ecdb.actionlink name="contribute_structure">create a new sequence</@>, or upload an MzXML file directly <@ecdb.actionlink name="create_acquisition!input" class="ecdb_button">Upload</@></h2>
<div>
