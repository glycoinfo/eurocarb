...
<div class="acquisition_details">
  ...
  -->
  <!--
  <p><@ecdb.actionlink name="edit_acquisition_select_seq!input" params="acquisitionId=${acquisition.acquisitionId?c}" class="ecdb_button bc_add_seq_link">Add sequence</@>
  </p>
  -->
...
<div class="acquisition_reference_details">
  <@ecdb.actionlink class="ecdb_button" name="edit_acquisition_select_reference" id="add_reference" params="acquisition.acquisitionId=${acquisition.acquisitionId?c}">Add reference</@>
<#if (acquisition.references?exists && acquisition.references?size>0)>
<h2>References</h2>
  <ul>
    <#list acquisition.references as r >    
      <li><p><@ecdb.actionlink class="ecdb_button reference_delete_button" name="edit_acquisition_delete_reference" params="acquisition.acquisitionId=${acquisition.acquisitionId?c}&amp;reference.referenceId=${r.referenceId?c}">Remove</@></p><p><@ecdb.reference ref=r/></p></li>    
    </#list>
  </ul>
</#if>
</div>
