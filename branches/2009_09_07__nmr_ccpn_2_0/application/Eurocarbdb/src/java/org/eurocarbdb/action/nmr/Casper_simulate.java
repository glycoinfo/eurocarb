...
*   for more details.
*
*   Last commit: $Rev: 1722 $ by $Author: magnusl@organ.su.se $ on $Date:: 2009-09-28 #$  
*/
...
public class Casper_simulate extends Casper
{
	...
	if(this.getDisableCcpn())
        ...
        if(!this.getCCorrection().equals("") && !this.getCCorrection().equals("0") ||
           !this.getHCorrection().equals("") && !this.getHCorrection().equals("0"))
	    {
