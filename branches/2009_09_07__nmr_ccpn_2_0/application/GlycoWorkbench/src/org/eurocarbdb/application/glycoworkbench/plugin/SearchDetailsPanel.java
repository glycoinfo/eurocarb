...
public class SearchDetailsPanel extends SortingTablePanel<AnnotatedPeakList> implements ActionListener {    
    ...
    theActionManager.add("cut",FileUtils.getIcon("cut"),"Cut",-1, "",this);
    theActionManager.add("copy",FileUtils.getIcon("copy"),"Copy",KeyEvent.VK_C, "",this);
    theActionManager.add("delete",FileUtils.getIcon("delete"),"Delete",-1, "",this);

    theActionManager.add("transfer",FileUtils.getIcon("transfer"),"Copy fragments into canvas",KeyEvent.VK_V, "",this);
    theActionManager.add("annotate",FileUtils.getIcon("annotate"),"Add to the annotated peak list",KeyEvent.VK_V, "",this);

    theActionManager.add("goto",FileUtils.getIcon("goto"),"Jump to a specific m/z value",-1, "",this);

    theActionManager.add("selectsimilar",FileUtils.getIcon(""),"Select annotations with equal structures",-1, "",this);
    theActionManager.add("filterselection",FileUtils.getIcon(""),"Show only selected annotations",-1, "",this);
    theActionManager.add("showallrows",FileUtils.getIcon(""),"Show all annotations",-1, "",this);
    theActionManager.add("addIsotopeCurves",FileUtils.getIcon(""),"Show isotopic distributions",-1, "",this);
    }
