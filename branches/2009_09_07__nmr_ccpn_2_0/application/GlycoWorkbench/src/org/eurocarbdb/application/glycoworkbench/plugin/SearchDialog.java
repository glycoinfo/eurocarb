...
* @author  aceroni
*/
public class SearchDialog extends EscapeDialog implements ActionListener, MouseListener {
    ...
    public SearchDialog(java.awt.Frame parent, ProfilerPlugin profiler, boolean search_again, GraphicOptions gopt) {
        super(parent, true);
    ...
    field_database.setModel(new javax.swing.DefaultComboBoxModel(theProfiler.getDictionaryNames().toArray(new String[0])));
    ...
    if( field_database.isEnabled() )
        return_database = theProfiler.getDictionary((String)field_database.getSelectedItem());
    else
    ...
    if( MouseUtils.isPopupTrigger(e) ) {       
        ...
        theCanvas.createPopupMenu(false).show(theCanvas, e.getX(), e.getY());   
    }
    }
