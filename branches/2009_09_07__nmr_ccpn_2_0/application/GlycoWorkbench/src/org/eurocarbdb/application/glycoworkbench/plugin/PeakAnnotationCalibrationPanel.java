...
public class PeakAnnotationCalibrationPanel extends DocumentPanel<AnnotatedPeakList> implements ActionListener, ComponentListener, GlycanWorkspace.Listener, BaseDocument.DocumentChangeListener {        
    ...
    theActionManager.add("accunit=da",FileUtils.getIcon("da"),"Show accuracy in Da",-1, "",this);
    theActionManager.add("accunit=ppm",FileUtils.getIcon("ppm"),"Show accuracy in PPM",-1, "",this);
    ...
    theActionManager.add("last",FileUtils.getIcon("last"),"Last structure",KeyEvent.VK_L, "",this);
