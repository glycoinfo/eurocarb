...
public class DictionariesManagerPanel extends SortingTablePanel<ProfilerPlugin> implements ActionListener, ProfilerPlugin.DictionariesChangeListener {    
    ...
    if( _theDocument!=null )
        ...
        theDocument = new ProfilerPlugin();
    ...
    theActionManager.add("add",FileUtils.getIcon("add"),"Add new dictionary",KeyEvent.VK_N, "",this);
    theActionManager.add("open",FileUtils.getIcon("open"),"Open existing dictionary",KeyEvent.VK_O, "",this);
    theActionManager.add("delete",FileUtils.getIcon("delete"),"Delete selected dictionary",KeyEvent.VK_DELETE, "",this);
    theActionManager.add("edit",FileUtils.getIcon("edit"),"Edit selected dictionary",KeyEvent.VK_E, "",this);
    }
