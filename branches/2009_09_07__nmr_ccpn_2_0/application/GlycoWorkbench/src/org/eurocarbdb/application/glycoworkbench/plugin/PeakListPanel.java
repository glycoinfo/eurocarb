...
public class PeakListPanel extends SortingTablePanel<PeakList> implements ActionListener {    
    ...
    // file
    theActionManager.add("new",FileUtils.getIcon("new"),"New",KeyEvent.VK_N, "",this);
    theActionManager.add("open",FileUtils.getIcon("open"),"Open",KeyEvent.VK_O, "",this);
    theActionManager.add("save",FileUtils.getIcon("save"),"Save",KeyEvent.VK_S, "",this);
    theActionManager.add("saveas",FileUtils.getIcon("saveas"),"Save as...",KeyEvent.VK_A, "",this);
    ...
    theActionManager.add("add",FileUtils.getIcon("add"),"Add peak",KeyEvent.VK_D, "",this);
    theActionManager.add("cut",FileUtils.getIcon("cut"),"Cut",KeyEvent.VK_T, "",this);
    theActionManager.add("copy",FileUtils.getIcon("copy"),"Copy",KeyEvent.VK_C, "",this);
    theActionManager.add("paste",FileUtils.getIcon("paste"),"Paste", KeyEvent.VK_P, "",this);
    theActionManager.add("delete",FileUtils.getIcon("delete"),"Delete",KeyEvent.VK_DELETE, "",this);
    theActionManager.add("selectall",FileUtils.getIcon("selectall"),"Select all",KeyEvent.VK_A, "",this);

    theActionManager.add("annotatepeaks",FileUtils.getIcon("annotatepeaks"),"Find possible annotations for selected peaks",-1, "",this);

    theActionManager.add("filterselection",FileUtils.getIcon(""),"Show only selected peaks",-1, "",this);
    theActionManager.add("showallrows",FileUtils.getIcon(""),"Show all peaks",-1, "",this); 
    }
    ...
    public void delete() {
    theDocument.remove(theTableSorter.modelIndexes(theTable.getSelectedRows()));
    }
    ...
    try {
        ...
        Collection<Peak> selected_peaks = theDocument.extract(model_inds);
        if( shown_mslevel.equals("ms") ) {
            if( parent_action!=null )            
            ms_action = theApplication.getPluginManager().getMsPeakAction(parent_action);            
            return theApplication.getPluginManager().runAction(ms_action,new PeakList(selected_peaks));        
        }
        if( parent_action!=null )            
            msms_action = theApplication.getPluginManager().getMsMsPeakAction(parent_action);            
        return theApplication.getPluginManager().runAction(msms_action,new PeakList(selected_peaks));    
        }
        return false;
    }
    catch(Exception e) {
