...
$suffix = "sugabaseCcpn";
$user = "aceroni";
$ref_data_dir = "/home/jionides/work/ECDB/eurocarb-branch-test-2/application/Eurocarbdb/data/ccpn_ref_data/";

$INDEX_START =0;
$BATCH_SIZE = 1400;
$TOTAL_SIZE = 1400;

$log = "/home/jionides/work/ECDB/eurocarb-branch-test-2/logs/casper.log";
...
for ($i=$INDEX_START; $i<$#ls; $i++) {
	...
	$bstr = join (" ",@batch);
	print "processing batch\nant run-batch-casper -Darg1=$dir_to_load -Darg2=$suffix -Darg3=$user -Darg4=$ref_data_dir -Darg5='$bstr'\n";

	$v = `ant run-batch-casper -Darg1=$dir_to_load -Darg2=$suffix -Darg3=$user -Darg4=$ref_data_dir -Darg5='$bstr'`;
	print LOG $v;
