...
*   for more details.
*
*   Last commit: $Rev: 1765 $ by $Author: john.ionides $ on $Date:: 2009-11-06 #$  
*/
/**
*   $Id: HibernateEntityManager.java 1765 2009-11-06 15:07:49Z john.ionides $
*   Last changed $Author: john.ionides $
*   EUROCarbDB Project
*/
...
public class HibernateEntityManager implements EntityManager 
{
    ...
    *   {@inheritDoc}
    */
    public void beginUnitOfWork(org.hibernate.Interceptor i)
    {
        log.debug("starting new db transaction under interceptor");
        getSessionFactory().openSession(i).beginTransaction();
        uowStarted = true;
    }
