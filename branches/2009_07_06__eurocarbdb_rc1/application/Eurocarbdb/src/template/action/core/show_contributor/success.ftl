...
<p>You have contributed ${count_my_contexts} <#if (count_my_contexts > 1)>association<#else>associations</#if> between a Structure and a biological context. Showing the last ${max_items_to_show} entries.
</p>
<div>
<#list contexts as gc>
