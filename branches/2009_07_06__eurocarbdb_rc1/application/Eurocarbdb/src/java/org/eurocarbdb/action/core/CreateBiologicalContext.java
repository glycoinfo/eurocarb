...
*   for more details.
*
*   Last commit: $Rev: 1576 $ by $Author: glycoslave $ on $Date:: 2009-07-24 #$  
*/
...
*/
@org.eurocarbdb.action.ParameterChecking(whitelist={"taxonomySearch","tissueTaxonomySearch","diseaseSearch","perturbationSearch"}, blacklist={"biologicalContext.biologicalContextId"})
