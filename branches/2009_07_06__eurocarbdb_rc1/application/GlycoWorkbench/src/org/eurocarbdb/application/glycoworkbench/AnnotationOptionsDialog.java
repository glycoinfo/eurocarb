...
public class AnnotationOptionsDialog extends EscapeDialog implements java.awt.event.ActionListener, java.awt.event.ItemListener, javax.swing.event.ChangeListener  {
     ...
     */
    public AnnotationOptionsDialog(java.awt.Frame parent,  FragmentOptions frag_opt, AnnotationOptions ann_opt, boolean ann_fragments, boolean der_options) {
        super(parent, true);

    theFragmentOptions = (frag_opt!=null) ?frag_opt :new FragmentOptions();
    theAnnotationOptions = (ann_opt!=null) ?ann_opt :new AnnotationOptions();   
    ...
    field_compute_exchanges.setSelected(theAnnotationOptions.COMPUTE_EXCHANGES);
    ...
    field_derive_from_parent.setSelected(theAnnotationOptions.DERIVE_FROM_PARENT && derive_options);    

    field_accuracy.setText(Double.toString(theAnnotationOptions.MASS_ACCURACY));
    field_accuracy_unit.setSelectedItem(theAnnotationOptions.MASS_ACCURACY_UNIT);
    }
    ...
    field_max_no_na_ions.setEnabled(!field_negative_mode.isSelected() && !field_derive_from_parent.isSelected());
    field_max_no_li_ions.setEnabled(!field_negative_mode.isSelected() && !field_derive_from_parent.isSelected());
    field_max_no_k_ions.setEnabled(!field_negative_mode.isSelected() && !field_derive_from_parent.isSelected());
    field_max_no_charges.setEnabled(!field_derive_from_parent.isSelected());

    field_compute_exchanges.setEnabled(!field_derive_from_parent.isSelected());
    field_max_ex_na_ions.setEnabled(field_compute_exchanges.isSelected() && !field_derive_from_parent.isSelected());
    field_max_ex_li_ions.setEnabled(field_compute_exchanges.isSelected() && !field_derive_from_parent.isSelected());
    field_max_ex_k_ions.setEnabled(field_compute_exchanges.isSelected() && !field_derive_from_parent.isSelected());
    ...
    theAnnotationOptions.MAX_NO_H_IONS = (Integer)field_max_no_h_ions.getValue();
    theAnnotationOptions.MAX_NO_NA_IONS = (Integer)field_max_no_na_ions.getValue();
    theAnnotationOptions.MAX_NO_LI_IONS = (Integer)field_max_no_li_ions.getValue();
    theAnnotationOptions.MAX_NO_K_IONS = (Integer)field_max_no_k_ions.getValue();
    theAnnotationOptions.MAX_NO_CHARGES = (Integer)field_max_no_charges.getValue();

    theAnnotationOptions.COMPUTE_EXCHANGES = field_compute_exchanges.isSelected();
    ...
    if( derive_options )
        theAnnotationOptions.DERIVE_FROM_PARENT = field_derive_from_parent.isSelected();

    theAnnotationOptions.MASS_ACCURACY = Double.valueOf(field_accuracy.getText());
    theAnnotationOptions.MASS_ACCURACY_UNIT = (String)field_accuracy_unit.getSelectedItem();
    }
    ...
    max_no_charges_ions = Math.max(max_no_charges_ions, (Integer)field_max_no_h_ions.getValue()); 
    if( !field_negative_mode.isSelected() ) {
        max_no_charges_ions = Math.max(max_no_charges_ions, (Integer)field_max_no_na_ions.getValue()); 
        max_no_charges_ions = Math.max(max_no_charges_ions, (Integer)field_max_no_li_ions.getValue()); 
        max_no_charges_ions = Math.max(max_no_charges_ions, (Integer)field_max_no_k_ions.getValue()); 
    }
    
    if( source==field_max_no_charges ) {
        int max_no_charges_new = (Integer)field_max_no_charges.getValue();
        enforceValue(field_max_no_h_ions,max_no_charges_ions,max_no_charges_new);
        enforceValue(field_max_no_na_ions,max_no_charges_ions,max_no_charges_new);
        enforceValue(field_max_no_li_ions,max_no_charges_ions,max_no_charges_new);
        enforceValue(field_max_no_k_ions,max_no_charges_ions,max_no_charges_new);
    }
    if( source==field_max_no_h_ions || source==field_max_no_na_ions || source==field_max_no_li_ions || source==field_max_no_k_ions ) 
        field_max_no_charges.setValue(max_no_charges_ions);
    }

    public void enforceValue(javax.swing.JSpinner field, int old_max_value, int new_max_value) {
