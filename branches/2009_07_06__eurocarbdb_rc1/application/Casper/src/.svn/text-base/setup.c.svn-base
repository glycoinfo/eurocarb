...
struct PA_Command SE_Cmds[]={
  ...
  { "link",     SE_AddLinkage, "link <FromUnit> <ToUnit> [<FromPos> <ToPos>]",
    "Specifies a linkage between two units. Positions can also be specified if they are known.\nE.g.\nlink 'a' 'b'\nlink 'b' 'c' '1' '4'"},
...
int SE_AddLinkage()
{
  char FromUnitName[32], ToUnitName[32], FromPosName[4], ToPosName[4];
  int pos;
